        ...
        e.GrpTree = {
            ...
            cascadeInit: function() {
                if (this.getCascadeInit()) {
                    for (var t, e = this, n = [], r = e.cbId, i = e.that, o = i.options[e.model].select, a = i.pdata, l = 0, s = a.length; s > l; l++)
                        t = a[l],
                        t[r] ? e.isEditable(t) ? (n.push(t),
                            delete t[r]) : o && (t.pq_rowselect = !0) : null === t[r] && delete t[r];
                    n.length && e.checkNodes(n, null, null, !0)
                }
            },
            cascadeNest: function(t) {
                for (var e, n, r, i = this, o = i.cbId, a = i.prop, l = i.childstr, s = t.length, d = 0; s > d; d++)
                    n = t[d],
                    n[a] && (e = !0,
                        i.eachChild(n, i.chkEachChild(o, n[o], a)),
                        delete n[a]),
                    (r = n[l]) && r.length && i.cascadeNest(r);
            ...
            checkNodes: function(t, e, n, r, i) {
                ...
                for (var o, a, l, s = 0, d = t.length, c = [], u = {
                        check: e
                    }, h = this, f = h.that, p = f.riOffset, g = h.cbId, v = h.prop, m = f.options[h.model], w = i ? !1 : h.isCascade(m), x = r && m.eventForInit || !r, y = m.select; d > s; s++)
                    o = t[s],
                    this.isEditable(o) && (a = o.pq_ri,
                        c.push({
                            rowData: o,
                            rowIndx: a,
                            rowIndxPage: a - p
                ...
                if (u.rows = c,
                    u.dataIndx = h.colUI.dataIndx,
                    r && (u.init = r),
                    x && (l = f._trigger("beforeCheck", n, u)),
                    l !== !1 && (c = u.rows,
                        d = c.length)) {
                    var C = this.chkRows = [];
                    for (s = 0; d > s; s++)
                        ...
                        o[g] = e;
                    w && h.cascadeNest(h.getRoots()),
                        y && this.selectRows(),
                        w && (u.getCascadeList = h.getCascadeList(h)),
                        x && f._trigger("check", n, u),
                        C.length = 0
                }
                h.setValCBox(),
                    r || f.refresh({
            ...
            eachChild: function(t, e) {
                e.call(this, t);
                for (var n, r = this.childstr, i = t[r] || [], o = 0, a = i.length; a > o; o++)
                    n = i[o],
                    n[r] ? this.eachChild(n, e) : e.call(this, n)
            },
            eachParent: function(t, e) {
                for (; t = this.getParent(t);)
                    e.call(this, t)
            },
            _flatten: function(t, e, n, r) {
                for (var i, o, a = this, l = t.length, s = a.id, d = a.parentId, c = 0, u = a.childstr; l > c; c++)
                    i = t[c],
                    i.pq_level = n,
                    r.push(i),
                    e && (i[d] = s ? e[s] : e),
                    o = i[u],
                    o && a._flatten(o, i, n + 1, r)
            },
            flatten: function(t) {
                var e = [];
            ...
            getRoots: function(t) {
                for (var e, n = this.that, r = t || n.pdata || [], i = r.length, o = 0, a = []; i > o; o++)
                    e = r[o],
                    0 !== e.pq_level || e.pq_gsummary || a.push(e);
                return i && !a.length && (a = r),
                    a
            },
            ...
            onCustomSortTree: function(t, e) {
                var n = this,
                    r = n.getRoots(e.data);
                return n.sort(r, e.sort_composite),
                    e.data = n.flatten(r),
                    !1
            },
            onRefresh: function(t, e) {
                return function() {
                    if (e.checkbox)
                        for (var t = this.$cont.find(".pq_indeter"), n = t.length; n--;)
                            t[n].indeterminate = !0
                }
            },
            ...
            renderCB: function(t, e, n) {
                ...
                return "function" == typeof t && (t = t.call(i, e)),
                    t ? (e[n] && (o = "checked"),
                        this.isEditable(e) || (a = "disabled",
                            r = "pq_disable"),
                        null === e[n] && (l = "class='pq_indeter'"),
                        ["<input type='checkbox' " + l + " " + o + " " + a + "/>", r]) : void 0
            },
            selectRows: function() {
            ...
            _summaryT: function(t, e, n, r, i, o, a) {
                for (var l, s, d, c, u, h = this, f = h.childstr, p = "groupModel" == h.model, g = o.summaryInTitleRow, v = h.that.colIndxs, m = o.showSummary, w = o.titleInFirstCol, x = 0, y = t.length, C = 0, b = {}, I = {}, _ = h.id, q = h.parentId, D = p && a ? o.dataIndx[a.pq_level] : "", R = [], M = n.length, T = pq.aggregate; M > C; C++)
                    u = n[C],
                    b[u] = [];
                for (; y > x; x++) {
                    if (s = t[x],
                        ...
                        e.push(s),
                        d = s[f]) {
                        for (l = h._summaryT(d, e, n, r, i, o, s),
                            C = 0; M > C; C++)
                            u = n[C],
                            h.copyArray(b[u], l[1][u]);
                        h.copyArray(R, l[2])
                    }
                    if (!p || !s.pq_gtitle) {
                        for (C = 0; M > C; C++)
                ...
                for (C = 0; M > C; C++)
                    ...
                    I[u] = T[c](b[u], i[C], R),
                    g && a && (0 == v[u] && w || (a[u] = I[u]));
                return !a || p && !m[a.pq_level] || (I.pq_level = a.pq_level,
                        I[q] = a[_],
                        e.push(I),
                        a.pq_child_sum = I,
                        I.pq_hidden = a.pq_close),
                    I.pq_gsummary = !0,
                    [I, b, R]
            },
            summaryT: function() {
                for (var e, n, r, i = this, o = i.that, a = o.options, l = a[i.model], s = i.getRoots(), d = [], c = [], u = [], h = [], f = 0, p = o.colModel, g = p.length; g > f; f++)
                    e = p[f],
                    n = e.summary,
                    n && !t.isEmptyObject(n) && (u.push(e.dataIndx),
                        h.push(e),
                        c.push(n));
                r = i._summaryT(s, d, u, c, h, l)[0],
                    l.grandSummary ? (r.pq_grandsummary = !0,
                        i.summaryData = a.summaryData = [r]) : (i.summaryData || []).length = 0,
                    o.pdata = d
            }
        }
}(jQuery),
        ...
        e.ChkGrpTree = {
            ...
            onRefreshHeader: function() {
                var t = this,
                    e = t.that;
                if (t.hasCboxHead()) {
                    if ("groupModel" == t.model && !e.options[t.model].on)
                        return;
                    var r = e.getCellHeader({
                            dataIndx: t.colUI.dataIndx
                        }),
                        i = r.find("input");
                    i.length || (r.find(".pq-title-span").prepend('<input type="checkbox" />'),
                            i = r.find("input")),
                        t.$inp && i[0] == t.$inp[0] || (t.$inp = i,
                            t.refreshHeadVal(),
                            n && i.on("click", function(e) {
                                null == i.data("pq_value") && (i[0].checked = !0,
                                    i.data("pq_value", !0),
                                    t.onHeaderChange(e))
                            }),
                ...
                if (this.hasCboxHead()) {
                    ...
                    if (u) {
                        for (var v = 0, m = u.length; m > v; v++)
                            t = u[v],
                            e = v + c,
                            t.pq_gsummary || t.pq_gtitle || !this.isEditable(t, i, e, a, o) || (p++,
                                t[o] === l.check ? f++ : g++);
                        f == p && p ? h = !0 : g == p && (h = !1),
                            this.inpVal = h,
                            this.refreshHeadVal()
...
function(t) {
    ...
    i._trigger = function(e, n, r) {
        ...
        if (r = r || {},
            n = t.Event(n),
            n.type = l.widgetName + ":" + e,
            n.target = f[0],
            a = n.originalEvent)
            for (i in a)
                i in n || (n[i] = a[i]);
        if (u && "function" == typeof u && u.call(l, n, r),
            d && d.length && (o(l, d, n, r),
                n.isImmediatePropagationStopped()))
            return !n.isDefaultPrevented();
        if (c.trigger && (f[h ? "trigger" : "triggerHandler"](n, r),
                n.isImmediatePropagationStopped()))
            return !n.isDefaultPrevented();
        if (p) {
            var g = p.call(l, n, r);
    ...
    i.on = function() {
        ...
        i.one = function() {
            for (var t = arguments.length, e = [], n = 0; t > n; n++)
                e[n] = arguments[n];
            return e[t] = !0,
...
function(t) {
    t.paramquery = t.paramquery || {},
        t.paramquery.onResize = function(e, n) {
            var r = !1,
                i = t(e);
            if ("static" === i.css("position") && i.css("position", "relative"),
                !r) {
...
function(t) {
    ...
    !r.find && (r.find = function(t, e) {
        ...
        t.extend(pq, {
            ...
            elementFromXY: function(e) {
                ...
                return o.closest(".ui-draggable-dragging").length && (n = o,
                        n.hide(),
                        o = t(document.elementFromPoint(r, i)),
                        n.show()),
                    o
            ...
            excelToJui: function() {
                ...
                return function(e) {
                    var n = t[e];
                    return n || (n = e.replace(/yy/g, "y").replace(/dddd/g, "DD").replace(/ddd/g, "D").replace(/mmmm/g, "MM").replace(/mmm/g, "M"),
                            t[e] = n),
                        n
                }
            }(),
            ...
            flatten: function(t, e) {
                ...
                for (e = e || []; i > r; r++)
                    n = t[r],
                    null != n && (n.push ? pq.flatten(n, e) : e.push(n));
                return e
            },
            toRC: function(t) {
                var e = t.match(/([A-Z]+)(\d+)/),
            ...
            formatEx: function(t, e, n, r) {
                return n && (r = r || pq.getDataType(t),
                    pq.filter.conditions[n][r]) ? this.format(t, e, r) : e
            },
            ...
            deFormat: function(e, n, r) {
                if (n) {
                    ...
                    if (l && (a = pq.getDataType(e),
                            o = r ? pq.filter.conditions[r][a] : !0))
                        try {
                            "function" == typeof l ? n = e.deFormat(n) : "date" == a ? (i = e.formatRaw || "mm/dd/yy",
                                i != l && (n = t.datepicker.parseDate(l, n),
                                    n = t.datepicker.formatDate(i, n))) : n = pq.deFormatNumber(n, l)
                        } catch (s) {
                            n = null
                        }
                }
            ...
            getDataType: function(t) {
                var e, n = t.dataType;
                return "bool" == n ? e = "bool" : "float" == n || "integer" == n ? e = "number" : "date" == n && (e = "date"),
                    e || "string"
            },
            getFn: function() {
                var t = {};
                return function(e) {
                    var n = e;
                    return "string" == typeof e && ((n = t[e]) || (n = window,
            ...
            isDateFormat: function() {
                ...
                return function(e) {
                    var n = t[e];
                    return null == n && (n = t[e] = /^[mdy\s-\/\.,]*$/i.test(e)),
                        n
                }
            }(),
            isEmpty: function(t) {
            ...
            juiToExcel: function() {
                ...
                return function(e) {
                    var n = t[e];
                    return n || (n = e.replace(/y/g, "yy").replace(/DD/g, "dddd").replace(/D/g, "ddd").replace(/MM/g, "mmmm").replace(/M/g, "mmm"),
                            t[e] = n),
                        n
                }
            }(),
            ...
            moveItem: function(t, e, n, r) {
                return n > r ? (e.splice(n, 1),
                        e.splice(r++, 0, t)) : n == r ? r++ : (e.splice(r, 0, t),
                        e.splice(n, 1)),
                    r
            },
            newLine: function(t) {
        ...
        n.select = function(t) {
            ...
            if (u)
                for (var g in u)
                    p.push('<option value="', g, '">', u[g], "</option>");
            if (o && o.length) {
                for (var v = 0, m = o.length; m > v; v++) {
                    ...
                    if (d) {
                        ...
                        if (r = h ? f() : "",
                            ...
                            e = w[a],
                                n != e && (null != n && p.push("</optgroup>"),
                                    p.push('<optgroup label="', e, '" ', b, " >"),
                                    n = e)
                        }
                        if (l == s)
                            p.push("<option ", C, y, r, ">", x, "</option>");
                        else {
                            var I = w[l];
                        ...
                        for (var g in w)
                            p.push('<option value="', g, '">', w[g], "</option>");
                    else
                        p.push("<option>", w, "</option>")
                }
                c && p.push("</optgroup>")
            }
            ...
            if (t) {
                if (t.incr) {
                    ...
                    return this.prop("indeterminate", !1),
                        e ? (e = !1,
                            this.prop("checked", !1)) : e === !1 ? (e = null,
                            this.prop("indeterminate", !0),
                            this.prop("checked", !1)) : (e = !0,
                            this.prop("checked", !0)),
                ...
                return e = t.val,
                    ...
                    null === e ? (this.prop("indeterminate", !0),
                        this.prop("checked", !1)) : e ? this.prop("checked", !0) : this.prop("checked", !1),
                    this
            }
    ...
    n.formatCurrency = function(t, e) {
            ...
            if (!isNaN(n)) {
                var r = 0 > n,
                    ...
                    u = o.decimal;
                n = n.toFixed(u);
                for (var h = n.length, f = u + c.length, p = n.substring(0, h - f), g = n.substring(h - f + c.length, h), v = p.match(/\d/g).reverse(), m = [], w = 0; w < v.length; w++)
                    w > 0 && w % s == 0 && m.push(d),
                    m.push(v[w]);
                return m = m.reverse(),
                    p = m.join(""),
        ...
        pq.formatNumber = n.formatCurrency,
        pq.deFormatNumber = function(t, e) {
            var n = 0 > t,
                r = i(e, n),
                o = r.symbol,
                a = r.symbolEnd,
                ...
                s = r.decSep;
            return l = "." === l ? "\\." : l,
                t = t.replace(o, "").replace(a, "").replace(new RegExp(l, "g"), ""),
                s && (t = 1 * t.replace(s, ".")),
                t
        },
        pq.validation = {
            is: function(t, e) {
                return "string" != t && t ? (t = t.substring(0, 1).toUpperCase() + t.substring(1, t.length),
                    this["is" + t](e)) : !0
            },
            isFloat: function(t) {
                var e = parseFloat(t);
    ...
    var o = [],
        ...
        l = pq.toLetter = function(t) {
            ...
            if (!e) {
                ...
                var n = t % 26,
                    r = t / 26 | 0,
                    i = n ? String.fromCharCode(64 + n) : (--r,
                        "Z");
                e = r ? l(r - 1) + i : i,
                    t--,
                    o[t] = e,
    ...
    pq.toNumber = function(t) {
        ...
        function() {
            function e(e) {
                var n = e.rtl;
                return null == n && (n = e.rtl = "rtl" == t(e).css("direction")),
                    n
            }
            var n = "w",
                r = "scrollLeft";
        ...
        e.cValid.prototype = {
            ...
            isValidCell: function(e) {
                ...
                if (y)
                    ...
                    var I = t.extend({}, C ? p : f, x.validation),
                        _ = I.css,
                        q = I.cls,
                        D = I.icon,
                        R = I.style;
                        ...
                        if (l) {
                            if (t(w).hasClass("pq-editor-focus")) {
                                ...
                                if (k) {
                                    ...
                                    if (h != S)
                                        throw "incorrect usage of isValid dataIndx: " + h;
                                    r.editCell({
                                        rowIndx: E,
                                        dataIndx: h
                                    })
                            ...
                            var P = {
                                ...
                                P = r.normalize(P);
                            T = r.getCell(P),
                                r.scrollCell(P, function() {
                                    n.onScrollCell(T, b, D, q, _, R),
                                        r.focus(P)
                                })
                        }
...
function(t) {
    ...
    e.options = {
        ...
        e._create = function() {
            ...
            t.listeners = {},
                r.html("<table style='border-collapse:collapse;'><tr>" + o + "</tr></table>"),
                r.addClass("pq-pager"),
                t.$first = r.find(".pq-page-first"),
                t.bindButton(t.$first, function(n) {
                    e.curPage > 1 && t.onChange(n, 1)
                }),
                t.$prev = r.find(".pq-page-prev"),
                t.bindButton(t.$prev, function(n) {
                    if (e.curPage > 1) {
                        var r = e.curPage - 1;
                        t.onChange(n, r)
                    }
                }),
                t.$next = r.find(".pq-page-next"),
                t.bindButton(t.$next, function(n) {
                    if (e.curPage < e.totalPages) {
                        var r = e.curPage + 1;
                        t.onChange(n, r)
                    }
                }),
                t.$last = r.find(".pq-page-last"),
                t.bindButton(t.$last, function(n) {
                    if (e.curPage !== e.totalPages) {
                        var r = e.totalPages;
                        t.onChange(n, r)
                    }
                }),
                t.$refresh = r.find(".pq-page-refresh"),
                t.bindButton(t.$refresh, function(e) {
                    return t._trigger("beforeRefresh", e) === !1 ? !1 : void t._trigger("refresh", e)
                }),
                t.$display = r.find(".pq-page-display"),
                t.$select = r.find(".pq-page-select").val(e.rPP).on("change", t.onChangeSelect.bind(t)),
                t.$totalPages = r.find(".pq-page-total"),
                t.$curPage = r.find(".pq-page-current"),
                t.bindCurPage(t.$curPage)
        },
        e._destroy = function() {
        ...
        e._setOptions = function(e) {
            ...
            for (n in e) {
                var o = e[n],
                    a = typeof o;
                "string" == a || "number" == a ? o != i[n] && (this._setOption(n, o),
                    r = !0) : "function" == typeof o.splice || t.isPlainObject(o) ? JSON.stringify(o) != JSON.stringify(i[n]) && (this._setOption(n, o),
                    r = !0) : o != i[n] && (this._setOption(n, o),
                    r = !0)
            }
            return r && this._refresh(),
                this
        },
        t.widget("paramquery.pqPager", e),
    ...
    var n = t.paramquery,
        r = n.pqPager;
    r.regional = {},
        r.defaults = r.prototype.options,
        t.extend(r.prototype, {
            ...
            bindCurPage: function(e) {
                ...
                e.bind("keydown", function(e) {
                    ...
                    var i = t(this),
                        o = i.val();
                    return isNaN(o) || 1 > o ? (i.val(r.curPage),
                        !1) : (o = parseInt(o),
                        o !== r.curPage ? o > r.totalPages ? (i.val(r.curPage),
            ...
            onChange: function(t, e) {
                ...
                return this._trigger("beforeChange", t, n) === !1 ? !1 : (this.options.curPage = e,
                    void this._trigger("change", t, n))
            },
            onChangeSelect: function(e) {
                ...
                return r._trigger("beforeChange", e, o) === !1 ? (n.val(r.options.rPP),
                    !1) : (r.options.rPP = i,
                    void r._trigger("change", e, o))
            },
            refresh: function() {
                this._destroy(),
                    this._create()
            ...
            _refresh: function() {
                ...
                t.setDisable(t.$next, n),
                    ...
                    t.$totalPages.text(e.totalPages),
                ...
                if (e) {
                    ...
                    if (-1 != e.indexOf("{0}")) {
                        for (var a = 0, l = i.length; l > a; a++)
                            r = i[a],
                            o.push('<option value="', r, '">', r, "</option>");
                        o.push("</select>"),
                            n = o.join(""),
                            e = e.replace("{0}", n) + "</span>"
                    }
                }
...
function(t) {
    ...
    o._create = function() {
            ...
            t(document).triggerHandler("pqGrid:bootup", {
                ...
                n.flexHeight && (n.height = "flex"),
                n.flexWidth && (n.width = "flex"),
                e.iRefresh = new i.cRefresh(e),
                e.iKeyNav = new i.cKeyNav(e),
                e.iValid = new i.cValid(e),
                e.tables = [],
                e.$tbl = null,
                e.iCols = new i.cColModel(e),
                e.iSort = new i.cSort(e),
                e._initTypeColumns(),
                r.on("scroll" + e.eventNamespace, function() {
                    this.scrollLeft = 0,
                        this.scrollTop = 0
            ...
            r.empty().attr({
                ...
                e.setLocale(),
                e.$bottom = t(".pq-grid-bottom", r),
                e.$summary = t(".pq-summary-outer", r),
                e.$toolPanel = r.find(".pq-tool-panel"),
                e.$top = t("div.pq-grid-top", r),
                n.showTop || e.$top.css("display", "none"),
                e.$title = t("div.pq-grid-title", r),
                n.showTitle || e.$title.css("display", "none");
            ...
            e.iHeader = new i.cHeader(e, p),
                e.$footer = t(".pq-grid-footer", r);
            ...
            e.iRenderB = new pq.cRenderBody(e, {
                ...
                g.on("focusout", function() {
                    ...
                    e.onfocus(t)
                }).on("mousedown", e._onMouseDown(e)).on("change", e._onChange(e)).on("mouseenter", ".pq-grid-cell,.pq-grid-number-cell", e._onCellMouseEnter(e)).on("mouseenter", ".pq-grid-row", e._onRowMouseEnter(e)).on("mouseleave", ".pq-grid-cell", e._onCellMouseLeave(e)).on("mouseleave", ".pq-grid-row", e._onRowMouseLeave(e)).on("keyup", e._onKeyUp(e)),
                n.selectionModel["native"] || this.disableSelection(),
                f.bind("keydown.pq-grid", e._onKeyPressDown(e)),
                this._refreshTitle(),
                e.iRows = new i.cRows(e),
                e.generateLoading(),
                e._initPager(),
                e._refreshResizable(),
                e._refreshDraggable(),
                e.iResizeColumns = new i.cResizeColumns(e)
        },
        o.addTouch = function() {
            var e, n, r;
            "ontouchend" in document && (r = this.$grid_center[0],
        ...
        o._mouseDown = function(e) {
            var n = this;
            return t(e.target).closest(".pq-editor-focus").length ? (this._blurEditMode = !0,
        ...
        o.setLocale = function() {
            var e = this.options,
                n = e.locale;
            e.strLocal != n && (t.extend(!0, e, i.pqGrid.regional[n]),
                t.extend(e.pageModel, i.pqPager.regional[n]))
        },
        o._setOption = function(t, e) {
            ...
            if ("height" === t)
                a(),
                r._refreshResizable();
            else if ("locale" == t || "pageModel" == t)
                a(),
                "locale" == t && r.setLocale(),
                o && o.destroy();
            else if ("width" === t)
                a(),
                r._refreshResizable();
                ...
                a();
                var h = c(e);
                r.element[h]("ui-corner-all"),
                    r.$top[h]("ui-corner-top"),
                    r.$bottom[h]("ui-corner-bottom")
            } else if ("freezeCols" == t)
                e = parseInt(e),
                !isNaN(e) && e >= 0 && e <= r.colModel.length - 2 && a();
            else if ("freezeRows" == t)
                e = parseInt(e),
                !isNaN(e) && e >= 0 && a();
            else if ("resizable" == t)
                a(),
                ...
                e.data !== u.data && u.dataUF && (u.dataUF.length = 0),
                a();
            else {
                if ("groupModel" == t)
                ...
                if ("colModel" === t || "columnTemplate" == t)
                    a(),
                    r.iCols.init();
                else if ("disabled" === t)
                    r._super(t, e),
                    e === !0 ? r._disable() : r._enable();
                else if ("strLoading" === t)
                    a(),
                    r._refreshLoadingString();
                else if ("showTop" === t)
                    a(),
                    r.$top.css("display", e ? "" : "none");
                else if ("showTitle" === t)
                    a(),
                    r.$title.css("display", e ? "" : "none");
                    ...
                    "collapsible" === t ? (a(),
                        r._createCollapse()) : "showBottom" === t ? (a(),
                        r.$bottom.css("display", e ? "" : "none")) : "wrap" == t || "hwrap" == t ? ("wrap" == t ? l.$tbl.add(s.$tbl) : d.$tbl)[c(!e)]("pq-no-wrap") : "rowBorders" === t ? (a(),
                        h = c(e),
                        n = "pq-td-border-top",
                        l.$tbl[h](n),
                        s.$tbl[h](n)) : "columnBorders" === t ? (a(),
                        h = c(e),
                        n = "pq-td-border-right",
                        l.$tbl[h](n),
                        s.$tbl[h](n)) : a()
            }
            return r
    ...
    a.refreshCM = function(t, e) {
        ...
        a.collapse = function(t) {
            ...
            return t = t ? t : {},
                i._collapsed ? !1 : (i.htCapture = n.height(),
                    void(t.animate === !1 ? (n.height(23),
                        a()) : (i.animating = !0,
                        n.animate({
                            height: "23px"
                        }, function() {
        ...
        a.expand = function(t) {
            ...
            return t = t ? t : {},
                i._collapsed === !1 ? !1 : void(t.animate === !1 ? (n.height(o),
                    l()) : (i.animating = !0,
                    n.animate({
                        height: o
                    }, function() {
        ...
        a._onDblClickCell = function(e) {
            ...
            i.$td = r,
                0 != n._trigger("cellDblClick", e, i) && (n.options.editModel.clicksToEdit > 1 && n.isEditable(i) && n.editCell(i),
                    i.$tr = r.closest(".pq-grid-row"),
                    n._trigger("rowDblClick", e, i))
        },
        a.getValueFromDataType = function(e, n, r) {
            ...
            var i;
            if ("date" == n)
                return i = Date.parse(e),
                    isNaN(i) ? void 0 : r ? i : e;
            if ("integer" == n)
                i = parseInt(e);
            else {
                if ("float" != n)
                    return "bool" == n ? null == e ? e : (i = t.trim(e).toLowerCase(),
                        0 == i.length ? null : "true" == i || "yes" == i || "1" == i ? !0 : "false" == i || "no" == i || "0" == i ? !1 : Boolean(i)) : "object" == n ? e : null == e ? e : t.trim(e);
                i = parseFloat(e)
            }
        ...
        a.isEditableCell = function(t) {
            var e, n, r = t.column;
            return r || (e = this.normalize(t),
                    r = e.column),
                n = r.editable,
                null != n ? "function" == typeof n ? (e = e || this.normalize(t),
                    this.callFn(n, e)) : n : void 0
        },
        ...
        a._onMouseDownCont = function(e) {
            ...
            i.blurEditor({
                ...
                t(document).bind("mouseup" + i.eventNamespace, i._mousePQUpDelegate),
                n = i.pdata,
                n && n.length || (r = i.$cont[0],
        ...
        a._onMouseDown = function(e) {
            return function(n) {
                if ((!n.which || 1 == n.which) && e.evtBelongs(n)) {
                    ...
                    if (a.length && (n.currentTarget = a[0],
                            r = e._onMouseDownCell(n)),
                        n.isPropagationStopped())
                        return;
                    if (i = o.closest(".pq-grid-row"),
                        i.length && (n.currentTarget = i[0],
                            r = e._onMouseDownRow(n)),
                        n.isPropagationStopped())
                        return;
        ...
        a._onMouseDownCell = function(e) {
            ...
            null != o.rowIndx && (n = this.iMerge.getRootCellO(o.rowIndx, o.colIndx, !0),
                n.$td = i,
                r._trigger("cellMouseDown", e, n))
        },
            ...
            return function(n) {
                if (e.evtBelongs(n)) {
                    ...
                    if (null == o.rowIndx || null == o.colIndx)
                        return;
                    if (e._trigger("cellMouseEnter", n, o) === !1)
                        return;
                    return "cell" == i.hoverMode && e.highlightCell(r),
                        !0
                }
            }
        },
            ...
            return function(n) {
                if (e.evtBelongs(n)) {
                    var r = t(this),
                        ...
                        a = o.rowIndxPage;
                    if (e._trigger("rowMouseEnter", n, o) === !1)
                        return;
                    return "row" == i.hoverMode && e.highlightRow(a),
                        !0
                }
            }
        },
        ...
        a._onClickCell = function(e) {
            ...
            l.$td = o,
                l.evt = e,
                0 != n._trigger("beforeCellClick", e, l) && (n._trigger("cellClick", e, l),
                    null == s || 0 > s || (1 == i.clicksToEdit && n.isEditable(l) && n.editCell(l),
                        l.$tr = o.closest(".pq-grid-row"),
                        n._trigger("rowClick", e, l)))
        },
        ...
        a._onRightClick = function(e) {
            ...
            r.$td = n,
                0 != this._trigger("cellRightClick", e, r) && (r.$tr = n.closest(".pq-grid-row"),
                    this._trigger("rowRightClick", e, r))
        },
            ...
            if (r.type) {
                var i = {
                    ...
                    change: function(t, n) {
                        ...
                        void 0 != n.curPage && (r.prevPage = r.curPage,
                                r.curPage = n.curPage),
                ...
                i = t.extend(i, r),
                    i.rtl = n.rtl,
                    e.pageI = pq.pager(r.appendTo ? r.appendTo : this.$footer, i).on("destroy", function() {
                        delete e.pageI
                    })
            }
        },
        ...
        a.remoteRequest = function(e) {
            ...
            if ("function" == typeof s.getUrl) {
                ...
                var w;
                "local" != c.type && (w = this.iFilterData.getQueryStringFilter(),
                    w && (a = !0,
                        g = {
                            pq_filter: w
                        }));
        ...
        a.onRemoteSuccess = function(t, e, n, r, i) {
            ...
            o = "function" == typeof c.getData ? c.getData.call(a, t, e, n) : t,
                c.data = o.data,
                "remote" == d.type && (null != o.curPage && (d.curPage = o.curPage),
                    null != o.totalRecords && (d.totalRecords = o.totalRecords)),
                a.hideLoading(),
                a.loading = !1,
        ...
        a._destroyDraggable = function() {
            ...
            e.length && e.data("draggable") && (e.draggable("destroy"),
        ...
        a._refreshPager = function() {
            var t = this,
                ...
                i = n.rPP,
                o = n.totalRecords;
            r ? (t.pageI || t._initPager(),
                t.pageI.option(n),
                o > i ? t.$bottom.css("display", "") : e.showBottom || t.$bottom.css("display", "none")) : (t.pageI && t.pageI.destroy(),
                e.showBottom ? t.$bottom.css("display", "") : t.$bottom.css("display", "none"))
        },
        ...
        a._generateCellRowOutline = function() {
            ...
            if (!this.$div_focus) {
                var r = this.element;
                n.inline && (r = this.getCell(n.indices),
                        r.css("padding", 0).empty()),
        ...
        a.blurEditor = function(t) {
            if (this.$div_focus) {
                ...
                if (!t || !t.blurIfFocus)
                    return e.triggerHandler("blur", t);
        ...
        a.goToPage = function(t) {
            ...
            if ("local" == e.type || "remote" == e.type) {
                var n = t.rowIndx,
                    ...
                    o = e.curPage;
                i != o && (e.curPage = i,
                    "local" == e.type ? this.refreshView() : this.refreshDataAndView())
            }
        },
        ...
        a.saveEditCell = function(e) {
            ...
            if (null != d) {
                ...
                return C === !1 ? !1 : (this._trigger("cellSave", a, x),
                    !0)
            }
        },
        a._addInvalid = function(t) {},
        ...
        a._digestData = function(t) {
            if (t.rowList)
                throw "not supported";
            if (R = t.addList = t.addList || [],
                t.updateList = t.updateList || [],
                t.deleteList = t.deleteList || [],
                R.length && R[0].rowData)
                throw "rd in addList";
            if (this._trigger("beforeValidate", null, t) === !1)
                return !1;
            var e, n, r, i, o = this,
                a = o.options,
                l = a.editModel,
            ...
            for (!d && (d = s.data = []),
                ...
                if (S = this._digestNewRow($, O, F, A, "update", H, p, v, _),
                    S === !1)
                    return !1;
                S && E.push(P)
            }
            for (r = 0,
                ...
                if (null == H && (H = I),
                    ...
                    S = this._digestNewRow($, O, F, A, "add", H, p, v, _),
                    S === !1)
                    return !1;
                S && k.push(P)
            }
            return R = t.addList = k,
                M = t.updateList = E,
                e = R.length,
                n = T.length,
                e || M.length || n ? (x && (y.increment(),
                        y.push(t)),
                    o._digestUpdate(M, C, w),
                    n && (o._digestDelete(T, C, w, d, u, g, D),
                        q.addRowIndx()),
                    e && (o._digestAdd(R, C, w, d, u, g, D),
                        q.addRowIndx()),
                    o._trigger("change", null, t),
                    !0) : "edit" == _ ? null : !1
        },
        ...
        a.refreshCell = function(t) {
            var e = this.normalize(t),
                ...
                r = e.rowIndxPage,
                i = e.colIndx;
            this.iRenderB.refreshCell(r, i, e.rowData, e.column) && (n && n.rowIndxPage == r && this.focus(),
                e.skip || this._trigger("refreshCell", null, e))
        },
        ...
        a.refreshRow = function(t) {
            if (this.pdata) {
                var e, n = this,
                    ...
                    o = r.rowIndxPage,
                    a = r.rowData;
                return a ? (n.iRenderB.refreshRow(o),
                    n.refresh({
                        soft: !0
                    }),
                    (e = n._focusEle) && e.rowIndxPage == o && n.focus(),
                    n._trigger("refreshRow", null, {
                        rowData: a,
                        rowIndx: i,
                        rowIndxPage: o
                    }),
            ...
            if (!this._quitEditMode) {
                ...
                e._quitEditMode = !0,
                    t && (n = t.old,
                        ...
                        i = t.fireOnly,
                        s = t.evt),
                    l && (r || n || this._trigger("editorEnd", s, l),
                        i || (this._removeEditOutline(t),
                            a.indices = null)),
        ...
        a.editCell = function(t) {
            var e, n, r = this,
                ...
                a = i.rowIndx,
                l = i.colIndx;
            return o.ismergedCell(a, l) && (e = o.getRootCellO(a, l),
                e.rowIndx != i.rowIndx || e.colIndx != i.colIndx) ? !1 : void r.scrollCell(i, function() {
                return n = r.getCell(i),
                    n && n.length ? r._editCell(i) : void 0
            })
        },
        ...
        a._editCell = function(e) {
            ...
            if (void 0 === x && "function" == typeof c.geditor && (x = c.geditor.call(y, w)),
                x !== !1) {
                ...
                if (u.indices) {
                    ...
                    if (q.rowIndxPage == l && q.colIndx == s) {
                        ...
                        return D[0].focus(),
                            document.activeElement != D[0] && window.setTimeout(function() {
                                D.focus()
                            }, 0),
                            !1
                    }
                ...
                M.addClass("pq-align-" + (g.align || "left")),
                    w.$cell = M;
                var T, k = I.type,
                ...
                if (w.cls = F,
                    w.attr = V,
                    "function" == typeof k && (T = k.call(y, w),
                        T && (k = T)),
                    b._type = k,
                    "checkbox" == k) {
                    var U = I.subtype,
                        z = m ? "checked='checked'" : "";
                    T = "<input " + z + " class='" + O + "' " + V + " " + B + " type=checkbox name='" + v + "' />",
                        M.html(T);
                    ...
                    if ("textarea" == k)
                        T = "<textarea class='" + O + "' " + V + " " + j + " name='" + v + "' ></textarea>";
                    else if ("select" == k) {
                        var G = I.options || [];
                        ...
                        T = "<input class='" + O + "' " + V + " " + j + " type=text name='" + v + "' />";
                    t(T).appendTo(M).val("select" == k && null != P && (A[P] || this.columns[P]) ? A[P] ? h[A[P]] : h[P] : m)
                } else
                    k && "contenteditable" != k || (T = "<div contenteditable='true' tabindx='0' " + N + " " + V + " class='" + O + "'></div>",
                        M.html(T),
                        M.children().html(m),
                        _ = !0);
                S && (w.$editor = M.children(".pq-editor-focus"),
                    this.callFn(S, w));
                ...
                if (u.indices = Y,
                    D.data({
                        ...
                        if (!n._quitEditMode && !n._blurEditMode && i.indices) {
                            if (!u) {
                                if (n._trigger("editorBlur", e, Y) === !1)
                                    return;
                                if (!o)
                                    return;
                                if (l[0] == document.activeElement)
                                    return;
                                if (d && l.hasClass(d))
                                    return;
                                if (l.hasClass("hasDatepicker")) {
                                    ...
                                    if (t(".ui-multiselect-menu").is(":visible") || t(document.activeElement).closest(".ui-multiselect-menu").length)
                                        return
                                } else if (l.hasClass("pq-select-button") && (t(".pq-select-menu").is(":visible") || t(document.activeElement).closest(".pq-select-menu").length))
                                    return
                            }
                            n._blurEditMode = !0;
                            var f = u || a || !s;
        ...
        a.getCellFilter = function(t) {
            return t.ri = this.headerCells.length,
                this.getCellHeader(t)
        },
        ...
        a.getCellIndices = function(t) {
            var e, n = t.$td;
            return null == n || 0 == n.length || n.closest(".pq-grid")[0] != this.element[0] ? {} : (e = this.iRenderB.getCellIndx(n[0]),
                e ? this.iMerge.getRootCellO(e[0] + this.riOffset, e[1], !0) : {})
        },
        ...
        a.normalize = function(t, e) {
            ...
            var a = o.rowIndx,
                ...
                s = o.dataIndx,
                d = o.colIndx;
            return null == l && null == a || (n = this.riOffset,
                    a = null == a ? 1 * l + n : a,
                    l = null == l ? 1 * a - n : l,
                    o.rowIndx = a,
                    o.rowIndxPage = l,
                    o.rowData = o.rowData || e && e[a] || this.getRowData(o)),
                null == d && null == s || (r = this.colModel,
                    s = null == s ? r[d] ? r[d].dataIndx : void 0 : s,
                    d = null == d ? this.colIndxs[s] : d,
                    o.column = r[d],
                    o.colIndx = d,
                    o.dataIndx = s),
                o
            ...
            if (s)
                if (l !== !1 && null == r && (r = this.getRowIndx({
                    ...
                    if (e = d ? d + " " + a : a,
                        e = o(e.split(/\s+/)).join(" "),
                        s.pq_rowcls = e,
                        l !== !1 && null != r && this.SelectRow().inViewRow(r)) {
                        var c = this.getRow({
                            rowIndxPage: r
                        });
                        c && c.addClass(a)
        ...
        a.removeClass = function(t) {
            ...
            if (r) {
                ...
                if (a !== !1 && null == n && (n = this.getRowIndx({
                    ...
                    null == i) {
                    if (s && (r.pq_rowcls = this._removeClass(s, o),
                            null != n && a !== !1)) {
                        var d = this.getRow({
                            rowIndx: n
                        });
                    ...
                    for (var u = 0, h = c.length; h > u; u++) {
                        i = c[u];
                        var f = l[i];
                        if (f && (r.pq_cellcls[i] = this._removeClass(f, o),
                                null != n && a !== !1)) {
                            var p = this.getCell({
                                rowIndx: n,
                                dataIndx: i
        ...
        a.getRowIndx = function(t) {
            ...
            return null == i || 0 == i.length ? {} : (e = this.iRenderB.getRowIndx(i[0])[0],
                null == e ? {} : {
                    rowIndxPage: e,
                    rowIndx: e + a
                })
        ...
        a.calcWidthCols = function(t, e, n) {
            var r = 0,
                ...
                a = i.numberCell,
                l = this.colModel;
            if (-1 == t && (a.show && (r += n ? 1 * a.width : a.outerWidth),
                    t = 0),
                n)
                for (var s = t; e > s; s++) {
                    var d = l[s];
    ...
    e.prototype = {
        bodyKeyPressDown: function(e) {
            var n, r, i, o, a = this,
                ...
                I = e.keyCode;
            if (v.indices)
                return void l.$div_focus.find(".pq-cell-focus").focus();
            if (o = t(e.target),
                o.hasClass("pq-grid-cell"))
                f = l.getCellIndices({
                    $td: o
                });
            else if ("pq-grid-excel" != m.id && "pq-body-outer" != m.className)
                return;
            if (I == x.SPACE && o[0] == l.$cont[0])
                return !1;
            ...
            if (null != n && null != i && null != D.rowData) {
                if (h.ismergedCell(n, i) && (M = h.getRootCellO(n, i),
                        D = M,
                        r = D.rowIndxPage,
                        n = D.rowIndx,
                        i = D.colIndx,
                        I != x.PAGE_UP && I != x.PAGE_DOWN && I != x.HOME && I != x.END || (_ = h.getData(n, i, "proxy_cell")) && (q = _.rowIndx - s,
                            R[q].pq_hidden || (r = q,
                                n = r + s)),
                        p[i].hidden && (i = l.getNextVisibleCI(i))),
                    0 == l._trigger("beforeCellKeyDown", e, M))
                    return !1;
                if (l._trigger("cellKeyDown", e, M),
                    I == y || I == C || I == x.UP || I == x.DOWN || g.onTab && I == b) {
                    var k = null;
                    I == y && !c || I == C && c || I == b && e.shiftKey ? k = this.incrIndx(r, i, !1) : I == C && !c || I == y && c || I == b && !e.shiftKey ? k = this.incrIndx(r, i, !0) : I == x.UP ? k = this.incrRowIndx(r, i, !1) : I == x.DOWN && (k = this.incrRowIndx(r, i, !0)),
                        k && (n = k.rowIndxPage + s,
                            this.select({
                                rowIndx: n,
                                colIndx: k.colIndx,
                    ...
                    w ? n = l.getFirstVisibleRIP() + s : i = l.getFirstVisibleCI(),
                    this.select({
                        rowIndx: n,
                        colIndx: i,
                        evt: e
                    ...
                    w ? n = l.getLastVisibleRIP() + s : i = l.getLastVisibleCI(),
                    this.select({
                        rowIndx: n,
                        colIndx: i,
                        evt: e
                    ...
                    v.pressToEdit && (this.isEditKey(I) || u.on && 187 == I) && !w ? 46 == I ? l.clear() : (r = M.rowIndxPage,
                        i = M.colIndx,
                        S = l.getCell(M),
                        S && S.length && l.isEditable(M) && l.editCell({
                            rowIndxPage: r,
                            colIndx: i,
                            select: !0
                        }),
        ...
        setDataMergeCell: function(t, e) {
            var n, r = this.that,
                i = r.iMerge;
            i.ismergedCell(t, e) && (n = i.getRootCellO(t, e),
                i.setData(n.rowIndx, n.colIndx, {
                    proxy_cell: {
                        rowIndx: t,
                        colIndx: e
                    }
        ...
        incrEditIndx: function(t, e, n) {
            ...
            do {
                ...
                u = t + s,
                    l.ismergedCell(u, e) && (c = l.getRootCellO(u, e),
                        l.setData(c.rowIndx, c.colIndx, {
                            proxy_edit_cell: {
                                rowIndx: u,
                                colIndx: e
                            }
        ...
        incrIndx: function(t, e, n) {
            var r, i, o, a, l, s = this.that,
                ...
                g = p.length;
            if (null == e)
                return t == h ? null : (t = this[n ? "getNextVisibleRIP" : "getPrevVisibleRIP"](t), {
                    rowIndxPage: t
                });
            if (e == f)
                return {
            ...
            do
                o = t + u,
                d.ismergedCell(o, e) && (r = d.getRootCell(o, e),
                    !l && (i = d.getData(r.o_ri, r.o_ci, "proxy_cell")) && (a = i.rowIndx - u,
                        c[a].pq_hidden || (t = a)),
                    c[t].pq_hidden && (t = d.getRootCellV(o, e).rowIndxPage),
                    !l && n && (e = r.o_ci + (r.o_cc ? r.o_cc - 1 : 0))),
                n ? g - 1 > e && e++ : e > 0 && e--,
                l = p[e];
            while (l && l.hidden);
            return {
        ...
        incrRowIndx: function(t, e, n) {
            var r, i, o = this.that,
                ...
                l = t + a,
                s = o.iMerge;
            return s.ismergedCell(l, e) && (r = s.getRootCell(l, e),
                    i = s.getData(r.o_ri, r.o_ci, "proxy_cell"),
                    n && (t = r.o_ri - a + r.o_rc - 1),
                    e = i ? i.colIndx : r.v_ci),
                t = this[n ? "getNextVisibleRIP" : "getPrevVisibleRIP"](t), {
                    rowIndxPage: t,
                    colIndx: e
                }
        ...
        keyDownInEdit: function(e) {
            ...
            if (i) {
                var o = t(e.target),
                    ...
                    f = h ? t.extend({}, l, h) : l,
                    p = this.getValText(o);
                if (o.data("oldVal", o[p]()),
                    0 == n._trigger("editorKeyDown", e, s))
                    return !1;
                ...
                if (e.keyCode == a.ESCAPE)
                    return n.quitEditMode({
                            evt: e
                        }),
                        n.focus({
                            rowIndxPage: d,
                        ...
                        e.preventDefault(),
                        !1;
                if (e.keyCode == a.PAGE_UP || e.keyCode == a.PAGE_DOWN)
                    return e.preventDefault(),
                        !1;
                if (f.keyUpDown && !e.altKey) {
                    if (e.keyCode == a.DOWN)
                        return s = this.incrRowIndx(d, c, !0),
                            this.saveAndMove(s, e);
                    if (e.keyCode == a.UP)
                        return s = this.incrRowIndx(d, c, !1),
                            this.saveAndMove(s, e)
                }
            }
        },
        keyPressInEdit: function(e, n) {
            var r = this.that,
                ...
                h = d.dataType;
            if (t.inArray(e.keyCode, u) >= 0)
                return !0;
            if (r._trigger("editorKeyPress", e, t.extend({}, a)) === !1)
                return !1;
        ...
        saveAndMove: function(t, e) {
            ...
            var n, r, i = this,
                ...
                a = t.rowIndxPage,
                l = t.colIndx;
            return o._blurEditMode = !0,
                o.saveEditCell({
                    evt: e
                }) !== !1 && o.pdata ? (o.quitEditMode(e),
                    t.incr && (r = i[t.edit ? "incrEditIndx" : "incrIndx"](a, l, !e.shiftKey),
                        a = r ? r.rowIndxPage : a,
                        l = r ? r.colIndx : l),
                    o.scrollCell({
                        rowIndxPage: a,
...
function(t) {
    ...
    n.prototype = {
        autoFitCols: function() {
            ...
            if (i !== a) {
                for (var l, s = i - a, d = [], c = 0; n > c; c++) {
                    ...
                    if (!p && !h && !f) {
                        var g;
                        0 > s ? (g = u._maxWidth - u._width,
                            g && d.push({
                                availWd: -1 * g,
                                colIndx: c
                            })) : (g = u._width - u._minWidth,
                            g && d.push({
                                availWd: g,
                                colIndx: c
                            }))
        ...
        numericVal: function(t, e) {
            var n;
            return n = (t + "").indexOf("%") > -1 ? parseInt(t) * e / 100 : parseInt(t),
                Math.round(n)
        },
        refreshColumnWidths: function(t) {
            ...
            var e = this.that,
                ...
                h = n.maxColWidth,
                f = 0;
            r.show && (r.width < r.minWidth && (r.width = r.minWidth),
                f = r.outerWidth = r.width);
            var p = i ? null : s - c - f,
                ...
                for (var v = 0; d > v; v++) {
                    ...
                    if (!w) {
                        ...
                        if (C > b && (b = C),
                            void 0 != x) {
                            var I, _ = 0;
                            !i && y ? (e.percentColumn = !0,
                                    m.resizable = !1,
                                    m._percent = !0,
                                    I = this.numericVal(x, p) - o,
                                    _ = Math.floor(I),
                                    g += I - _,
                                    g >= 1 && (_ += 1,
                                        g -= 1)) : x && (_ = 1 * x),
        ...
        format: function() {
            ...
            return function(t, r) {
                ...
                if (pq.isDateFormat(r)) {
                    if (t == parseInt(t))
                        return pq.formulas.TEXT(t, pq.juiToExcel(r));
        ...
        renderCell: function(t) {
            var e, n, r, i, o = this.that,
                ...
                m = d.columnBorders;
            if (u) {
                s || (h.align && c.push("pq-align-" + h.align),
                    p == v - 1 && m && c.push("pq-last-frozen-col"),
                    h.cls && c.push(h.cls));
                var w, x, y = u[g],
                ...
                if (t.dataIndx = g,
                    t.cellData = y,
                    t.formatVal = b,
                    (i = h.render) && (w = o.callFn(i, t),
                        w && "string" != typeof w && ((e = w.attr) && a.push(e),
                            (r = w.cls) && c.push(r),
                            (n = w.style) && l.push(n),
                            w = w.text)),
                    null == w && (i = h._render) && (w = i.call(o, t)),
                    w && "string" != typeof w && ((e = w.attr) && a.push(e),
                        (r = w.cls) && c.push(r),
                        (n = w.style) && l.push(n),
                        w = w.text),
...
function(t) {
    ...
    n.getHeadCell = function(t) {
            var e, n, r, i = this.iRenderHead.getCellIndx(t[0]),
                o = i[0],
                a = i[1];
            return null != a && null != o && (n = this.headerCells[o],
                    n && (n = n[a]),
                    n && (r = n.colModel)),
                r && r.length && (e = !0), {
        ...
        e.cHeader.prototype = {
            ...
            colCollapse: function(t, e) {
                var n = this.that,
                    ...
                    i = t.collapsible;
                n._trigger("beforeColumnCollapse", e, r) !== !1 && (i.on = !i.on,
                    n._trigger("columnCollapse", e, r) !== !1 && n.refresh({
                        colModel: !0
                    }))
            },
            onHeaderClick: function(e) {
                var n, r, i, o, a = this,
                    l = this.that,
                    s = l.iDragColumns;
                if (l._trigger("headerClick", e),
                    !s || "stop" == s.status) {
                    if (o = t(e.target),
                        o.is("input,label"))
                        return !0;
                    if (n = o.closest(".pq-grid-col"),
                        n.length)
                        if (i = l.getHeadCell(n),
                            r = i.col,
                            o.hasClass("pq-col-collapse"))
                            a.colCollapse(r, e);
                        else if (!i.isParent)
                        return a.onHeaderCellClick(r, i.ci, e)
                }
            },
            ...
            createHeaderCell: function(t, e, n, r, i, o) {
                ...
                return n.pq_title = w,
                    ...
                    g && i.push(g),
                    i.push(n.clsHead),
                    m && i.push("pq-has-menu"),
                    v && v.length ? h && (i.push("pq-collapsible-th"),
                        a = ["<span class='pq-col-collapse pq-icon-hover ui-icon ui-icon-", h.on ? "plus" : "minus", "'></span>"].join("")) : i.push("pq-grid-col-leaf"),
                    l = "pq-row-indx=" + t,
                    s = "pq-col-indx=" + e,
                    ["<div ", s, " ", l, " ", f, " ", r, " ", " class='", i.join(" "), "' style='", o.join(""), "' >", "<div class='pq-td-div'>", a, "<span class='pq-title-span'>", w, "</span>", u, "</div>", m ? "<span class='pq-menu-icon'></span>" : "", "</div>"].join("")
            },
        ...
        e.cResizeColumns.prototype = {
                ...
                o.draggable({
                    ...
                    helper: function(e, n) {
                        ...
                        return a._setDragLimits(i),
                            a._getDragHelper(e, n),
                            r
                    },
                    start: function(t, e) {
                        n = t.clientX,
                            i = parseInt(a.$cl[0].style[l])
                    },
                    drag: function(t, e) {
                        r = t.clientX;
                        var o = r - n;
                        "right" == a.rtl && (o *= -1),
                            a.$cl[0].style[l] = i + o + "px"
                    },
                    stop: function(t, e) {
            ...
            _getDragHelper: function(e) {
                ...
                this.$clleft = t("<div class='pq-grid-drag-bar' " + f + u + "px;'></div>").appendTo(a),
                    this.$cl = t("<div class='pq-grid-drag-bar' " + f + h + "px;'></div>").appendTo(a)
            },
...
function(t) {
    ...
    e.cDragColumns = function(e) {
            ...
            n.that = e,
                ...
                n.rtl = r.rtl,
                n.status = "stop",
                n.$arrowTop = o("down", i.topIcon),
                n.$arrowBottom = o("up", i.bottomIcon),
                n.hideArrows(),
                i && i.enabled && e.$header.on("mousedown", ".pq-grid-col", n.onColMouseDown(n, e))
        },
        e.cDragColumns.prototype = {
            dragHelper: function(e, n, r) {
                ...
                return function() {
                    e.status = "helper",
                        n.$header.find(".pq-grid-col-resize-handle").hide();
                ...
                return function(r) {
                    ...
                    if (!r.pq_composed) {
                        if (t(r.target).is("input,select,textarea"))
                            return;
                        if (i = n.getHeadCell(s),
                            o = i.col,
                            a = o ? o.parent : null,
                            !o || o.nodrag || o._nodrag || a && 1 == a.colSpan)
                            return;
                        e.setDraggable(r, o, i) && (r.pq_composed = !0,
                            l = t.Event("mousedown", r),
                            t(r.target).trigger(l))
                    }
                }
            },
            onDrop: function() {
                ...
                return function(r, i) {
                    if (!e.dropPending) {
                        var o = 1 * i.draggable.attr("pq-col-indx"),
                            ...
                            c = e.leftDrop;
                        if (e.rtl && (c = !c),
                            n._trigger("beforeColumnOrder", null, {
                                colIndxDrag: o,
                                colIndxDrop: s,
                                left: c
                            }) !== !1) {
            ...
            onDrag: function(e, n) {
                return function(r, i) {
                    ...
                    d.length > 0 ? (e.updateDragHelper(!0),
                        o = d.width(),
                        a = r.clientX - d.offset().left + t(document).scrollLeft(),
                        s = o / 2 > a,
                        e.leftDrop = s,
                        e.showFeedback(d, s)) : (e.hideArrows(),
                        l = t(".pq-drop-hover", n.$top),
                        e.updateDragHelper(!!l.length))
                }
            },
            ...
            setDroppables: function(e) {
                for (var n, r, i, o, a, l, s = this, d = s.that, c = e.col, u = e.ri, h = e.o_ci, f = h + c.o_colspan, p = s.onDrop(), g = "pq-drop-hover ui-state-highlight", v = {
                        ...
                        tolerance: "pointer",
                        drop: p
                    }, m = d.$header.find(":not(.pq-grid-header-search-row)>.pq-grid-col"), w = m.length; w--;)
                    a = t(m[w]),
                    ...
                    r = n.ri,
                    i = n.ci,
                    o == c || o.nodrop || o._nodrop || r > u && i >= h && f > i ? l && a.droppable("destroy") : l || a.droppable(v)
            },
    ...
    e.cHeaderSearch = function(t) {},
        e.cHeaderSearch.prototype = {
            _bindFocus: function() {
                ...
                for (var n = this.that, r = this, i = n.$header.find(".pq-grid-header-search-row"), o = 0; o < i.length; o++)
                    t(i[o]).on("focusin", e)
            },
            _input: function(t, e, n, r, i, o) {
                return e = pq.formatEx(t, e, o),
                    ["<input ", ' value="', e, "\" name='", t.dataIndx, "' type=text style='", r, "' class='", n, "' ", i, " />"].join("")
            },
                ...
                for (;;) {
                    ...
                    if (!f.hidden && p) {
                        a.scrollColumn({
                            ...
                            return "textbox2" == (f.filterUI || {}).type && (n = t(h ? n[1] : n[0])),
                                n ? (n.focus(),
                                    e.preventDefault(),
                                    !1) : void 0
                        });
            ...
            bindListener: function(e, n, r, i) {
                var o = this,
                    ...
                    d = s[0],
                    c = s[1];
                pq.fakeEvent(e, n, a.options.filterModel.timeout),
                    e.off(n).on(n, function(n) {
                        var o, l, s = i.filterUI,
                            u = s.type,
                            h = s.condition;
                        return "checkbox" == u ? o = e.pqval({
                                incr: !0
                            }) : "textbox2" == u ? (o = t(e[0]).val(),
                                l = t(e[1]).val()) : o = e.val(),
                            o = "" === o ? void 0 : pq.deFormat(i, o, h),
                            l = "" === l ? void 0 : pq.deFormat(i, l, h),
                            d !== o || c !== l ? (d = o,
                                c = l,
                                r = pq.getFn(r),
                                r.call(a, n, {
            ...
            postRenderCell: function(e) {
                ...
                if (0 != c.length) {
                    ...
                    "checkbox" == u ? c.pqval({
                        ...
                        t.isArray(f) || (f = [f]),
                        e.format && (f = f.slice(0, 25).map(function(t) {
                    ...
                    for (var m = 0; m < v.length; m++) {
                        var w = v[m],
                            x = typeof w,
                            y = {};
                        "string" == x ? w = o.createListener(w) : "function" == x && (y[h[u]] = w,
                            w = y);
                        for (var C in w)
                            o.bindListener(c, C, w[C], e)
                    }
                }
            },
            getControlStr: function(t) {
                ...
                var f = "pq-grid-hd-search-field " + (c.cls || ""),
                    p = c.style || "",
                    g = c.attr || "";
                if (u && u.indexOf("textbox") >= 0)
                    a = a ? a : "",
                    f = f + " pq-search-txt" + i,
                    h = "textbox2" == u ? this.betweenTmpl(this._input(t, a, f + " pq-from", p, g, s), this._input(t, l, f + " pq-to", p, g, s)) : this._input(t, a, f, p, g, s);
                else if ("select" === u) {
                    f += i;
            ...
            renderFilterCell: function(t, e, n) {
                var r, i, o, a = this,
                    ...
                    c = t.cls,
                    u = t.halign || t.align;
                return u && n.push("pq-align-" + u),
                    c && n.push(c),
                    n.push(t.clsHead),
                    t.filter && (o = a.getControlStr(t),
                        o && n.push("pq-col-" + e)),
                    i = a.hasMenu(d, t),
                    i && n.push("pq-has-menu"),
                    r = ["<div class='pq-td-div' style='overflow:hidden;'>", "", o, "</div>", i ? "<span class='pq-filter-icon'></span>" : ""].join("")
            },
    ...
    t.extend(e, {
        ...
        e.prototype = {
            addRowIndx: function(t) {
                for (var e, n = this.that, r = n.options.dataModel, i = r.dataUF, o = n.get_p_data(), a = o.length; a--;)
                    e = o[a],
                    e && (e.pq_ri = a);
                if (t)
                    for (a = i.length; a--;)
            ...
            refreshGridWidthAndHeight: function() {
                ...
                if (a || l || c || f) {
                    ...
                    if (!g.length)
                        return;
                    var v, m;
                    g[0] == document.body || "fixed" == p.css("position") ? (v = t(window).width(),
                        m = window.innerHeight || t(window).height()) : (v = g.width(),
                        m = g.height());
                    var w = this._calcOffset,
                        x = a ? w(i.width) : 0,
                        y = l ? w(i.height) : 0;
                    f ? e = parseInt(i.maxWidth) * v / 100 : a && (e = parseInt(i.width) * v / 100 + x),
                        c ? n = parseInt(i.maxHeight) * m / 100 : l && (n = parseInt(i.height) * m / 100 + y)
                }
                e || (h && i.maxWidth ? u || (e = i.maxWidth) : a || (e = i.width)),
                    i.maxWidth && (this.maxWidthPixel = e),
                    n || (d && i.maxHeight ? s || (n = i.maxHeight) : l || (n = i.height)),
                    parseFloat(e) == e ? (e = e < i.minWidth ? i.minWidth : e,
                        p.css("width", e)) : "auto" === e && p.width(e),
                    parseFloat(n) == n && (n = n < i.minHeight ? i.minHeight : n,
                        p.css("height", n)),
            ...
            getParentDims: function() {
                var e, n, r = this.that,
                    i = r.element,
                    o = i.parent();
                return o.length ? (o[0] == document.body || "fixed" == i.css("position") ? (n = window.innerHeight || t(window).height(),
                        e = t(window).width()) : (n = o.height(),
                        e = o.width()),
                    [e, n]) : []
            },
            onWindowResize: function(n, r) {
                var i, o, a, l, s, d = this,
                    ...
                    p = c.options,
                    g = c.element;
                if (!e.isFullScreen() && !(t.support.touch && p.editModel.indices && t(document.activeElement).is(".pq-editor-focus") || r && (s = r.$grid,
                        s && (s == g || 0 == g.closest(s).length))))
                    return l = d.isReactiveDims(),
                        e.ISZOOM ? d.setResizeTimer(function() {
                            d.refresh({
                                soft: !0
                            })
                        }) : void(l && d.setResizeTimer(function() {
                            if (a = d.getParentDims(),
                                o = a[0],
                                i = a[1],
                                i == h && o == f) {
                                if (parseInt(g.width()) == parseInt(u.wdGrid))
                                    return
                            } else
                                u.htParent = i,
                                u.wdParent = o;
            ...
            refresh: function(t) {
                ...
                if (t.colModel && r.refreshCM(),
                    !l[0].offsetWidth)
                    return void l.addClass("pq-pending-refresh");
                s.css("height", "1px"),
            ...
            setCenterHeight: function() {
                var t, e = this.that,
                    n = e.$top,
                    r = e.options;
                return ("flex" !== r.height || r.maxHeight) && (t = e.dims.htGrid - (r.showTop ? n[0].offsetHeight + parseInt(n.css("marginTop")) : 0) - e.$bottom[0].offsetHeight + 1,
                        t = t >= 0 ? t : "",
                        e.$grid_center.height(t)),
                    t
            }
        },
        t(function() {})
...
function(t) {
    var e = t.paramquery.cCheckBoxColumn = function(e, n) {
        ...
        o.that = e,
            o.options = e.options,
            n.cbId ? (i = o.colUI = n,
                r = o.colCB = e.columns[n.cbId]) : r = i = o.colCB = o.colUI = n;
        var a = {
                all: !1,
                header: !1,
                select: !1,
            ...
            s = r.dataIndx;
        i._render = o.cellRender(r, i),
            e.on("dataAvailable", function() {
                e.one("dataReady", function() {
                    return o.oneDataReady()
                })
            }).on("dataReady", o.onDataReady.bind(o)).on("valChange", o.onCheckBoxChange(o)).on("cellKeyDown", o.onCellKeyDown.bind(o)).on("refreshHeader", o.onRefreshHeader.bind(o)).on("change", o.onChange(o, e, s, l.check, l.uncheck)),
            l.select && e.on("rowSelect", o.onRowSelect(o, e)).on("beforeRowSelectDone", o.onBeforeRowSelect(o, e, s, l.check, l.uncheck)),
            e.on("beforeCheck", o.onBeforeCheck.bind(o))
    };
    e.prototype = t.extend({
        cellRender: function(t, e) {
            ...
            return function(r) {
                var i, o, a, l = this,
                    ...
                    u = e.renderLabel,
                    h = e.useLabel;
                if (!(s.pq_gtitle || s.pq_gsummary || r.Export))
                    return i = c.check === s[d] ? "checked" : "",
                        o = n.isEditable(s, t, r.rowIndx, r.colIndx, d) ? "" : "disabled",
                        u && (a = u.call(l, r)),
                        null == a && (a = t == e ? "" : r.formatVal || r.cellData),
                        [h ? " <label style='width:100%;'>" : "", "<input type='checkbox' ", i, " ", o, " />", a, h ? "</label>" : ""].join("")
            }
        },
        checkAll: function(t, e) {
            t = null == t ? !0 : t;
        ...
        checkNodes: function(t, e, n) {
            if (t.length) {
                ...
                return i._trigger("beforeCheck", n, p) === !1 ? h() : (g.updateList = p.rows,
                    g.history = g.track = l.select ? !1 : null,
                    i._digestData(g) === !1 ? h() : void(l.maxCheck || 1 != g.updateList.length ? i.refresh({
                        header: !1
                    }) : i.refreshRow({
                        rowIndx: u
                    })))
        ...
        onBeforeRowSelect: function(t, e, n, r, i) {
            return function(o, a) {
                if ("checkbox" != a.source) {
                    var l = function(o) {
                        for (var a, l, s, d = o.length, c = e.columns[n], u = e.colIndxs[n]; d--;)
                            s = o[d],
                            a = s.rowIndx,
                            l = s.rowData,
                            t.isEditable(l, c, a, u, n) ? l[n] = l.pq_rowselect ? i : r : o.splice(d, 1)
                    };
                    l(a.addList),
                        l(a.deleteList)
                }
                    ...
                    c = function(t) {
                        t.forEach(function(t) {
                            ...
                            i.hasOwnProperty(n) && (e = i[n],
                                e === r ? a.push(t) : o && o[n] === r && l.push(t))
                        })
                    };
                t.setValCBox(),
                    c(o.addList),
                    c(o.updateList),
                    t.colCB.cb.select && e.SelectRow().update({
                        addList: a,
                        deleteList: l,
                        source: "checkbox"
                    }),
        ...
        oneDataReady: function() {
            ...
            if (null != l && n && a.select)
                for (; i > r; r++)
                    (t = n[r]) && (t[l] === a.check ? t.pq_rowselect = !0 : t.pq_rowselect && (t[l] = a.check))
        },
        onRowSelect: function(t, e) {
            return function(n, r) {
                "checkbox" != r.source && (r.addList.length || r.deleteList.length) && (t.setValCBox(),
                    e.refresh({
                        header: !1
                    }))
            }
...
function(t) {
    function e(t, e, n) {
        for (var r = 0, i = t.length; i > r; r++) {
            for (var o, a = t[r], l = {}, s = 0, d = e.length; d > s; s++)
                o = e[s],
                l[o] = a[o];
            n.push(l)
        }
    ...
    n.pqGrid.defaults = o.options,
        o.focus = function(e) {
            var n, r, i, o, a, l, s, d, c = e || {},
                ...
                w = c.colIndx;
            if (f)
                null != m && null != w || (i = this.getCellIndices({
                        $td: f
                    }),
                    m = i.rowIndxPage,
                    w = i.colIndx);
                ...
                if (null == m || null == w) {
                    if (r = this._focusEle,
                        p && p != document.body && "pq-grid-excel" != p.id && "pq-body-outer" != p.className)
                        return void(o = !0);
                    r ? (m = r.rowIndxPage,
                        w = r.colIndx) : o = !0
                }
                null != m && (s = u.iMerge,
                    l = m + u.riOffset,
                    s.ismergedCell(l, w) && (d = s.getRootCellO(l, w),
                        m = d.rowIndxPage,
                        w = d.colIndx),
                    f = u.getCell({
                        rowIndxPage: m,
            ...
            if (null != m && null != w) {
                ...
                x ? (p != document.body && t(p).blur(),
                    g.find(".pq-focus").removeAttr("tabindex").removeClass("pq-focus"),
                    g.removeAttr("tabindex"),
                    r = this._focusEle = this._focusEle || {},
                    f && (n = f[0]) && f.hasClass("pq-grid-cell") && !n.edited ? (r.$ele && r.$ele.length && r.$ele[0].removeAttribute("tabindex"),
                        r.$ele = f,
                        r.rowIndxPage = m,
                        r.colIndx = w,
                        n.setAttribute("tabindex", "-1"),
                        o || (f.addClass("pq-focus"),
                            n.focus())) : (a = h.dataModel.data,
                        a && a.length || v.setAttribute("tabindex", 0))) : (r = this._focusEle,
                    r && g.find(".pq-focus").removeClass("pq-focus"),
                    f && (f.addClass("pq-focus"),
                        this._focusEle = {
                            $ele: f,
                            rowIndxPage: m,
                            colIndx: w
                        }),
                    document.activeElement != v && (g.attr("tabindex", 0),
                        v.focus()))
            }
        },
        ...
        o._saveState = function(e, n, r) {
            ...
            for (i in r)
                o = r[i],
                o && (a = e[i],
                    t.isArray(o) ? null != a && (l = n[i] = t.isPlainObject(n[i]) ? n[i] : {},
        ...
        o.saveState = function(t) {
            t = t || {};
            for (var e, n, r, i, o = this, a = o.element, l = o.options, s = l.stateColKeys, d = l.stateKeys, c = o.colModel, u = [], h = 0, f = c.length, p = a[0].id; f > h; h++)
                n = c[h],
                e = n.dataIndx,
                r = {
                    dataIndx: e
            ...
            return i = {
                ...
                o._saveState(l, i, d),
                t.stringify !== !1 && (i = JSON.stringify(i),
                    t.save !== !1 && "undefined" != typeof Storage && localStorage.setItem("pq-grid" + (p || ""), i)),
                i
        },
        o.getState = function() {
        ...
        o.loadState = function(e) {
            ...
            for (var a, l, s, d = o.colModel, c = [], u = [], h = r.options, f = h.stateColKeys, p = r.depth > 1, g = p ? r.colModel : h.colModel, v = 0, m = d.length; m > v; v++)
                a = d[v],
                s = a.dataIndx,
                c[s] = a,
                u[s] = v;
            for (p || g.sort(function(t, e) {
                ...
                l = g[v],
                s = l.dataIndx,
                (a = c[s]) && r._saveState(a, l, f);
            return r.iCols.init(),
                i(h.sortModel, o.sortModel),
                i(h.pageModel, o.pageModel),
                r.Group().option(o.groupModel, !1),
                n = {
                    freezeRows: o.freezeRows,
                    freezeCols: o.freezeCols
                },
                isNaN(1 * h.height) || isNaN(1 * o.height) || (n.height = o.height),
                isNaN(1 * h.width) || isNaN(1 * o.width) || (n.width = o.width),
                r.option(n),
        ...
        o.refreshToolbar = function() {
            ...
            if (n._toolbar && (e = n._toolbar,
                ...
                e ? e.widget().replaceWith(d) : n.$top.append(d),
                    e = pq.toolbar(d, {
                        items: s,
                        gridInstance: n,
                        bootstrap: r.bootstrap
                    }),
                    r.showToolbar || d.css("display", "none"),
                    n._toolbar = e
            }
        },
        ...
        o._initTypeColumns = function() {
            for (var t = this.colModel, e = 0, r = t.length, i = this.iCheckBox = {}; r > e; e++) {
                var o = t[e],
                    a = o.type;
                "checkbox" == a || "checkBoxSelection" == a ? (o.type = "checkbox",
                    i[o.dataIndx] = new n.cCheckBoxColumn(this, o)) : "detail" == a && (o.dataIndx = "pq_detail",
                    this.iHierarchy = new n.cHierarchy(this, o))
            }
        },
        ...
        o.refreshHeaderFilter = function(t) {
            var e = this.normalize(t),
                ...
                o = {},
                a = i.rows - 1;
            this.options.filterModel.header && (i.refreshCell(a, n, o, r),
        ...
        o.getDataCascade = function(t, e, n) {
            var r, i, o = this,
                ...
                d = l.indexOf(t),
                c = a.mode;
            return "AND" == c && l.length && "remote" != a.type && (d >= 0 && l.splice(d, l.length),
                    l.length && (r = l.map(function(t) {
                            var e = o.getColumn({
                                    dataIndx: t
                                }).filter,
                                n = e.crules || [e];
        ...
        o.removeNullOptions = function(t, e, n) {
            ...
            return null == n ? t.filter(function(t) {
                var n = t[e];
                return null != n && "" !== n ? !0 : r ? void 0 : (r = !0,
                    t[e] = "",
                    !0)
            }) : t.filter(function(t) {
                var n = t[e];
        ...
        o.get_p_data = function() {
            ...
            return a ? (e = o.rPP,
                n = this.riOffset,
                !s.length && l.length && (s = l.slice(n, n + e)),
                t = "remote" == a,
                d = t ? new Array(n) : l.slice(0, n),
                r = t ? [] : l.slice(n + e),
                d.concat(s, r)) : s.length ? s : l
        },
        o._onDataAvailable = function(t) {
            ...
            return n !== !1 && t.trigger !== !1 && this._trigger("dataAvailable", t.evt, {
                ...
                "local" == s.type && i !== !1 && (n ? this.sort({
                    refresh: !1
                }) : o = this.iSort.sortLocalData(o, !0)),
        ...
        o.reset = function(e) {
            ...
            (o || d || c) && (o && (n = o === !0 ? {
                    ...
                    s(a.sortModel, n)),
                d && !l && this.iFilterData.clearFilters(i.colModel),
                c && (r = c === !0 ? {
                        dataIndx: []
                    } : c,
                    i.groupOption(r, !1)),
        ...
        o.pager = function() {
            var t;
            return this.pageI = this.pageI || ((t = this.widget().find(".pq-pager")).length ? t.pqPager("instance") : null),
                this.pageI
        },
        o.toolbar = function() {
        ...
        e.cColModel.prototype = {
            ...
            autoGenColumns: function() {
                ...
                if (l && l.length) {
                    ...
                    t.each(c, function(t, e) {
                        var n = "string";
                        s.isInteger(e) ? n = e + "".indexOf(".") > -1 ? "float" : "integer" : s.isDate(e) ? n = "date" : s.isFloat(e) && (n = "float"),
                            d.push({
                                dataType: i ? i : n,
                                dataIndx: t,
                                title: o ? o : t,
            ...
            cacheIndices: function() {
                for (var t, e, n = this.that, r = "JSON" == this.getDataType(), i = {}, o = {}, a = {}, l = n.colModel, s = 0, d = l.length, c = 0, u = this.vciArr = [], h = this.ciArr = []; d > s; s++) {
                    var f = l[s],
                        p = f.dataIndx;
                    null == p && (p = "detail" == f.type ? "pq_detail" : r ? "dataIndx_" + s : s,
                            "pq_detail" == p && (f.dataType = "object"),
                            f.dataIndx = p),
                        i[p] = f,
                        o[p] = s,
                        t = f.validations,
                        ...
                        f.hidden || (h[c] = s,
                            u[s] = c,
                            c++),
                        f.align || (e = f.dataType,
                            !e || "integer" != e && "float" != e || (f.align = "right"))
                }
                n.columns = i,
                    n.colIndxs = o,
                    n.validations = a
            ...
            collapse: function(t) {
                ...
                if (l) {
                    for (; s--;)
                        e = a[s],
                        null === c ? (r = e.showifOpen === o,
                            r && d++) : r = u === s ? !1 : o,
                        e.hidden = r,
                        r || !(n = e.colModel) || e.collapsible || this.each(function(t) {
                            t.hidden = r
                        }, n);
            ...
            extend: function(e, n) {
                for (var r, i, o = t.extend, a = e.length; a--;) {
                    ...
                    for (r in n)
                        void 0 === l[r] && (i = n[r],
                            i && "object" == typeof i ? l[r] = o(!0, {}, i) : l[r] = i)
                }
            },
            find: function(t, e) {
                for (var n, r, i = this.that, o = e || i.options.colModel, a = 0, l = o.length; l > a; a++) {
                    if (n = o[a],
                        t.call(i, n))
                        return n;
                    if (n.colModel && (r = this.find(t, n.colModel)))
                        return r;
                }
            },
                        ...
                        if (0 == o)
                            ...
                            if (u && 0 != u.length) {
                                for (var h = s - c.leftPos, f = 0, p = 0, g = 0; g < u.length; g++)
                                    if (f += u[g].childCount > 0 ? u[g].childCount : 1,
                                        f > h) {
                                        p = g;
                                        break
                                    }
            ...
            hide: function(t) {
                ...
                t.diShow = t.diShow || [],
                    t.diHide = t.diHide || [],
                    e._trigger("beforeHideCols", null, t) !== !1 && (t.diShow = t.diShow.filter(function(t) {
                            var e = n[t];
                            return e.hidden ? (delete e.hidden,
                                !0) : void 0
                        }),
                        t.diHide = t.diHide.filter(function(t) {
                            var e = n[t];
                            return e.hidden ? void 0 : (e.hidden = !0,
                                !0)
                        }),
                        e.refresh({
                            colModel: !0
            ...
            init: function(t) {
                ...
                s || (i.autoGenColumns(),
                    ...
                    e = i.nestedCols(s),
                    o.depth = e.depth,
                    n = o.colModel = e.colModel,
                    r = n.length,
                    l && i.extend(n, l),
                    i.getHeaderCells(),
                    i.assignRowSpan(),
                    i.cacheIndices(),
                    o._trigger("CMInit", null, t)
            },
            nestedCols: function(t, e, n, r) {
                ...
                for (var a = e, l = 0, s = 0, d = 0, c = 0, u = 0; i > u; u++) {
                    ...
                    r && (f.parent = r),
                        n === !0 && (f.hidden = n),
                        p && p.length ? (f.collapsible && this.collapse(f),
                            h = this.nestedCols(p, e + 1, f.hidden, f),
                            o = o.concat(h.colModel),
                            h.colSpan > 0 ? (h.depth > a && (a = h.depth),
                                f.colSpan = h.colSpan,
                                l += h.colSpan) : f.colSpan = 0,
                            c += h.o_colspan,
                            f.o_colspan = h.o_colspan,
                            f.childCount = h.childCount,
                            d += h.childCount) : (f.hidden ? f.colSpan = 0 : (f.colSpan = 1,
                                l++),
                            c++,
                            f.o_colspan = 1,
                            f.childCount = 0,
            ...
            reduce: function(t, e) {
                ...
                return (e || n.options.colModel).forEach(function(e, i) {
                        ...
                        l && (a = l.colModel,
                            a && a.length ? (o = this.reduce(t, a),
                                o.length && (l.colModel = o,
                                    r.push(l))) : r.push(l))
                    }, this),
                    r
            },
    ...
    function e(e, n) {
        ...
        r.that = e,
            ...
            e.on("cellClick", r.toggle.bind(r)).on("cellKeyDown", function(e, n) {
                ...
                e.iRenderB.removeView = r.removeView(r, e),
                    e.iRenderB.renderView = r.renderView(r, e)
        ...
        e.prototype = {
                        ...
                        n = setTimeout(function() {
                            ...
                            r.forEach(function(r) {
                                    if (document.body.contains(r)) {
                                        ...
                                        l != o && (a.pq_detail.height = o,
                                            n.push([i, o - l]))
                                    }
                                }),
                                r = [],
                                n.length && (t.that._trigger("onResizeHierarchy"),
                                    t.softRefresh(n))
                        }, 150)
                })
            },
            removeView: function(e, n) {
                ...
                return function(n, i, o) {
                    ...
                    for (a = n; i >= a; a++)
                        l = this.getRow(a, h),
                        l && 1 == l.children.length && (s = t(l),
                            d = s.children("." + u),
                            1 == d.length && (e.detachCells(d),
                    ...
                    if (e.refreshComplete) {
                        for (e.refreshComplete = !1,
                            ...
                            if (d = x[s],
                                ...
                                if (I.length) {
                                    if (!document.body.contains(I[0]))
                                        throw "incorrectly detached detail";
                                    I.css({
                                        top: _
                                    })
                                } else
                                    I = t("<div role='gridcell' id='" + e.getId(s) + "' class='" + h + "' style='" + q + "'></div>").append(b),
                                    t(u.getRow(s, m > s ? "tr" : "right")).append(I),
                                    e.onResize(e, I);
                                for (var D, R, M = I.find(".pq-grid"), T = 0, k = M.length; k > T; T++)
                                    D = t(M[T]),
                                    R = D.pqGrid("instance"),
                                    R._parent = n,
                                    D.hasClass("pq-pending-refresh") && D.is(":visible") && (D.removeClass("pq-pending-refresh"),
                                        R.refresh())
                            }
                        return e.refreshComplete = !0,
                            c
                    }
                }
            },
            renderCell: function(t) {
                var e, n = this.that.options.detailModel,
                    r = t.cellData,
                    i = t.rowData;
                return i.pq_gsummary || i.pq_gtitle ? "" : (e = r && r.show ? n.expandIcon : n.collapseIcon,
            ...
            rowExpand: function(t) {
                var e, n = this.that,
                    ...
                    s = "pq_detail";
                if (o) {
                    if (n._trigger("beforeRowExpand", null, r) === !1)
                        return;
                    e = o[s] = o[s] || {},
                        e.show = !0,
            ...
            rowCollapse: function(t) {
                ...
                if (s && s.show) {
                    if (r.close = !0,
                        e._trigger("beforeRowExpand", null, r) === !1)
                        return;
                    a.cache || this.rowInvalidate(r),
                        s.show = !1,
                        this.softRefresh([
...
function(t) {
    var e = function(t) {
        var e = this;
        e.that = t,
            e["class"] = "pq-grid-overlay",
            e.rtl = t.options.rtl ? "right" : "left",
            e.ranges = [],
        ...
        e.prototype = {
                ...
                if (t && this.addUnique(this.ranges, t)) {
                    ...
                    if (f) {
                        ...
                        var p, g, v, m, w, x, y, C, b, I, _ = h(r, i),
                            q = h(o, a);
                        if (f = u.getCellXY(r, i),
                            w = f[0] - 1,
                            x = f[1] - 1,
                            f = u.getCellCoords(o, a),
                            y = f[2],
                            C = f[3],
                            b = C - x,
                            I = y - w,
                            _ == q ? this.addLayer(w, x, b, I, s, _) : (p = h(r, a),
                                g = h(o, i),
                                v = _[0].offsetWidth,
                                m = _[0].offsetHeight,
                                g == _ ? (this.addLayer(w, x, b, v - w, s, _, "border-right:0;"),
                                    this.addLayer(0, x, b, y, s, q, "border-left:0;")) : _ == p ? (this.addLayer(w, x, m - x, I, s, _, "border-bottom:0;"),
                                    this.addLayer(w, 0, C, I, s, q, "border-top:0;")) : (this.addLayer(w, x, m - x, v - w, s, _, "border-right:0;border-bottom:0"),
                                    this.addLayer(0, x, m - x, y, s, p, "border-left:0;border-bottom:0"),
                                    this.addLayer(w, 0, C, v - w, s, g, "border-right:0;border-top:0"),
                                    this.addLayer(0, 0, C, y, s, q, "border-left:0;border-top:0"))),
                            I = n.options.numberCell.outerWidth || 0,
                            this.addLayer(0, x, b, I, d, u.$clt, ""),
                            this.addLayer(0, x, b, I, d, u.$cleft, ""),
                            0 != n.options.showHeader) {
                            u = n.iRenderHead,
                                f = u.getCellXY(0, i),
                                w = f[0],
                                x = f[1],
                                f = u.getCellCoords(n.headerCells.length - 1, a),
                                y = f[2],
                                C = f[3],
                                b = C - x,
                                I = y - w;
                            var D = u.$cright;
                            this.addLayer(w, x, b, I, c, D, ""),
                                D = u.$cleft,
                                this.addLayer(w, x, b, I, c, D, "")
                        }
                    }
            ...
            onRefresh: function(t, e) {
                ...
                return function() {
                    clearTimeout(n),
                        n = setTimeout(function() {
                            e.element && (t.removeAll(),
                                e.Selection().address().forEach(function(e) {
                                    t.addBlock(e)
                                }))
                        }, 50)
                }
            ...
            removeAll: function() {
                var t = this.that,
                    e = t.$cont,
                    n = t.$header;
                e && (e.children().children().children("svg").remove(),
                        n.children().children().children("svg").remove()),
                    this.ranges = []
            },
            removeBlock: function(t) {
                if (t) {
                    ...
                    l >= 0 && (this.ranges.splice(l, 1),
                        e = "." + this["class"] + "." + this.serialize(n, r, i, o),
                        a.$cont.find(e).remove(),
                        a.$header.find(e).remove())
                }
            },
            ...
            shiftRC: function(t, e, n, r) {
                ...
                return t -= c,
                    n -= c,
                    t = d > t ? Math.max(t, Math.min(0, n)) : t,
                    t >= s || 0 > n ? void 0 : (n = Math.min(n, s - 1),
                        t += c,
                        n += c,
                        a.ismergedCell(t, e) && (i = a.getRootCell(t, e),
                            t = i.o_ri,
                            e = i.o_ci),
                        a.ismergedCell(n, r) && (i = a.getRootCell(n, r),
                            n = i.o_ri + i.o_rc - 1,
                            r = i.o_ci + i.o_cc - 1),
                        t -= c,
                        n -= c,
                        t = Math.max(t, 0),
                        n = Math.min(n, s - 1),
                        r = Math.min(r, o.colModel.length - 1),
                        [t, e, n, r])
            }
        }
}(jQuery),
function(t) {
    ...
    var n = pq.Range = function(t, e, r, i) {
        ...
        return this.that = t,
            this._areas = [],
            this instanceof n == 0 ? new n(t, e, r, i) : (this._type = r || "range",
                void this.init(e, i))
    };
    n.prototype = t.extend({
                    ...
                    m.copy !== !1 && (u = R[v],
                        d && (h = y(R, m, b, p, g),
                            h === u && (k.colIndx = g,
                                ...
                                k.dataIndx = v,
                                h = C(k, c, q)[0],
                                I[g] && /(\r|\n)/.test(h) && (h = this.newLine(h))),
                            D.push(h)),
                        s && void 0 !== u && (M[v] = void 0,
                            T[v] = u));
                s && a.push({
                        rowIndx: p,
                        rowData: R,
        ...
        copy: function(t) {
            ...
            if (u = null == u ? !0 : u,
                h = null == h ? !0 : h,
                m = null == m ? a.options.copyModel.render : m,
                w.length) {
                if (w.forEach(function(t) {
                        e = t.type,
                            ...
                            i = "cell" === e ? n : t.r2,
                            o = "cell" === e ? r : t.c2,
                            this._copyArea(n, i, r, o, v, p, f, g, s, d, m)
                    }, this),
                    d) {
                    var x = p.join("\n");
                    if (t.clip) {
        ...
        count: function() {
            for (var t = "range" === this._type, e = this.address(), n = 0, r = e.length, i = 0; r > i; i++)
                n += t ? this._countArea(e[i]) : 1;
            return n
        },
        cut: function(t) {
            return t = t || {},
        ...
        indexOf: function(t) {
            ...
            for (var e, n = t.r1, r = t.c1, i = t.r2, o = t.c2, a = this.address(), l = 0, s = a.length; s > l; l++)
                if (e = a[l],
                    "row" !== e.type && n >= e.r1 && i <= e.r2 && r >= e.c1 && o <= e.c2)
                    return l;
            return -1
        },
        index: function(t) {
            ...
            for (var e, n = t.type, r = t.r1, i = t.c1, o = t.r2, a = t.c2, l = this.address(), s = 0, d = l.length; d > s; s++)
                if (e = l[s],
                    n === e.type && r === e.r1 && o === e.r2 && i === e.c1 && a === e.c2)
                    return s;
            return -1
        },
        init: function(t, e) {
        ...
        rows: function(t) {
            var e = this.that,
                ...
                r = this.addressLast();
            if (r)
                for (var i = r.r1, o = r.c1, a = r.r2, l = r.c2, s = r.type, d = null == t ? i : i + t, c = null == t ? a : i + t, u = d; c >= u; u++)
                    n.push({
                        r1: u,
                        c1: o,
                        r2: u,
        ...
        _normal: function(t, e) {
            ...
            return g = m - f + 1,
                v = w - p + 1,
                0 > h || 0 > c ? null : (f > m && (a = f,
                        f = m,
                        m = a),
                    p > w && (a = p,
                        p = w,
                        w = a),
                    null != f || null != p ? (null == f ? (f = 0,
                            m = c,
                            w = null == w ? p : w,
                            l = "column") : null == p ? (!t._type,
                            p = 0,
                            m = null == m ? f : m,
                            w = h,
                            l = t._type || "row") : null == m || f == m && p == w ? (l = "cell",
                            m = f,
                            w = p) : l = "block",
                        e && (n = s.iMerge.inflateRange(f, p, m, w),
                            f = n[0],
                            p = n[1],
                            m = n[2],
                            w = n[3]),
    ...
    var r = pq.Selection = function(e, n) {
        if (null == e)
            throw "invalid param";
        return this instanceof r == 0 ? new r(e, n) : (this._areas = [],
            this.that = e,
            this.iCells = new t.paramquery.cCells(e),
            void this._base(e, n))
    };
    pq.extend(n, r, {
        add: function(t, e) {
        ...
        removeAll: function(t) {
            t = t || {},
                this._areas.length && (this.iCells.removeAll(),
                    this._areas = [],
                    t.trigger !== !1 && this.trigger())
        },
    ...
    t.widget("paramquery.pqToolbar", {
            ...
            _create: function() {
                ...
                for (h.addClass("pq-toolbar"); p > f; f++) {
                    ...
                    if (w.options = b,
                        "textbox" == x)
                        v = t([E, "<input type='text' " + P + ">", S].join(""));
                    else if ("textarea" == x)
                        v = t([E, "<textarea " + P + "></textarea>", S].join(""));
                    else if ("select" == x)
                        "function" == typeof b && (b = b.call(o, {
                            colModel: d
                        })),
                        b = b || [],
                        g = e.select({
                        ...
                        v = t(["<label class='btn btn-default' " + P + ">", I || "File", "<input type='file' style='display:none;'>", "</label>"].join(""));
                    else if ("checkbox" == x)
                        v = t([I ? "<label " + M + ">" : "", "<input type='checkbox' ", y ? "checked='checked' " : "", P, ">", I ? I + "</label>" : ""].join(""));
                    else if ("separator" == x)
                        v = t("<span class='pq-separator' " + [k, M].join(" ") + "></span>");
                    else if ("button" == x) {
                        var $ = "";
                        s && ($ = C ? "<span class='glyphicon " + C + "'></span>" : ""),
                            v = t("<button type='button' " + P + ">" + $ + I + "</button>"),
                            t.extend(b, {
                                label: I ? I : !1,
                                icon: C,
                                icons: {
                        ...
                        "string" == typeof x ? v = t(x) : "function" == typeof x && (g = x.call(o, {
                                colModel: d,
                                cls: D
                            }),
                            v = t(g));
                    v.appendTo(h),
                        m = this.getInner(v, I, x),
                        "checkbox" !== x && void 0 !== y && m.val(y);
        ...
        t.extend(e.pqToolbar.prototype, {
            ...
            _onEvent: function(e, n, r) {
                return function(i) {
                    "checkbox" == r.type ? r.value = t(i.target).prop("checked") : r.value = t(i.target).val(),
                        n.call(e, i)
                }
            },
            _destroy: function() {
    ...
    n.options.trackModel = {
        ...
        e.cUCData.prototype = {
            ...
            commitDelete: function(t, e) {
                for (var n, r, i, o, a = this.ddata, l = a.length, s = this.udata; l-- && (n = a[l].rowData,
                        r = n[e],
                        i = t.length);)
                    for (; i--;)
                        if (r == t[i][e]) {
            ...
            getChanges: function() {
                for (var e = (this.that,
                        this.udata), n = this.adata, r = this.ddata, i = t.inArray, o = [], a = [], l = [], s = [], d = 0, c = r.length; c > d; d++) {
                    var u = r[d],
                        h = u.rowData;
                    s.push(h)
                }
            ...
            isDirty: function(t) {
                ...
                if (a)
                    ...
                    (n.length || r.length || i.length) && (o = !0);
                return o
            },
            onDA: function(t) {
                return function(e, n) {
                    "filter" != n.source && (t.udata = [],
                        t.ddata = [],
                        t.adata = [])
                }
            },
            rollbackAdd: function(t, e) {
                for (var n = this.adata, r = [], i = (t.type,
                        0), o = n.length; o > i; i++) {
                    var a = n[i],
                        l = a.rowData;
                    r.push({
            ...
            rollbackDelete: function(t, e) {
                for (var n = this.ddata, r = [], i = (t.type,
                        n.length - 1); i >= 0; i--) {
                    var o = n[i],
                        a = (o.indx,
                            o.rowIndx),
            ...
            rollback: function(t) {
                var e = this.that,
                    ...
                    s = [],
                    d = n.data;
                null != o && "update" != o || (l = this.rollbackUpdate(r, d)),
                    null != o && "delete" != o || (a = this.rollbackDelete(r, d)),
                    null != o && "add" != o || (s = this.rollbackAdd(r, d)),
                    e._digestData({
                        history: !1,
                        allowInvalid: !0,
                        checkEditable: !1,
        ...
        n.getChanges = function(t) {
            if (this.blurEditor({
                ...
                if (e) {
                    if ("byVal" == e)
                        return this.iUCData.getChangesValue(t);
                    if ("raw" == e)
        ...
        n.moveNodes = function(t, e) {
            var n = this,
                ...
                o = r.dataModel.data;
            e = null == e ? o.length : e,
                n._trigger("beforeMoveNode"),
                t.forEach(function(t) {
                    e = pq.moveItem(t, o, o.indexOf(t), e)
                }),
                o != n.pdata && (n.pdata = o.slice(i, r.pageModel.rPP + i)),
                n._trigger("moveNode", null, {
                    args: arguments
                }),
                n.refresh()
        },
        ...
        e.prototype = t.extend({
            ...
            onCellClick: function(t, e) {
                var n, r = this.that,
                    ...
                    l = r.iRows;
                if ("row" == i.type) {
                    if (!i.row && -1 == e.colIndx)
                        return;
                    n = l.isSelected(e),
                        o && !n || a || !pq.isCtrl(t) ? !o && t.shiftKey ? l.extend(e) : !o || n && a ? (e.isFirst = !0,
                            l[a ? "toggle" : "replace"](e)) : n || l.replace(e) : (e.isFirst = !0,
                            l.toggle(e))
                }
            },
...
function(t) {
    ...
    a.clip = "",
        a.prototype = {
            createClipBoard: function() {
                var e = this.that,
                    ...
                    o = t("#" + r);
                0 == o.length && (n = t("<div id='pq-grid-excel-div'  style='position:fixed;top:20px;left:20px;height:1px;width:1px;overflow:hidden;z-index:" + i.zIndex + ";'/>").appendTo(document.body),
                        o = t("<textarea id='" + r + "' autocomplete='off' spellcheck='false' style='overflow:hidden;height:10000px;width:10000px;opacity:0' />").appendTo(n),
                        o.css({
                            opacity: 0
                        }).on("keyup", function(t) {
            ...
            paste: function(e) {
                ...
                if (h.on && 0 != o.length && 0 != s) {
                    ...
                    if (n._trigger("beforePaste", null, D) === !1)
                        return !1;
                    q && n.getRowData({
                        rowIndx: q.r1
                    }) ? (f = "row" == q.type ? "row" : "cell",
                        m = q.r1,
                        x = q.r2,
                        w = q.c1,
                        y = q.c2) : (f = "cell",
                    ...
                    var R, M;
                    "replace" == C ? (R = m,
                        M = s > x - m + 1 ? "extend" : "repeat") : "append" == C ? (R = x + 1,
                        M = "extend") : "prepend" == C && (R = m,
                        M = "extend");
                    ...
                    for (v = 0; S > v; v++) {
                        ...
                        0 == t.isEmptyObject(N) && (null == V ? (p = !0,
                                $.push({
                                    newRow: N,
                                    rowIndx: O
                                })) : A.push({
        ...
        t(document).unbind(".pqExcel").bind("keydown.pqExcel", function(i) {
            if (pq.isCtrl(i)) {
                var o = t(i.target);
                if (!o.hasClass("pq-grid-cell") && !o.is("#" + r) && !o.hasClass("pq-body-outer"))
                    return;
                var s, d = o.closest(".pq-grid");
                if (e || o.length && d.length) {
                    if (!e) {
                        try {
                            if (s = d.pqGrid("instance"),
                                s.options.selectionModel["native"])
                                return !0
                        } catch (c) {
                            return !0
                        }
                    ...
                    if ("67" == i.keyCode || "99" == i.keyCode)
                        e.copy({
                            clip: t("#" + r)
                        });
                    else if ("88" == i.keyCode)
                        e.copy({
                            cut: !0,
                            clip: t("#" + r)
                        });
                    else if ("86" == i.keyCode || "118" == i.keyCode)
                        n = !0,
                        e.clearClipBoard(),
                        window.setTimeout(function() {
                            e && (e.paste({
            ...
            var i = r.keyCode;
            if (n || !e || pq.isCtrl(r) || -1 == t.inArray(i, [17, 91, 93, 224]) || (e.destroyClipBoard(),
                    e = null),
                l) {
                var o = t(r.target);
    ...
    i.prototype = {
        onKeyDown: function(t, e) {
            var n = {
                ...
                r = pq.isCtrl(t);
            return r && t.keyCode == n.z ? (this.undo(),
                !1) : r && t.keyCode == n.y ? (this.redo(),
                !1) : void 0
        },
        resetUndo: function() {
            if (0 == this.counter)
        ...
        push: function(e) {
            var n = this.canRedo(),
                r = this.records,
                i = this.counter;
            r.length > i && r.splice(i, r.length - i),
                r[i] = t.extend({
                    id: this.id
                }, e),
                this.counter++;
...
function(t) {
    ...
    pq.filter = {
            dpBeforeShow: function(e, n, r) {
                return function() {
                    ...
                    a.length && (i = "" == a[0][n] ? a[1][n] : a[0][n],
                            o = a[a.length - 1][n]),
                        t(this).datepicker("option", "defaultDate", new Date(1 == r ? o : i))
                }
            },
            datepicker: function(e) {
                ...
                return "date" == l ? (a.each(function(e, n) {
                        ...
                        a.defaultDate || (a.beforeShow = a.beforeShow || pq.filter.dpBeforeShow(i, r, e)),
                            t(n).datepicker(a)
                    }),
                    !0) : void 0
            },
        ...
        t.extend(pq.filter, {
            ...
            getFilterUI: function(e, n) {
                ...
                return d.condition = e.condition,
                    d.init = [],
                    d.options = [],
                    [i, o, l, s].forEach(function(t) {
                        t.init && d.init.push(t.init),
                            t.options && d.options.push(t.options)
                    }),
                    d
            },
            options: function(t) {
            ...
            getOptions: function(t, e, n) {
                for (var r, i, o = e.options, a = t.dataIndx, l = {
                    ...
                    if (r = o[s],
                        r && (i = "function" == typeof r ? r.call(n, l) : r))
                        return i = n.getPlainOptions(i, a),
                            i = n.removeNullOptions(i, e.dataIndx || a, e.groupIndx);
                return []
            },
    ...
    var n = function(t) {
        var e = this;
        e.that = t,
            t.on("load", e.onLoad.bind(e)).on("filter clearFilter", e.onFilterChange.bind(e))
    };
    e.cFilterData = n;
    var r = n.conditions = {
        equal: function(t, e) {
    ...
    n.convert = function(t, e) {
            return null == t || "" === t ? "" : ("string" == e ? t = (t + "").trim().toUpperCase() : "date" == e ? t = Date.parse(t) : "number" == e ? 1 * t == t && (t = 1 * t) : "bool" == e && (t = String(t).toLowerCase()),
                t)
        },
        n.convertEx = function(t, e, n, r) {
            var i = pq.getDataType({
                ...
                a = o[i];
            return a ? this.convert(t, i) : o.string ? (r && (t = pq.format(r, t)),
                "regexp" == n ? t : this.convert(t, "string")) : o.number ? this.convert(t, "number") : void 0
        },
        n.prototype = {
            ...
            clearFilters: function(t) {
                t.forEach(function(t) {
                    ...
                    e && (e.crules || []).forEach(function(t) {
                        (n[t.condition] || {}).nr && (t.condition = void 0),
            ...
            compatibilityCheck: function(t) {
                ...
                if (n)
                    if (e = n[0]) {
                        if (e.hasOwnProperty("dataIndx") && e.hasOwnProperty("value"))
                            throw r
                    } else if (!t.rules)
                    throw r
            },
            ...
            filter: function(t) {
                ...
                var e, n, r = this.that,
                    ...
                    g = 0,
                    v = l.length;
                if ("remove" != h && this.addMissingConditions(l),
                    s) {
                    if (r._trigger("beforeFilter", null, t) === !1)
                        return;
                    for (null != t.header && (o = t.header),
                        f && this.clearFilters(p); v > g; g++)
                        e = l[g],
                        n = r.getColumn({
                            dataIndx: e.dataIndx
                        }),
                ...
                return "remote" != d.location || "local" == c.type ? (m.source = "filter",
                    m.trigger = !1,
                    r._onDataAvailable(m)) : void r.remoteRequest({
                    apply: s,
                    CM: p,
                    callback: function() {
            ...
            hideRows: function(t, e, n) {
                for (var r, i = 0, o = e.length; o > i; i++)
                    r = e[i],
                    r.pq_hidden = !this.isMatchRow(r, t, n)
            },
                    ...
                    if (g.on && v && l && l.length) {
                        if (u.length)
                            if (e = {
                                ...
                                r._trigger("customFilter", null, e) === !1)
                                f = e.dataTmp,
                                p = e.dataUF;
                            else
                        ...
                        n && o && (e = {
                            ...
                            r._trigger("clearFilter", null, e) === !1 && (u = e.data),
                            0 == c.readSorter().length && (u = c.sortLocalData(u)),
                            d.data = u,
                            r._queueATriggers.filter = {
                                ui: {
                                    type: "local"
                                }
                            })
            ...
            _getRulesFromCM: function(e, r, i, o, a, l, s) {
                if ("between" === i)
                    ...
                    i && (o = s(o, l, i),
                        null != a && (a = s(a, l, i)));
                var f;
                return f = "remote" == e ? "" : ((r.conditions || {})[i] || {}).compare || pq.filter.conditions[i].compare || n.conditions[i],
                    [o, a, f, i]
            },
                ...
                for (var r = this, i = n.length, o = 0, a = t.location, l = "remote" === a, s = [], d = e.cFilterData, c = function(t, e, n) {
                    ...
                    if (h) {
                        var f, p, g, v, m, w, x = u.dataIndx,
                            ...
                            C = h.crules || [h],
                            b = [];
                        y = y && "stringi" != y && "function" != typeof y ? y : "string",
                            C.forEach(function(t) {
                                v = t.condition,
                                    p = t.value,
                                    g = t.value2,
                                    v && r.isCorrect(v, p, g) && (w = r._getRulesFromCM(a, h, v, p, g, y, c)) && (p = w[0],
                                        g = w[1],
                                        m = w[2],
                                        b.push({
                                            condition: w[3],
                            ...
                            b.length && (f = {
                                ...
                                l && 1 == b.length ? (f.value = b[0].value,
                                    f.value2 = b[0].value2,
                                    f.condition = b[0].condition) : (f.crules = b,
                                    f.mode = h.mode,
                                    l || (f.column = u)),
                                s.push(f))
                    }
                }
                return (t.apply || l) && this.sortRulesAndFMIndx(s),
                    s
            },
            ...
            getQueryStringFilter: function() {
                ...
                return i && i.on && s && (s.length ? (t = {
                        ...
                        d = r === !1 ? t : JSON.stringify(t)) : (d = "",
                        l.length && e._trigger("clearFilter"))),
                    d
            },
            isCorrect: function(t, e, n) {
                var r = pq.filter.conditions,
                    i = r[t];
                if (i)
                    return !!(null != e && "" !== e || null != n && "" !== n || i.nr);
                throw "filter condition NA"
            },
            isMatchCell: function(t, e) {
                for (var r, i, o, a, l, s, d, c = t.dataIndx, u = t.column, h = t.dataType, f = t.mode, p = [], g = t.crules, v = g.length, m = e[c], w = 0; v > w; w++)
                    s = g[w],
                    o = s.condition,
                    r = s.value,
                    i = s.value2,
                    a = s.cbFn,
                    o && (d = "regexp" === o ? null == m ? "" : m : n.convertEx(m, h, o, u),
                        p.push(!!a(d, r, i)));
                if (v = p.length,
                    "AND" === f) {
                    for (w = 0; v > w; w++)
            ...
            onFilterChange: function() {
                var t = this.that,
                    ...
                    d = (r.rules || []).reduce(function(t, e) {
                        return (e.found || s) && t.push(e.dataIndx),
                            t
                    }, []);
                o.forEach(function(e) {
                        var r = t.getCellHeader({
                            ...
                            i = n[e];
                        r.length && (r.removeClass(l),
                                t.getCellFilter({
                                    dataIndx: e
                                }).removeClass(l)),
                            i.clsHead = (i.clsHead || "").split(" ").filter(function(t) {
                                return t !== l
                            }).join(" ")
                    }),
                    d.forEach(function(e) {
                        var r = t.getCellHeader({
                            ...
                            i = n[e];
                        r.length && (r.addClass(l),
                                t.getCellFilter({
                                    dataIndx: e
                                }).addClass(l)),
                            i.clsHead = (i.clsHead || "") + " " + l
                    }),
                    r.oldDI = r.newDI = d
            },
            onLoad: function() {
    ...
    e.pqGrid.prototype.sort = function(t) {
            ...
            if (i && i.length || "local" != a) {
                var l, s = n.editModel,
                    ...
                    f = d.readCancel();
                if (t.sorter ? t.addon ? (t.single = h,
                        t.cancel = f,
                        l = d.addon(t)) : l = t.sorter : l = d.readSorter(),
                    l.length || c.length) {
                    ...
                    if (e._trigger("beforeSort", u, p) === !1)
                    ...
                    d.resumeSort(),
                        ...
                        d.writeSorter(l),
                        d.writeSingle(h),
                        "local" == a ? (r.data = d.sortLocalData(i, !t.skipCustomSort),
        ...
        n.prototype = {
            addon: function(e) {
                ...
                if (null != r)
                    ...
                    u > -1 ? (d = l[u].dir,
                        "up" == d ? l[u].dir = "down" : a && "down" == d ? l.splice(u, 1) : 1 == l.length ? l[u].dir = "up" : l.splice(u, 1)) : l.push(t.extend({}, n, {
                        dir: "up"
                    }))
                }
                return l
            ...
            compileSorter: function(t, e) {
                ...
                for (var g = 0; p > g; g++) {
                    ...
                    s[g] = _,
                        ...
                        }(b, r.sort_dataType) : "date" == b ? l[g] = r["sort_date" + (I ? "_fast" : "")] : "bool" == b ? l[g] = r.sort_bool : "stringi" == b ? l[g] = r.sort_locale : l[g] = r.sort_string,
                        I && n.addCache(e, b, m, _)
                }
                return n._composite(l, s, d, p)
            },
            _composite: function(t, e, n, r) {
                return function(i, o) {
                    for (var a = 0, l = 0; r > l && (a = t[l](i, o, e[l], n[l]),
                            0 == a); l++)
                    ;
                    return a
                }
            ...
            _sortLocalData: function(t, e, n) {
                ...
                return n && i._trigger("customSort", null, l) === !1 ? e = l.data : e.sort(a),
                    o.useCache && r.removeCache(t, e)(),
                    e
            },
    ...
    r.calcVisibleRows = e,
        ...
        n.prototype = {
            ...
            init: function() {
                for (var t = this.that, n = this.findNextVisibleColumn, r = this.findNextVisibleRow, i = this.calcVisibleColumns, o = t.colModel, a = t.options.mergeCells || [], l = t.get_p_data(), s = [], d = [], c = 0, u = a.length; u > c; c++) {
                    var h, f, p = a[c],
                        ...
                        C = p.rc,
                        b = p.cc;
                    if (y && m && (y.hidden && (x = n(o, w, b)),
                            h = i(o, w, w + b),
                            m.pq_hidden && (v = r(l, g, C)),
                            f = e(l, g, g + C),
                            !(1 > f || 1 > h))) {
                        s.push({
                                r1: g,
            ...
            getMergeCells: function(t, e, n) {
                for (var r, i, o, a = this.that, l = a.options.mergeCells, s = a.riOffset, d = s + n, c = [], u = l ? l.length : 0, h = 0; u > h; h++)
                    r = l[h],
                    i = r.r1,
                    o = r.c1,
                    (!e || i >= s && d > i) && (e && (i -= s),
        ...
        pq.aggregate = {
            ...
            max: function(t, e) {
                ...
                return t = this.flatten(t),
                    t.length ? ("float" == r || "integer" == r ? n = Math.max.apply(Math, t) : "date" == r ? (t.sort(function(t, e) {
        ...
        r.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
            addGroup: function(t, e) {
                var n = this,
                    ...
                    o = pq.objectify(i),
                    a = i.slice();
                null == t || o[t] || (null == e ? a.push(t) : a.splice(e, 0, t),
                    n.option({
                        dataIndx: a
                    }, "", "", function() {
                        n.triggerChange()
            ...
            createHeader: function() {
                for (var e = this, n = e.that, i = e.$header, o = n.options, a = o.bootstrap, l = n.columns, s = a.on, d = o.groupModel, c = d.dataIndx, u = c.length; u--;)
                    null == l[c[u]] && c.splice(u, 1);
                if (u = c.length,
                    d.header && d.on) {
                    if (i ? i.empty() : (i = e.$header = t("<div class='pq-group-header ui-helper-clearfix' ></div>").appendTo(n.$top),
                            i.on("click", ".pq-group-item", r.onGroupItemClick(e))),
                        u) {
                        for (var h = [], f = 0; u > f; f++) {
                            var p = c[f],
                                g = l[p],
                ...
                return function(e) {
                    ...
                    if (i.pq_gsummary || i.pq_gtitle) {
                        var o, a = pq.aggregate,
                            ...
                            u = l.dataType,
                            h = [""];
                        if (c(e.dataIndx, n.dataIndx) > -1)
                            return !1;
                        if (!n.summaryEdit && !d || d === !1)
                            return !1;
                        o = r.getAggOptions(u);
                        for (var f in a)
                            c(f, o) > -1 && h.push(f);
            ...
            editorInit: function(t) {
                ...
                n || (n = t.column.summary = {}),
                    e = n[r[t.rowData.pq_level]] || n.type,
            ...
            editorGetData: function(t) {
                ...
                return o[o[r] ? r : "type"] = a,
                    this.one("beforeValidate", function(t, n) {
                        n.allowInvalid = !0,
                            n.track = !1,
                            n.history = !1,
                            e.dataType = "string",
                            this.one(!0, "change", function(t, n) {
                                e.dataType = i
                            })
                    }),
                    a
            ...
            expandTo: function(t, e) {
                for (var n, r, i = this.that, o = !!e, a = t.split(","), l = a.length, s = this.childstr, d = this.getRoots(i.pdata), c = 0; l > c && (r = a[c],
                        n = d[r]);)
                    o || (n.pq_close = o),
                    d = n[s],
                    c++;
                n && (n.pq_close = o,
                    i._trigger("group", null, {
                        node: n,
                        close: o
                    }) !== !1 && this.softRefresh())
            },
            ...
            getAggOptions: function(t) {
                var e = this.that.options,
                    n = e.summaryOptions;
                return "integer" == t || "float" == t ? t = "number" : "date" !== t && (t = "string"),
                    n[t].split(",")
            },
            getVal: function(e) {
                var n = t.trim;
            ...
            groupData: function() {
                ...
                e.pdata = t.flattenG(l, t.group(i), r, s)(a),
                    t.summaryT()
            },
            hideRows: function(t, e, n, r) {
                for (var i, o = this.that, a = !0, l = o.pdata, s = t, d = l.length; d > s; s++)
                    if (i = l[s],
                        i.pq_gsummary)
                        n || r ? i.pq_level >= e && (i.pq_hidden = a) : i.pq_level > e && (i.pq_hidden = a);
                    else if (i.pq_gtitle) {
                    if (i.pq_level <= e)
                        break;
                    i.pq_hidden = a
            ...
            init: function() {
                ...
                a.onCMInit(),
                    a._init || (a.mc = [],
                        ...
                        n = t.bootstrap,
                        r = n.on,
                        i = r ? "glyphicon " : "ui-icon ",
                        a.groupRemoveIcon = "pq-group-remove " + i + (r ? "glyphicon-remove" : "ui-icon-close"),
                        a.toggleIcon = "pq-group-toggle " + i,
                        o.on("cellClick", a.onCellClick(a)).on("cellKeyDown", a.onCellKeyDown(a, e)).on(!0, "cellMouseDown", a.onCellMouseDown()).on("change", a.onChange(a, e)).on("dataReady", a.onDataReady(a, o)).on("beforeFilterDone", function() {
                            a.saveState()
                        }).on("columnDragDone", a.onColumnDrag(a)).on("columnOrder", a.onColumnOrder(a, e)).on("customSort", a.onCustomSort.bind(a)).on("valChange", a.onCheckbox(a, e)).on("refresh refreshRow", a.onRefresh(a, e)).on("refreshHeader", a.onRefreshHeader.bind(a)),
                        e.titleInFirstCol && o.on("CMInit", a.onCMInit.bind(a)),
                        o.on("beforeCheck", a.onBeforeCheck.bind(a)),
                        a.setCascadeInit(!0),
                        a._init = !0)
            },
            ...
            initHeader: function(t, e) {
                ...
                if (n.$header) {
                    ...
                    r.data("uiSortable") || n.initHeadSortable(),
                        i.length || r.append("<span class='pq-group-placeholder'>" + t.strGroup_header + "</span>"),
                        e.headerMenu && n.initHeaderMenu()
                }
            },
            initHeaderMenu: function() {
                for (var n, r = this, i = r.that, o = i.BS_on, a = i.options, l = r.$header, s = ["<ul class='pq-group-menu'><li>", o ? "<span class='glyphicon glyphicon-chevron-left'></span>" : "<div><span>&nbsp;</span></div>", "<ul>"], d = a.groupModel, c = d.menuItems, u = 0, h = c.length; h > u; u++)
                    e(s, d, c[u], a);
                s.push("</ul></li></ul>"),
                    n = t(s.join("")).appendTo(l),
                    n.menu({
                        icons: {
            ...
            initmerge: function() {
                ...
                i.on && (o ? c.forEach(function(n, r) {
                        u.forEach(function(n) {
                            n.pq_gtitle && r == n.pq_level && (t = e.getRC(n),
                                d.push({
                                    r1: n.pq_ri,
                                    rc: t,
                                    c1: r,
                    ...
                    d.length ? (e.mc = r.mergeCells = d,
                        n.iMerge.init()) : this.mc.length && (e.mc.length = 0,
                        n.iMerge.init())
            },
                        ...
                        e && (r = t.pq_level,
                            ...
                            d && (n = d[t[u]],
                                null != n && (delete d[t[u]],
                                    i = t.pq_close = n)),
                            null == i && (i = t.pq_close),
                            i ? this.hideRows(h + 1, r, l, s) : l && (t.pq_hidden = !0))
            },
            updateItems: function(t) {
                ...
                return (t || r.that.pdata).forEach(function(t) {
                        t.pq_gtitle && (e = t[o],
                            n = e.length,
                            n && e[0][o] ? t.pq_items = r.updateItems(e) : t.pq_items = n,
                            i += t.pq_items)
                    }),
                    i
            },
            ...
            moveNodes: function(t, e, n, r, i) {
                ...
                if (t = t.slice(0),
                    w) {
                    for (d._trigger("beforeMoveNode"); w > m; m++)
                        l = t[m],
                        r ? e[c].splice(n++, 0, l) : (o = s.getParent(l),
                            a = o[c].indexOf(l),
                            i ? o[c].splice(a, 1) : o == e ? n = pq.moveItem(l, e[c], a, n) : (e[c].splice(n++, 0, l),
                                o[c].splice(a, 1))),
                        C && (p.forEach(function(t) {
                            ...
                            l[v] = C[v],
                            l[u] = C[u]),
                        r ? g.splice(b++, 0, l) : (a = g.indexOf(l),
                            i ? g.splice(a, 1) : b = pq.moveItem(l, g, a, b),
                            s.removeEmptyParent(o));
                    s.updateItems(),
                        s.summaryT(),
                        s.isCascade(f) && (s.cascadeInit(),
                            s.setValCBox()),
                        d.iRefresh.addRowIndx(),
                        s.initmerge(),
                        d._trigger((r ? "add" : i ? "delete" : "move") + "Node", null, {
                            args: arguments
                        }),
                        d.refresh({
                            header: !1
            ...
            onCellKeyDown: function(e, n) {
                return function(r, i) {
                    return i.rowData.pq_gtitle && t.inArray(i.dataIndx, n.dataIndx) >= 0 && r.keyCode == t.ui.keyCode.ENTER ? (e.toggleRow(i.rowIndxPage, r),
                        !1) : void 0
                }
            },
            onChange: function(t, e) {
                return function(n, r) {
                    e.source == r.source || "checkbox" == r.source || (t.summaryT(),
                        t.that.refresh())
                }
            },
            ...
            onCustomSort: function(t, e) {
                ...
                if (a.length && 1 == l.length) {
                    if (c >= 0 && d.groupChange)
                        return;
                    if ("pq_order" == s || (d.summary || {}).type)
                        return n._delaySort(e);
                    ...
                    return h = pq.arrayUnique(h, "dataIndx"),
                        n._delaySort(e, function(t) {
            ...
            summaryRestore: function() {
                function t(e, r) {
                    ...
                    return e.forEach(function(e) {
                            i.push(e),
                                t(e[n] || [], e).forEach(function(t) {
                                    i.push(t)
                                })
                        }),
                        r && r.pq_child_sum && i.push(r.pq_child_sum),
                        i
                }
                var e = this,
                    n = e.childstr,
            ...
            onDataReady: function(t, e) {
                return function() {
                    var n = e.options.groupModel,
                        r = n.dataIndx.length;
                    n.on && (r || n.grandSummary ? (e._trigger("skipGroup") !== !1 && (t.groupData(),
                                    t.buildCache()),
                                e.iRefresh.addRowIndx(),
                                t.refreshColumns(),
                                r && (t.initcollapsed(),
                                    t.initmerge(),
                                    t.isCascade(n) && t.cascadeInit())) : t.refreshColumns(),
                            t.setValCBox()),
                        t.createHeader()
                }
            },
            onColumnOrder: function(t, e) {
                return function() {
                    return e.titleInFirstCol ? (t.that.refreshView(),
                        !1) : void t.initmerge()
                }
            },
            option: function(e, n, r, i) {
                var o = e.dataIndx,
                    ...
                    f = c.dataIndx;
                0 != l._trigger("beforeGroupOption", null, h) && (e.agg && a.updateAgg(e.agg, c.agg),
                    c.on && f.length && (e.on === !1 || 0 === s) && a.showRows(),
                    t.extend(c, e),
                    i && i(),
                    a.init(),
                    a.setOption(),
                    l._trigger("groupOption", null, h),
                    n !== !1 && l.refreshView())
            },
            showRows: function() {
                ...
                return o && (s += l),
                    function(t) {
                        var o, l, c = t.rowData,
                            u = t.column,
                            h = u.renderLabel;
                        return t.Export ? void 0 : (o = h && h.call(r.that, t),
                            o = o || t.formatVal || t.cellData,
                            i && a && (n = r.renderCB(i, c, e.cbId),
                                n && (d = n[0])),
                            l = d && (u.useLabel || e.useLabel), {
            ...
            renderCell: function(t, e) {
                var n = this.renderTitle(t, e),
                    r = this.that,
                    i = e.dataIndx,
                    o = (pq.objectify(this.isPivot() ? i.slice(0, i.length - 1) : i),
                        this.renderBodyCell(t, e)),
            ...
            renderSummary: function(t) {
                ...
                return function(r) {
                    var i, o, a, l = r.rowData,
                        s = r.column,
                        d = s.summary;
                    return d && (o = d[n[l.pq_level]] || d.type) ? (a = t.summaryTitle[o],
                        "function" == typeof a ? a.call(e, r) : (i = r.formatVal,
                            null == i && (i = r.cellData,
                                i = null == i ? "" : i),
                            "number" != typeof i || s.format || parseInt(i) === i || (i = i.toFixed(2)),
            ...
            renderTitle: function(t, e) {
                ...
                return function(t) {
                    var s, h, f, g, v, m = t.rowData,
                        w = t.column,
                        x = w.useLabel;
                    return null != t.cellData ? (s = m.pq_close,
                        h = m.pq_level,
                        f = e.title,
                        i.updateformatVal(e, t, h),
                        f = w.renderLabel || f[h] || e.titleDefault,
                        f = "function" == typeof f ? f.call(o, t) : f.replace("{0}", t.formatVal || t.cellData).replace("{1}", m.pq_items),
                        f = null == f ? t.formatVal || t.cellData : f,
                        v = s ? 1 : 0,
                        g = "pq-group-icon " + p[v],
                        t.Export ? f : (l && c && i.isCascade(e) && (n = i.renderCB(l, m, e.cbId),
                                n && (r = n[0],
                                    n[1] && d.push(n[1]))),
                            x = r && (null != x ? x : e.useLabel), {
            ...
            refreshColumns: function() {
                for (var t, e, n, r = this.that, i = r.options, o = i.groupModel, a = o.on, l = o.fixCols, s = this.renderCell(i, o), d = o.dataIndx, c = d.length, u = r.colModel, h = u.length; h--;)
                    t = u[h],
                    t._renderG && (delete t._render,
                        delete t._renderG),
                    t._nodrag && (delete t._nodrag,
                        delete t._nodrop),
                    a && (e = t.summary) && e.type && s(t);
                if (i.geditor = a ? this.editorSummary(i, o) : void 0,
                    a)
                    if (o.titleInFirstCol)
                        t = this.firstCol(),
                        s(t, !0);
                    else
                        for (h = c - 1; h >= 0; h--)
                ...
                if (l && a)
                    for (h = 0; c > h; h++)
                        ...
                        n != h && (r.iDragColumns.moveColumn(n, h, !0),
                            r.refreshCM(null, {
                                group: !0
                            }))
            },
            ...
            setSumCols: function(t) {
                var e = [],
                    n = [];
                return t = pq.objectify(t),
                    this.that.colModel.forEach(function(r) {
                        var i, o = r.summary;
                        o && o.type && (i = r.dataIndx,
                            t[i] || (e.push(r),
                                n.push(i)))
                    }),
                    this._sumCols = e,
            ...
            setOption: function() {
                var t = this;
                t._init && (t.refreshColumns(),
                    t.summaryData.length = 0,
                    t.initmerge())
            },
...
function(t) {
    ...
    var i = e.cDrag = function(t) {
        var e = this,
            ...
            i = n.dragModel;
        i.on && (e.that = t,
            n.postRenderInterval = n.postRenderInterval || -1,
            e.model = i,
            e.ns = ".pq-drag",
            i.tmplDragN = e.rtlfy(r, i.tmplDragN),
            i.tmplDrag = e.rtlfy(r, i.tmplDrag),
    ...
    n.Drag = function() {
        ...
        i.prototype = {
            ...
            getHelper: function(e) {
                ...
                return u.find("span:eq(1)").html(c),
                    n.addRejectIcon(),
                    u.addClass("pq-theme pq-drag-helper").css(i.cssHelper).data("Drag", n),
                    u[0]
            },
            getUI: function() {
                return this.cellObj
            ...
            onCreate: function() {
                var e = this,
                    ...
                    i = -1 == n.diDrag;
                e.that.on(!0, "cellMouseDown", e.onCellMouseDown.bind(e)),
                    r[e.rtl ? "right" : "left"] = 2,
                    e.ele = e.that.$cont.children(":first").addClass(n.clsDnD + (i ? " pq-drag-number" : "")).draggable(t.extend({
                        cursorAt: r,
            ...
            drop: function(t, e) {
                var n = e.helper.data("Drag"),
                    ...
                    d = function(t) {
                        var e;
                        t.isFolder(a) ? (e = a,
                                l || (c = 0)) : (e = t.getParent(a),
                                c = t.getChildren(e).indexOf(a) + (l ? 0 : 1)),
                            h ? t.moveNodes(f, e, c) : t.addNodes(f, e, c)
                    };
                if (n) {
                    var c, u = n.getUI(),
                        h = n.grid() == r,
    ...
    i.prototype = {
        ...
        onDrag: function(t, e) {
            var n = this,
                ...
                o = n.Drag,
                a = function() {
                    n.denyDrop = n.callFn("isDroppable", t, e) === !1,
                        n.denyDrop ? (o && o.out(),
                            n.removeFeedback()) : (o && o.over(),
                            n.feedback(t, i))
                };
            (i.length || n.that.$cont[0].contains(r[0])) && (n.addUI(e, t, i),
                e.rowData && a())
        },
            ...
            var n, r = this,
                ...
                l = function(r) {
                    if (a && a.grid() != i)
                        ...
                        try {
                            n = o.draggable("instance"),
                                n.options[r].call(o[0], t, e)
                        } catch (l) {}
                };
            l("beforeDrop"),
                r.callFn("drop", t, e),
        ...
        onDrop: function(t, e) {
            ...
            r.onOut(t, e),
                r.denyDrop || (n = r.getCell(i),
                    (n.length || r.that.$cont[0].contains(i[0])) && (r.addUI(e, t, n),
                        r.onDropX(t, e)))
        },
        onMouseout: function() {
            this.removeFeedback()
...
function(t) {
    ...
    var n = e.cContext = function(t) {
        ...
        e.that = t,
            e.ns = ".pq-cmenu",
            e.rtl = n.rtl,
            t.on("cellRightClick " + (r.head ? "headRightClick" : ""), e.onContext.bind(e)).on("destroy", e.removeMenu.bind(e))
    };
    n.prototype = {
        get$Item: function(e) {
        ...
        onclickDoc: function(t) {
            ...
            r ? r.disabled || (n = r.action,
                n && (e = n.call(this.that, t, this.ui, r),
                    e !== !1 && this.removeMenu())) : this.removeMenu()
        },
        removeMenu: function() {
            this.$menu && (this.$menu.remove(),
                delete this.$menu,
                t(document.body).off(this.ns))
        },
        ...
        onMouseOver: function(t) {
            var e, n = this,
                ...
                a = n.get$Item(t),
                l = (i || {}).subItems;
            a.siblings().each(n.removeSubMenu),
                l && l.length && !a[0][o] && (e = n.createMenu(l),
                    e.position({
        ...
        createMenu: function(e) {
            ...
            return e.forEach(function(t, e) {
                ...
                n = t("<div dir='" + (r.rtl ? "rtl" : "ltr") + "' class='pq-cmenu pq-theme pq-popup'><table>" + i + "</table></div>").appendTo(document.body),
                n.find(".pq-cmenu-item").each(function(n, r) {
                    t(r).data("item", e[n])
                }),
                n.on("mouseover", r.onMouseOver.bind(r)).on("remove", r.onRemove(r)),
                n
        },
        ...
        showMenu: function(e, n) {
            ...
            return a && r.removeMenu(),
                s && s.length ? (i.init.call(o, e, n),
                    r.ui = n,
                    a = r.$menu = r.createMenu(s),
                    a.css({
                        position: "absolute",
                        left: e.pageX - (r.rtl ? a.width() : 0),
                        top: e.pageY
                    }),
                    t(document.body).on("click" + r.ns, r.onclickDoc.bind(r)).on("contextmenu" + r.ns, r.onContextDoc.bind(r)),
                    !1) : void 0
        }
    }
}(jQuery),
function(t) {
    ...
    var e = t.paramquery,
        n = e.cAnim = function(t) {
            ...
            e.grid = t,
                n.on && t.on(n.events, e.onBefore.bind(e))
        },
            ...
            onBefore: function(t, e) {
                if (!t.isDefaultPrevented() && !this.data) {
                    var n, r = this,
                        ...
                        l = r.render = [];
                    try {
                        r.htTbl = o.dims.htTbl,
                            o.eachV(function(t, e) {
                                n = o.get$Row(e),
                                    t.pq_render = 1,
                                    l.push([t, n.clone(), n.map(function(t, e) {
                                        return e.parentNode
                                    })])
                            }),
                            a.forEach(function(t, e) {
                                t.pq_top = o.getTop(e),
                                    t.pq_hideOld = t.pq_hidden
                            }),
                            i.one("refresh", r.oneRefresh.bind(r)),
                            setTimeout(function() {
                                r.cleanUp()
                            })
                    } catch (s) {
            ...
            oneRefresh: function() {
                if (this.data) {
                    ...
                    n._active = !0,
                        l > s && a.css("height", l),
                        setTimeout(function() {
                            a.css("height", i.dims.htTbl),
                                n._active = !1
                        }, o),
                        i.eachV(function(t, n) {
                            delete t.pq_render;
                            var r, a, l = i.getTop(n),
                                s = t.pq_top;
                            (s != l || t.pq_hideOld) && (e = i.get$Row(n),
                                null == s || t.pq_hideOld ? (r = {
                                        opacity: 0
                                    },
                                    a = {
                                        opacity: 1
                        ...
                        n.render.forEach(n.removeRows.bind(n)),
                        n.cleanUp()
                }
            },
...
function(t) {
    ...
    var e = t.paramquery,
        n = e.cAnimH = function(t) {
            ...
            e.grid = t,
                e.rtl = n.rtl ? "right" : "left",
                r.on && t.on(r.eventsH, e.onBeforeCol.bind(e))
        },
        r = e.pqGrid.prototype;
    r.AnimH = function() {
            return this.iAnimH
        ...
        n.prototype = {
            ...
            onBeforeCol: function(t) {
                if (!t.isDefaultPrevented() && !this.data) {
                    ...
                    i.forEach(function(t, e) {
                            t.pq_hideOld = t.hidden,
                                t.pq_left = a.getLeft(e)
                        }),
                        a.eachH(function(t, n) {
                            e = o(n),
                                t.pq_render = 1,
                                l.push([t, e.clone(), e.map(function(t, e) {
                ...
                if (this.data) {
                    ...
                    r.eachH(function(n, a) {
                            ...
                            var l = r.getLeft(a),
                                ...
                                h = {};
                            (s != l || n.pq_hideOld) && (t = o(a),
                                null == s ? t.css(c).animate(u, i) : n.pq_hideOld ? (c[d] = s,
                                    u[d] = l,
                                    t.css(c).animate(u, i)) : (h[d] = l,
                                    t.css(d, s).animate(h, i)));
                        }),
                        e.render.forEach(e.removeCols.bind(e)),
                        e.cleanUp()
                }
            },
            removeCols: function(e) {
                ...
                a.pq_render && (delete a.pq_render,
                    ...
                    null == c || a.hidden ? (n.css("opacity", 1),
                        i = {
                            opacity: 0
                        }) : (r = d.getLeft(c),
                        i = {
...
function(t) {
    ...
    var n = e.cFillHandle = function(t) {
        ...
        e.$wrap,
            ...
            e.that = t,
            e.rtl = t.options.rtl,
            t.on("selectChange", e.onSelectChange(e)).on("selectEnd", e.onSelectEnd(e)).on("assignTblDims", e.onRefresh(e)).on("keyDown", e.onKeyDown.bind(e))
    };
    n.prototype = {
        ...
        create: function() {
            var e, n = this,
                r = n.that;
            if (!n.locked && (n.remove(),
                    e = r.Selection().address(),
                    1 === e.length)) {
                var e = e[0],
                    i = e.r2,
                    o = e.c2,
                ...
                if (d.length && r._trigger("beforeFillHandle", null, s) !== !1) {
                    ...
                    m[n.rtl ? "right" : "left"] = g,
                        w.css(m),
                        n.$wrap = w,
                        n.setDraggable(),
                        n.setDoubleClickable()
                }
            }
        },
        ...
        onRefresh: function(t) {
            var e;
            return function() {
                this.options.fillHandle ? (clearTimeout(e),
        ...
        patternDate: function(t) {
            ...
            return function(n) {
                var r = new Date(t);
                return r.setDate(r.getDate() + (n - 1)),
                    e.formatDate(r)
            }
        },
        ...
        patternDate2: function(t, e) {
            ...
            return !l && !s || !a && !l || !s && !a ? function(e) {
                    var n = new Date(t);
                    return a ? n.setDate(n.getDate() + a * (e - 1)) : l ? n.setMonth(n.getMonth() + l * (e - 1)) : n.setFullYear(n.getFullYear() + s * (e - 1)),
                        o.formatDate(n)
                } :
                (r = Date.parse(r),
                    n = Date.parse(i) - r,
        ...
        getDT: function(t) {
            for (var e, n, r, i = t.length, o = 0; i > o; o++) {
                if (e = t[o],
                    parseFloat(e) == e ? r = "number" : pq.validation.isDate(e) && (r = "date"),
                    n && n != r)
                    return "string";
                n = r
            }
        ...
        pattern: function(t) {
            ...
            var n, r, i, o = t.length,
                a = "date" === e;
            return 2 === o ? a ? this.patternDate2(t[0], t[1]) : (n = t[1] - t[0],
                r = t[0] - n,
                function(t) {
                    return n * t + r
                }
            ) : 3 === o ? (n = (t[2] - 2 * t[1] + t[0]) / 2,
                r = t[1] - t[0] - 3 * n,
                i = t[0] - n - r,
                function(t) {
                    return n * t * t + r * t + i
            ...
            if (w) {
                for (a = p; v >= a; a++) {
                    if (s = {
                        ...
                        c._trigger("autofillSeries", null, s),
                        !(d = s.series))
                        return;
                    f.push(d)
                }
        ...
        onKeyDown: function(e) {
            if (!this.oldAF && pq.isCtrl(e)) {
                ...
                n.oldAF = r.autofill,
                    r.autofill = !1,
                    t(document.body).one("keyup", function() {
                        r.autofill = n.oldAF,
                            delete n.oldAF
                    })
            }
    ...
    e.prototype = {
        ...
        onMouseDown: function(e) {
            var n, r = this,
                ...
                l = a.length,
                s = r.ns;
            (l || o.closest(i.$cont).length) && (n = o.closest(".pq-fill-handle").length,
                t(document).on("mousemove" + s, r[l && !n ? "onMouseMove" : "process"].bind(r)).on("mouseup" + s, r.onMouseUp.bind(r)))
        },
        onMouseMove: function(t) {
            var e = this,
                n = e.that;
            (e.capture || pq.elementFromXY(t).closest(n.$cont).length && n.iDrop.isOver()) && (e.capture = !0,
                e.process(t))
        },
        onMouseUp: function() {
        ...
        e.cFormula.prototype = {
            ...
            calcMainData: function() {
                var t = this.formulaSave(),
                    ...
                    n = t.length;
                if (n) {
                    for (var r = e.options, i = r.dataModel.data, o = i.length; o--;)
            ...
            onChange: function(t) {
                ...
                n && (t.addList.forEach(i),
                    t.updateList.forEach(i))
            },
            formulas: function() {
                var t, e, n = this.that,
                    r = [],
    ...
    n.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
        addNodes: function(t, e, n) {
            var r, i, o, a, l = this,
                ...
                x = [];
            if (e ? (i = e[f],
                    r = c.indexOf(e) + (null == n ? (e[h] || []).length : n) + 1) : r = c.length,
                t.forEach(function(t) {
                    var e = t[f];
                    if (!p[e] && (g.push(t),
                            w(e),
        ...
        collapseNodes: function(t, e, n) {
            for (var r, i, o = 0, a = this.that, l = t.length, s = [], d = !n; l > o; o++)
                r = t[o],
                this.isFolder(r) && this.isCollapsed(r) !== d && s.push(r);
            if (s.length && (i = {
                        close: d,
                        nodes: s
                    },
        ...
        deleteNodes: function(t) {
            var e, n, r = this,
                ...
                s = [];
            if (t) {
                for (e = t.length; e > o; o++)
                    n = t[o],
                    r.eachChild(n, function(t) {
                        var e = t[l];
                        a[e] || (a[e] = 1,
                            s.push({
                                rowData: t
        ...
        filter: function(t, e, n, r, i, o) {
            for (var a, l, s, d, c = this.childstr, u = 0, h = t.length; h > u; u++)
                a = t[u],
                l = !1,
                (d = a[c]) && (l = this.filter(d, e, n, r, i, o),
                    l && (s = !0,
                        i.push(a))),
                l || (n.isMatchRow(a, e, r) ? (s = !0,
                    i.push(a)) : o.push(a));
            return s
        },
        getFormat: function() {
            for (var t, e, n = this, r = n.that.options.dataModel.data, i = "flat", o = 0, a = r.length, l = n.parentId, s = n.childstr; a > o && (t = r[o],
                    null == t[l]); o++)
                if ((e = t[s]) && e.length)
                    return n.getParent(e[0]) == t ? "flat" : "nested";
            return i
        },
        getChildrenAll: function(t, e) {
            for (var n, r = this.childstr, i = t[r] || [], o = i.length, a = 0, l = e || []; o > a; a++)
                n = i[a],
                l.push(n),
                n[r] && this.getChildrenAll(n, l);
            return l
        },
        getLevel: function(t) {
            return t.pq_level
        ...
        _groupById: function(t, e, n, r, i) {
            for (var o, a = this, l = a.childstr, s = 0, d = n.length; d > s; s++) {
                ...
                c.pq_level = i,
                    t.push(c),
                    (o = r[u]) ? (c[l] = o,
                        a._groupById(t, e, o, r, i + 1)) : delete c[l]
            }
        },
        groupById: function(t) {
            for (var e, n, r, i = this, o = i.id, a = i.parentId, l = {}, s = [], d = 0, c = t.length; c > d; d++)
                r = t[d],
                e = r[a],
                null == e && (e = ""),
                (n = l[e]) || (n = l[e] = []),
        ...
        init: function() {
            ...
            t.cbId = i,
                ...
                t.childstr = r.childstr,
                t.onCMInit(),
                o ? t._init || (t.on("CMInit", t.onCMInit.bind(t)).on("dataAvailable", t.onDataAvailable(t, e, r)).on("dataReadyAfter", t.onDataReadyAfter(t, e, r)).on("beforeCellKeyDown", t.onBeforeCellKeyDown.bind(t)).on("customSort", t.onCustomSortTree.bind(t)).on("customFilter", t.onCustomFilter.bind(t)).on("clearFilter", t.onClearFilter.bind(t)).on("change", t.onChange(t, e, r)).on("cellClick", t.onCellClick.bind(t)).on("refresh refreshRow", t.onRefresh(t, r)).on("valChange", t.onCheckbox(t, r)).on("refreshHeader", t.onRefreshHeader.bind(t)).on("beforeCheck", t.onBeforeCheck.bind(t)),
                    t.setCascadeInit(!0),
                    t._init = !0) : t._init && (this.off(),
                    t._init = !1),
                t._init && (n.groupModel.on = r.summary)
        },
        initData: function() {
            var t = this,
                e = t.that,
                n = e.options,
                r = n.dataModel;
            r.data = t["flat" == t.getFormat() ? "groupById" : "flatten"](r.data),
                t.buildCache()
        },
        ...
        moveNodes: function(t, e, n) {
            ...
            if (t.forEach(function(t) {
                ...
                o = t.reduce(function(t, e) {
                    return m[e[c]] || t.push(e),
                        t
                }, []),
                a = o.length) {
                for (d._trigger("beforeMoveNode"); a > w; w++)
                    l = o[w],
                    r = s.getParent(l),
                    i = r[h].indexOf(l),
                    r == e ? n = pq.moveItem(l, e[h], i, n) : (e[h].splice(n++, 0, l),
                        r[h].splice(i, 1)),
                    l[c] = v;
                f.data = s.flatten(s.getRoots()),
                    d.refreshView(),
                    d._trigger("moveNode", null, {
                        args: arguments
                    })
            }
        },
        ...
        onBeforeCellKeyDown: function(e, n) {
            var r, i, o = this,
                ...
                c = t.ui.keyCode;
            if (s == o.dataIndx) {
                if (o.isFolder(l) && (i = l.pq_close,
                        d == c.ENTER && !a.isEditable({
                            rowIndx: l.pq_ri,
                            dataIndx: s
                        }) || !i && d == c.LEFT || i && d == c.RIGHT))
                    return o.toggleNode(l),
                        !1;
                if (d == c.SPACE && (r = a.getCell(n).find("input[type='checkbox']"),
                        r.length))
                    return r.click(),
                        !1
            }
        ...
        onChange: function(t, e, n) {
            return function(r, i) {
                var o = i.source || "",
                    a = i.addList.length,
                    l = i.deleteList.length; -
                1 == o.indexOf("checkbox") && ("undo" != o && "redo" != o || !a && !l ? n.summary && n.refreshOnChange && !a && !l ? (t.summaryT(),
                    e.refresh()) : "addNodes" != o && "deleteNodes" != o || t.refreshViewFull() : t.refreshViewFull())
            }
        },
        onClearFilter: function(t, e) {
            return e.data = this.groupById(e.data),
                !1
        },
        onCustomFilter: function(t, e) {
            var n = this,
                ...
                s = [],
                d = e.mode;
            return n.filter(n.getRoots(i), a, o, d, l, s),
                e.dataTmp = n.groupById(l),
                e.dataUF = s,
                !1
        },
        ...
        onDataReadyAfter: function(t, e, n) {
            return function() {
                n.summary && t.summaryT(t),
                    t.showHideRows(),
                    t.isCascade(n) && t.cascadeInit()
            }
        },
        option: function(e, n) {
            var r, i = this,
        ...
        renderCell: function(t, e) {
            return function(n) {
                ...
                if (p) {
                    var q = u.callFn(p, n);
                    null != q && ("string" != typeof q ? (q.iconCls && (w = q.iconCls),
                        null != q.text && (_ = q.text),
                        l = q.attr,
                        b.push(q.cls),
                        I.push(q.style)) : _ = q)
                }
                return n.Export ? t.exportCell(_, x) : (v && (s = t.renderCB(v, c, e.cbId),
                        s && (d = s[0],
                            s[1] && b.push(s[1]))),
                    m && (o = c.pq_close ? g[1] : g[0],
                        i = "<span class='pq-group-icon ui-icon " + o + "'></span>"),
                    w && (a = "<span class='pq-tree-icon ui-icon " + w + "'></span>"),
                    r = d && (f.useLabel || e.useLabel), {
                        cls: b.join(" "),
                        attr: l,
                        style: I.join(""),
        ...
        setCellRender: function() {
            var t, e, n = this,
                ...
                o = r.columns;
            i.summary && r.iGroup.refreshColumns(),
                (t = n.di_prev) && (e = o[t],
                    e && (e._render = null),
                    n.di_prev = null),
                (t = i.dataIndx) && (e = o[t],
                    e._render = n.renderCell(n, i),
                    n.di_prev = t)
        },
        _showHideRows: function(t, e, n) {
            for (var r, i, o, a = this, l = e || a.getRoots(), s = a.childstr, d = n || !1, c = l.length, u = 0; c > u; u++)
                r = l[u],
                r.pq_hidden = d,
                (o = r[s]) && (i = d || r.pq_close,
                    a._showHideRows(t, o, i))
        },
        showHideRows: function() {
            ...
            if (n._showHideRows(o),
                a)
                for (o = r.pdata,
                    t = o.length; t > i; i++)
                    e = o[i],
                    e.pq_gsummary && (e.pq_hidden = n.getParent(e).pq_hidden)
        },
        ...
        r.prototype = {
            _add: function(t, e) {
                var n, r = this.that,
                    ...
                    a = t.rowData,
                    l = this.inViewRow(i);
                return !a.pq_hidden && l && (n = r.getRow(t),
                        n.length && (n[o ? "addClass" : "removeClass"](this.hclass),
                            !o && n.removeAttr("tabindex"))),
                    a.pq_rowselect = o,
                    t
            },
            _data: function(t) {
            ...
            getSelection: function() {
                for (var t, e = this.that, n = e.get_p_data(), r = 0, i = n.length, o = []; i > r; r++)
                    t = n[r],
                    t && t.pq_rowselect && o.push({
                        rowIndx: r,
                        rowData: t
                    });
                return o
            ...
            replace: function(t) {
                t.deleteList = this.getSelection(),
                    this.add(t)
            },
            selectAll: function(t, e) {
                for (var n, r = this.that, i = [], o = r.riOffset, a = this._data(t), l = a[0], s = a[1], d = a[2]; d > s; s++)
                    n = l[s],
                    n && i.push({
                        rowIndx: s,
                        rowIndxPage: s - o,
            ...
            toRange: function() {
                for (var t, e, n, r = [], i = this.that, o = i.get_p_data(), a = 0, l = o.length; l > a; a++)
                    t = o[a],
                    t.pq_rowselect ? null != e ? n = a : e = n = a : null != e && (r.push({
                            r1: e,
                            r2: n
                        }),
                        e = n = null);
            ...
            update: function(t, e) {
                ...
                if (a = a.filter(function(t) {
                    ...
                    l = l.filter(n.isSelected.bind(n)),
                    a.length || l.length) {
                    if (i.addList = a,
                        i.deleteList = l,
                        r._trigger("beforeRowSelect", null, i) === !1)
                        return;
    ...
    n.prototype = {
        ...
        importS: function(t, n, r, i, o) {
            ...
            for (null != o && (I = o + 1,
                ...
                l = a.indx || C,
                s = {},
                l != C && this.fillRows(g, l, !0),
                a.cells.forEach(function(t, e) {
                    d = t.indx || e,
                        c = i && _ && b[d] ? b[d].dataIndx : d,
                        s[c] = t.value,
                        p.copyStyle(s, c, t),
                        t.format && p.copyFormat(s, c, t.format),
                        h = t.formula,
                        h && p.copyFormula(s, c, I ? q(h, 0, -I) : h),
                        d >= m && (m = d + 1)
                }),
                a.hidden && (s.pq_hidden = !0),
                g[l] = s;
            t.name && v.option("title", t.name),
                n && this.fillRows(g, g.length + n, !0),
                v.option("dataModel.data", g),
                m += r || 0,
                v.refreshCM(this.generateCols(m, t.columns, u)),
                v.option("mergeCells", (f || []).map(function(t) {
        ...
        copyFormat: function(t, e, n) {
            ...
            n = pq.isDateFormat(n) ? pq.excelToJui(n) : pq.excelToNum(n),
                r[e] = n
        },
        copyStyle: function(t, e, n) {
            var r, i, o = [];
            (r = n.font) && o.push("font-family:" + r),
                (r = n.fontSize) && o.push("font-size:" + r + "px"),
                (r = n.color) && o.push("color:" + r),
                (r = n.bgColor) && o.push("background:" + r),
                n.bold && o.push("font-weight:bold"),
                n.italic && o.push("font-style:italic"),
                n.underline && o.push("text-decoration:underline"),
                (r = n.align) && o.push("text-align:" + r),
                (r = n.valign) && o.push("vertical-align:" + r),
                n.wrap && o.push("white-space:normal"),
    ...
    pq.excelImport = {
            ...
            o.find("numFmts>numFmt").each(function(e, n) {
                ...
                o.find("fonts>font").each(function(r, o) {
                    var a = t(o),
                        ...
                        u = {};
                    return 0 === r ? (e = l,
                        void(n = d.toUpperCase())) : (a.find("b").length && (u.bold = !0),
                        c && (u.color = i.getColor(c)),
                        d && d.toUpperCase() != n && (u.font = d),
                        l && l != e && (u.fontSize = l),
                        a.find("u").length && (u.underline = !0),
                        a.find("i").length && (u.italic = !0),
                        void s.push(u))
                }),
                o.find("cellXfs>xf").each(function(e, n) {
                    ...
                    g.length && (i = g.attr("horizontal"),
                            ...
                            "1" == c && (w.wrap = !0)),
                        f && (r = a[f],
                            /(?=.*m.*)(?=.*d.*)(?=.*y.*)/i.test(r) && (r = r.replace(/(\[.*\]|[^mdy\/\-\s])/gi, "")),
                            w.format = r),
                        p && d[p] && (w.bgColor = d[p]);
                    for (u in m)
                        w[u] = m[u];
        ...
        getCols: function(t) {
            for (var e = this, n = (t.match(/<dimension\s.*?\/>/) || [])[0], r = e.attr(n || "").ref, i = [], o = t.match(/<col\s.*?\/>/g) || [], a = r ? pq.getAddress(r).c2 + 1 : o.length, l = pq.excel.colRatio, s = 0; a > s; s++)
                for (var d, c = o[s], u = e.attr(c), h = 1 * u.min, f = 1 * u.max, p = 1 * u.hidden, g = 1 * u.width, v = h; f >= v; v++)
                    d = {},
        ...
        getSI: function(t) {
            ...
            if (t.replace(/<si>([\s\S]*?)<\/si>/g, function(t, i) {
                    e = [],
                        i.replace(/<t.*?>([\s\S]*?)<\/t>/g, function(t, n) {
                            e.push(n)
                        }),
                        n.push(r(e.join("")))
                }),
        ...
        getWorkSheet: function(t, e, n, r) {
            for (var i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y, C = this, b = [], I = 0, _ = pq.toNumber, q = this.getFormula(C), D = pq.isEmpty, R = pq.formulas, M = pq.isDateFormat, T = C.getMergeCells(t), k = e.match(/<row.*?<\/row>/g) || [], E = 0, S = k.length; S > E; E++) {
                ...
                for (var P = 0, $ = c.length; $ > P; P++) {
                    if (o = c[P],
                        ...
                        g = C.match(o, /<c.*?>(.*?)(<\/c>)?$/, 1),
                        s = {},
                        "inlineStr" == u ? f = g.match(/<t><!\[CDATA\[(.*?)\]\]><\/t>/)[1] : (f = C.match(g, /<v>(.*?)<\/v>/, 1) || void 0,
                            null != f && (f = "s" == u ? n[f] : "str" == u ? pq.unescapeXml(f) : "b" == u ? "1" == f : R.VALUE(f))),
                        p = m.r,
                        p ? (p = p.replace(/\d+/, ""),
                            p = _(p)) : p = P,
                        I = I > p ? I : p,
                        ...
                        p !== P && (s.indx = p),
                        a = q(g, x, p),
                        a && (s.formula = pq.unescapeXml(a)),
                        h = m.s,
                        h && (h = this.getStyle(h))) {
                        for (i in h)
                            s[i] = h[i];
                        l = s.format,
                            null != f && !a && l && M(l) && (s.value = R.TEXT(f, "m/d/yyyy"))
                    }!D(s) && d.cells.push(s)
                }
                b.push(d)
            }
            var A = {
                ...
                H = C.getCols(t),
                F = C.getFrozen(t);
            return T.length && (A.mergeCells = T),
                H.length && (A.columns = H),
                F.r && (A.frozenRows = F.r),
                F.c && (A.frozenCols = F.c),
                A
        },
        Import: function(t, e) {
            var n, r, i, o = this,
            ...
            s ? (r = "?" + Math.random(),
                window.Uint8Array ? (i = new XMLHttpRequest,
                    i.open("GET", s + r, !0),
        ...
        readPaths: function() {
            ...
            for (var i in r)
                r[i] = n.find('[ContentType$="' + r[i] + '+xml"]').attr("PartName");
            for (i in e)
...
function(t) {
    ...
    r.prototype = t.extend({
        copyStyle: function(t, e) {
            var n, r, i, o, a, l, s;
            "string" == typeof e && (s = e.split(";"),
                    e = {},
                    s.forEach(function(t) {
                        t && (s = t.split(":"),
                            s[0] && s[1] && (e[s[0].trim()] = s[1].trim()))
                    })),
                (n = e.background) && (t.bgColor = n),
                (r = e["font-size"]) && (t.fontSize = parseFloat(r)),
                (o = e.color) && (t.color = o),
        ...
        getCsvHeader: function(t, e, n, r) {
            for (var i, o, a, l = this, s = [], d = [], c = 0; e > c; c++) {
                for (var u = t[c], h = null, f = 0, p = u.length; p > f; f++)
                    i = n[f],
                    i.hidden || i.copy === !1 || (o = u[f],
                        c > 0 && o == t[c - 1][f] ? s.push("") : h && f > 0 && o == h ? s.push("") : (a = l.getTitle(o, f),
                            a = a ? a.replace(/\"/g, '""') : "",
                            h = o,
                            s.push('"' + a + '"')));
                d.push(s.join(r)),
        ...
        getCSVContent: function(t, e, n, r, i, o, a, l, s, d, c, u, h) {
            var f, p, g, v, m, w, x, y, C, b, I, _ = this,
                q = t.separator || ",",
                D = [];
            for (I = h ? _.getCsvHeader(r, i, e, q) : [],
                v = 0; a > v; v++)
                if (x = o[v],
                    !x.pq_hidden) {
                    y = l ? v + s : v,
                    ...
                    for (var m = 0; n > m; m++)
                        if (b = e[m],
                            ...
                            p = null,
                                f = null,
                                d.ismergedCell(y, m) ? (f = d.isRootCell(y, m)) ? (p = d.getRootCellO(y, m),
                                    p.Export = !0,
                                    g = _.getRenderVal(p, c, u)[0]) : g = "" : (w.colIndx = m,
                                    w.column = b,
                                    w.dataIndx = b.dataIndx,
                                    g = _.getRenderVal(w, c, u)[0]);
                            var R = (null == g ? "" : g) + "";
                            R = R.replace(/\"/g, '""'),
                                D.push('"' + R + '"')
                        }
        ...
        Export: function(t) {
            if (this.that._trigger("beforeExport", null, t) === !1)
                return !1;
var dd=this;
  var url=$.trim($.cookie(this.that.$bottom.context.id+'_pq_export_url')).slice(1,-1)+"&download=1";
 ...
 const result =  $.ajax({
        ...
        data: data
            ...
            if ("xlsx" == b) {
                ...
                if (t.workbook)
                    return I;
                t.workbook = I,
                    e = pq.excel.exportWb(t)
            } else
                "json" == b ? t.data = n.getJsonContent(t, w) : "csv" == b ? t.data = n.getCSVContent(t, h, f, c, u, w, x, a, l, d, y, s, C) : t.data = n.getHtmlContent(t, h, f, c, u, w, x, a, l, d, y, s, C);
            return e = e || n.postRequest(t),
                r._trigger("exportData", null, t),
                e 
        },
        getHtmlHeader: function(t, e) {
            ...
            for (var n, r, i, o, a, l = this, s = [], d = 0; e > d; d++) {
                ...
                for (var h = 0, f = c.length; f > h; h++)
                    n = c[h],
                    r = n.colSpan,
                    !n.hidden && r && n.copy !== !1 && (i = n.rowSpan,
                        d > 0 && n == t[d - 1][h] || u && h > 0 && n == u || (o = l.getTitle(n, h),
                            u = n,
                            a = n.halign || n.align,
                            a = a ? "align=" + a : "",
                            s.push("<td colspan=", r, " rowspan=", i, " ", a, ">", o, "</td>")));
                s.push("</tr></thead>")
            }
            return s.join("")
        },
        ...
        getHtmlContent: function(t, e, n, r, i, o, a, l, s, d, c, u, h) {
            ...
            var f = this,
                ...
                C = [];
            return C.push("<!DOCTYPE html><html><head>", '<meta charset="utf-8" />', '<title>', "", "</title><body ", g ? 'dir="rtl"' : "", " >", "<style>", y, ".column{  float: left; padding: 5px; width:100%;   } .column1{ width: 40%;  text-align: right;   }  .column2{  margin-top:0%  }.page-header, .page-header-space {  height: 100px;}.page-footer, .page-footer-space {  height: 50px;}.page-footer {  position: fixed;  bottom: 0;  width: 100%;  border-top: 1px solid black; /* for demo */  background: yellow; /* for demo */}.page-header {  position: fixed;  top: 0mm;  width: 100%;  /* for demo */  background: yellow; /* for demo */}.page {  page-break-after: always;}@page {  margin: 10mm}@media print {   thead {display: table-header-group;}    tfoot {display: table-footer-group;}      button {display: none;}      body {margin: 0;}}", v, "</style>", '<div class="page-header">'+" <div class='column column2'><span style=' font-weight: bold;  font-size: 25px; text-align:center; margin-left:40%'>"+''+"</span><br><br><span style='position:relative;top:-20px; font-weight: bold;  font-size: 15px; text-align:center; margin-left:40%'>"+t.title+"</span><span style='position:relative;top:-20px;'></span></div></div> <table >    <thead>      <tr> <td><!--place holder for the fixed-position header-->          <div class='page-header-space'></div>        </td>      </tr>    </thead>    <tbody>      <tr>        <td>          <!--*** CONTENT GOES HERE ***-->            <div class='page' style='line-height: 1;'><table border='1'>"),
                C.push(h ? f.getHtmlHeader(r, i, e) : ""),
                C.push(f.getHtmlBody(e, n, o, a, l, s, d, c, u)),
                C.push("</table></div></body></html>"),
                C.join("")
        },
        ...
        getXlsCols: function(t, e) {
            for (var n, r, i, o = [], a = 0, l = pq.excel.colWidth; e > a; a++)
                r = t[a],
                i = 1 * (r._width || l).toFixed(2),
                n = {},
                i !== l && (n.width = i),
                r.hidden && (n.hidden = !0),
                pq.isEmpty(n) || (o.length !== a && (n.indx = a),
                    o.push(n));
            return o
        },
        ...
        getXlsBody: function(n, r, i, o, a, l, s, d, c, u) {
            ...
            for (f = 0; o > f; f++) {
                for (I = i[f],
                    ...
                    v = S.getFormula(I, D),
                    h = !1,
                    s.ismergedCell(_, p) && (s.isRootCell(_, p, "o") || (h = !0)),
                    h || v || (x.colIndx = p,
                        x.column = w,
                        x.dataIndx = D,
                        y = E.getRenderVal(x, d, c),
                        g = y[0],
                        C = y[1]),
                    k = E.getCellFormat(I, D) || w.format,
                    M = {},
                    "string" == typeof k && (pq.isDateFormat(k) ? (g !== m && t.datepicker.formatDate(k, new Date(m)) === g && (g = m),
                            k = pq.juiToExcel(k)) : (g !== m && pq.formatNumber(m, k) === g && (g = m),
                            k = pq.numToExcel(k)),
                        M.format = k),
                    void 0 !== g && (M.value = g),
                    T && (T = T[D]) && (T = T.style) && E.copyStyle(M, T),
                    C && E.copyStyle(M, C),
                    v && (u && (v = $(v, 0, u)),
                        M.formula = v),
                    pq.isEmpty(M) || (M.dataIndx = D,
                        b.length !== p && (M.indx = p),
                        b.push(M));
                R = {},
                    b.length && (R.cells = b),
                    I.pq_hidden && (R.hidden = !0),
                    pq.isEmpty(R) || (P.length !== f && (R.indx = f),
                        P.push(R))
            }
            return P
        },
        ...
        getWorkbook: function(t, e, n, r, i, o, a, l, s, d, c, u, h) {
            ...
            return m.rtl && (_.rtl = !0),
                b.length && (_.mergeCells = b),
                (f = C.length) && (_.headerRows = f),
                y && (_.frozenRows = y),
                w && (_.frozenCols = w),
                (h || (h = m.title)) && (_.name = h), {
                    sheets: [_]
                }
        },
...
function(t) {
    var e = pq.excel = {
        ...
        eachRow: function(t, e) {
            for (var n = t.rows, r = 0, i = n.length; i > r; r++)
                e(n[r], r)
        },
        exportWb: function(t) {
            var e = t.workbook,
                ...
                l = a.length,
                s = new JSZip;
            s.file("[Content_Types].xml", this.getContentTypes(l)),
                a.forEach(function(t, e) {
                    ...
                    o.push(t.name),
                        n && (l = l.replace.apply(l, n)),
                        s.file("worksheet" + (e + 1) + ".xml", i.getSheet(a, r, l, d))
                }),
                s.file("workbook.xml", this.getWBook(o)),
                s.file("styles.xml", i.getStyle());
            var d = s.folder("_rels");
            return d.file(".rels", r.rels),
                d.file("workbook.xml.rels", this.getWBookRels(l)),
                t.url ? (t.data = s.generate({
                        type: "base64",
                        compression: "DEFLATE"
                    }),
                    t.decodeBase = !0,
                    pq.postRequest(t)) : s.generate({
                    type: t.type || "blob",
                    compression: "DEFLATE"
                })
        },
        ...
        getBody: function(t) {
            ...
            for (e = 0; k > e; e++) {
                for (f = t[e],
                    ...
                    null == h ? s = "<v></v>" : h == parseFloat(h) && (h + "").match(/^[0-9,e,\-,\.]*$/gi) ? s = "<v>" + h + "</v>" : D && M.isDate(h) ? s = "<v>" + M.VALUE(h) + "</v>" : "boolean" == typeof h ? (s = "<v>" + (h ? "1" : "0") + "</v>",
                        a = 't="b"') : (a = 't="inlineStr"',
                        s = "<is><t><![CDATA[" + h + "]]></t></is>"),
                    (D || p || g || m || w || y || x || C || b || I) && (l = 's="' + R.getStyleIndx(D, p, g, v, m, w, y, x, C, b, I) + '"'),
        ...
        getColor: function() {
            ...
            return function(n) {
                var r, i, o = t[n];
                if (o || (/^#[0-9,a,b,c,d,e,f]{6}$/i.test(n) ? i = n.replace("#", "") : (r = n.match(/^rgb\((\d{1,3}),(\d{1,3}),(\d{1,3})\)$/i)) && (i = e((1 * r[1]).toString(16)) + e((1 * r[2]).toString(16)) + e((1 * r[3]).toString(16))),
                        i && 6 === i.length && (o = t[n] = "ff" + i)),
                    o)
                    return o;
        ...
        getCols: function(t) {
            ...
            for (a.push("<cols>"); c > d; d++) {
                var u = t[d],
                    ...
                    p = u.indx;
                l = (p || l) + 1,
                    r === f && i === h && l == s + 1 ? n = l : (o && (this._getCol(a, e, n, i, r),
                            e = null),
                        n = l,
                        null == e && (e = l)),
                    r = f,
            ...
            return this._getCol(a, e, n, i, r),
                a.push("</cols>"),
                a.join("")
        },
        getContentTypes: function(t) {
            for (var e = [], n = 1; t >= n; n++)
                e.push('<Override PartName="/worksheet' + n + '.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"/>');
        ...
        getItem: function(t, e) {
            ...
            if (null == l || e == l)
                return i;
            if (n = -1 == l ? t.length - 1 : e,
                n >= 0)
                for (;;) {
                    if (a++,
                        a > 20)
                        throw "not found";
                    if (r = Math.floor((n + o) / 2),
                        i = t[r],
                        l = i.indx,
                        l == e)
                        return i;
                    if (l > e ? n = r : o = r == o ? r + 1 : r,
                        o == n && r == o)
                        break
                }
        },
        getMergeCells: function(t) {
            ...
            var e = [],
                n = 0,
                r = t.length;
            for (e.push('<mergeCells count="' + r + '">'); r > n; n++)
                e.push('<mergeCell ref="', t[n], '"/>');
        ...
        getWBookRels: function(t) {
            for (var e = [], n = 1; t >= n; n++)
                e.push('<Relationship Id="rId' + n + '" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet" Target="/worksheet' + n + '.xml"/>');
        ...
        getStyle: function() {
            ...
            if (w) {
                delete w.length;
                for (m in w)
                    b.push('<numFmt numFmtId="' + w[m] + '" formatCode="' + m + '"/>');
                delete this.formats
            }
            if (x) {
                delete x.length;
                for (m in x)
                    I.push('<fill><patternFill patternType="solid"><fgColor rgb="' + this.getColor(m) + '"/></patternFill></fill>');
                delete this.fills
            }
            if (y) {
                delete y.length;
                for (m in y)
                    ...
                    i = a[4] ? "<i/>" : "",
                    o = a[5] ? "<u/>" : "",
                    _.push("<font>", r, i, o, e, t, n, '<family val="2"/></font>');
                delete this.fonts
            }
            if (C) {
                delete C.length;
    ...
    e.colRatio = 8,
        e.colWidth = 8.43 * e.colRatio,
        e.numFmtIds = function() {
...
function(t) {
    ...
    t.extend(n, {
            ...
            selectExp: function(t, e) {
                ...
                return !/"[^"]+$/.test(a) && (i = t.slice(e),
                    (n = a.match(/.*?([a-z0-9:$]+)$/i)) && ("" === i && (r = []) || (r = i.match(/^([a-z0-9:$]+)?.*/i)))) ? o = (n[1] + (null == r[1] ? "" : r[1])).replace(/\$/g, "").toUpperCase() : void 0
            },
            shiftRC: function(t) {
                var e = n,
        ...
        n.prototype = {
                    ...
                    return t = t.split(" ").join(""),
                        t.toUpperCase().replace(/([A-Z]+)([0-9]+)\:([A-Z]+)([0-9]+)/g, function(t, e, n, r, i) {
                            return e = pq.toNumber(e),
                                ...
                                e > r && (e = [r, r = e][0]),
                                1 * n > 1 * i && (n = [i, i = n][0]),
                                pq.toLetter(e) + n + ":" + pq.toLetter(r) + i
                        })
                })
            },
            computeAll: function() {
            ...
            eachFormula: function(t) {
                var e = this,
                    ...
                    i = function(e, r, i) {
                        ...
                        for (o in i)
                            a = i[o],
                            "string" != typeof a && t(a, e, o, r, n)
                    },
                    o = function(t) {
                        t = t || [];
                        for (var e, n, r = t.length; r--;)
                            (e = t[r]) && (n = e.pq_fn) && i(e, r, n)
                    };
                o(r.get_p_data()),
                    n = !1,
                    o(r.options.summaryData)
            },
                        ...
                        r.forEach(function(r) {
                            ...
                            for (o in l)
                                if (i = l[o],
                                    ...
                                    c ? d !== c.fn && (r.oldRow[o] = "=" + c.fn,
                                        e.save(s, o, d, r.rowIndx, n[o])) : e.save(s || l, o, d, r.rowIndx, n[o])
                                } else
                                    s && (a = e.remove(s, o)) && (r.oldRow[o] = "=" + a.fn)
                        })
                    };
                r(t.addList),
                    r(t.updateList)
                ...
                var t, e = this,
                    ...
                    a = function(n, r, a) {
                        ...
                        for (s in a)
                            l = a[s],
                            t = !0,
                            "string" == typeof l ? e.save(n, s, e.check(l), r, o[s]) : l.ri != r && (d = r - l.riO,
                                l.ri = r,
                                l.fn = i(l.fnOrig, l.ci - l.ciO, d))
                    },
                    l = function(t) {
                        t = t || [];
                        for (var e, n, r = t.length; r--;)
                            (e = t[r]) && (n = e.pq_fn) && a(e, r, n)
                    };
                l(r.get_p_data()),
                    l(r.options.summaryData),
                    e.initObj(),
                    t && e.computeAll()
            },
            getFnW: function(t, e) {
            ...
            remove: function(t, e) {
                var n, r = t.pq_fn;
                return r && (n = r[e]) ? (delete r[e],
                    pq.isEmpty(r) && delete t.pq_fn,
                    n) : void 0
            },
            range: function(t) {
                var e = t.split(":"),
            ...
            selectRange: function(t, e) {
                ...
                return l ? (/^([a-z0-9]+):([a-z0-9]+)$/i.test(l) ? (r = l.split(":"),
                        i = this.toCell(r[0]),
                        o = this.toCell(r[1]),
                        a = {
                            r1: i.r,
                            ...
                            r2: o.r,
                            c2: o.c
                        }) : /^[a-z]+[0-9]+$/i.test(l) && (i = this.toCell(l),
                        a = {
                            r1: i.r,
                            c1: i.c
                        }),
    ...
    pq.intel = {
        ...
        popup: function(e, n, r) {
            ...
            this.that = l.pqGrid("instance"),
                s.remove(),
                (i = c[0]) && (o = this.getMatch(i, c[1]),
                    a = o.map(this.item, this).join(""),
                    a && t("<div class='pq-intel' style='width:350px;max-height:300px;overflow:auto;background:#fff;border:1px solid gray;box-shadow: 4px 4px 2px #aaaaaa;padding:5px;'></div>").appendTo(d).html(a).position({
                        my: "center top",
                        at: "center bottom",
                        collision: "flipfit",
                        of: r,
...
function(t) {
    pq.Select = function(e, n) {
        if (this instanceof pq.Select == 0)
            return new pq.Select(e, n);
    ...
    e.prototype = {
        ...
        t(document).on("pqGrid:bootup", function(t, n) {
            var r = n.instance,
                i = r.Group();
            i.primary = new e(r),
                r.on("beforeFilterDone", i.onBeforeFilterDone.bind(i)).one("CMInit", i.oneCMInit.bind(i))
        });
    var n = {},
        r = {
            clearPivot: function(t) {
                if (this.isPivot()) {
                    var e = this.that,
                        n = e.options.dataModel,
                        r = this.primary;
                    if (r.getOCM() && e.refreshCM(r.getOCM()),
                        t) {
                        if (!r.getDMData())
                            throw "!primary.getDMData";
                        n.data = r.getDMData()
                    } else
                        r.getDMData() && (n.data = r.getDMData());
            ...
            groupData: function() {
                var t, e, r, i = this,
                    ...
                    h = d.length;
                if (u ? (h && (t = s.slice(),
                            l.dataIndx = s = s.concat(d)),
                        i.skipConcat = !0,
                        e = l.titleInFirstCol,
                        r = l.merge,
                        l.titleInFirstCol = !1,
                        l.fixCols = !0,
                        l.merge = !1) : c && h && (t = s.slice(),
                        l.dataIndx.length = l.dataIndx.length - 1,
                        i.setPivot(!1)),
                    n.groupData.call(i),
                    u && (o.pdata = o.pdata.reduce(function(t, e) {
                        return e.pq_gtitle && t.push(e),
                            t
                    }, [])),
                    c && h && (l.dataIndx = t,
                        i.setPivot(!0)),
                    u) {
                    if (h) {
                        e ? (l.titleInFirstCol = !0,
                                l.fixCols = !1) : t.length > 1 && (l.merge = r),
                            i.pivotData(s, t),
                            l.dataIndx = t.slice(0, t.length - 1),
                            l.summaryInTitleRow = "all",
                            i.skipConcat = !1;
            ...
            getSorter: function(t) {
                ...
                return n || (e = pq.getDataType(t),
                        n = "number" == e ? function(t, e) {
            ...
            nestedCM: function(e, n) {
                ...
                return d = i.map(function(t) {
                        var e = d[t];
                        return l.push(r.getSorter(e)),
                            s.push(pq.getDataType(e)),
                            e
                    }),
                    function c(n, r, i) {
                        r = r || 0,
                        ...
                        if (t.isEmptyObject(n))
                            ...
                            for (g in n)
                                ...
                                m ? (w = v,
                                    ...
                                    y.push(f));
                            y.sort(l[r]),
                                w && y["before" == o ? "unshift" : "push"].apply(y, w)
                        }
                        return y
                    }
            },
            ...
            option: function(t, e, r, i) {
                var o = this;
                o.isPivot() && o.clearPivot(),
                    n.option.call(o, t, e, r, i)
            },
            pivotData: function(e, n) {
                var r, i, o = this.that,
                    ...
                    u = o.pdata,
                    h = o.columns;
                d.titleInFirstCol ? (r = o.colModel[0],
                    i = [r].concat(n.reduce(function(e, n) {
                ...
                return t.forEach(function(t) {
                        ...
                        p === y - 1 ? e.forEach(function(e) {
                                l = f.slice(),
                                    ...
                                    i = !0),
                                w > p && (h[C] = a[C] = b),
                                m && y - 2 >= p && p >= w - 1 && e.forEach(function(e) {
                                    l = f.slice(0, g + 1),
                                        l.push("aggr"),
                                        l.push(e),
                                        a[l.join("_")] = t[e]
                    ...
                    u.setDMData(g.data),
                    g.data = c.pdata = d,
                    m && this.addAggrInCM(x, v.pivotTotalForSingle),
                    x
            },
...
function(t) {
    ...
    e.pqGrid.defaults.toolPanel = {},
        ...
        e.cToolPanel = function(t) {
            var e = this;
            e.that = t,
                e.clsSort = "pq-sortable",
                t.one("render", e.init.bind(e))
        },
        e.cToolPanel.prototype = {
            ...
            init: function() {
                ...
                if (t.isVisible() && !t.getInit()) {
                    ...
                    e.html(["<div class='pq-pivot-cols-all", l, "'>", "<div class='", u, "' style='", d ? "padding-top:0;" : "", "'></div>", d ? "" : ["<div class='", a, "'>", "<label><input type='checkbox' class='pq-pivot-checkbox' ", c, "/>", r.strTP_pivot, "</label>", "</div>"].join(""), "</div>", "<div class='pq-pivot-rows", l, "' style='display:", i.hideRowPane ? "none" : "", ";'>", "<div deny='denyGroup' class='", u, "'></div>", "<div class='", a, "'><span class='pq-icon'></span>", r.strTP_rowPane, "</div>", "</div>", "<div class='pq-pivot-cols", l, "' style='display:", s ? "none" : "", ";'>", "<div deny='denyPivot' class='", u, "'></div>", "<div class='", a, "'><span class='pq-icon'></span>", r.strTP_colPane, "</div>", "</div>", "<div class='pq-pivot-vals", l, "' style='display:", i.hideAggPane ? "none" : "", ";'>", "<div deny='denyAgg' class='", u, "'></div>", "<div class='", a, "'><span class='pq-icon'></span>", r.strTP_aggPane, "</div>", "</div>"].join("")),
                        t.$pivotChk = e.find(".pq-pivot-checkbox").on("click", t.onPivotChange(t, n)),
                        t.$colsAll = e.find(".pq-pivot-cols-all>." + u),
                        t.$colsPane = e.find(".pq-pivot-cols"),
                        t.$cols = e.find(".pq-pivot-cols>." + u),
                        t.$rows = e.find(".pq-pivot-rows>." + u),
                        t.$aggs = e.find(".pq-pivot-vals>." + u).on("click contextmenu", t.onClick.bind(t)),
                        n.on("refreshFull", t.setHt.bind(t)).on("groupOption", t.onGroupOption.bind(t)),
                        setTimeout(function() {
                            n.element && (n.on("CMInit", t.onCMInit.bind(t)),
                                t.render())
                        }),
                        t.setInit()
                }
            ...
            onStop: function(e) {
                return function(n, r) {
                    var i = t(this),
                        o = r.item,
                        a = o.parent();
                    i[0] != a[0] && e.isDeny(i, a, o) && (i.sortable("cancel"),
                        e.setSortCancel(!0))
                }
            },
            onTimer: function() {
            ...
            refresh: function() {
                this.setHtml(),
                    t(this.panes).sortable("refresh")
            },
            render: function() {
                var e = this,
                    n = "." + e.clsSort,
                    r = e.that;
                r.element && (e.panes = [e.$colsAll, e.$cols, e.$rows, e.$aggs],
                    e.setHtml(),
                    t(e.panes).sortable({
                        appendTo: e.$ele,
                        connectWith: n,
            ...
            setHtml: function() {
                ...
                v.concat(m).forEach(function(t) {
                    ...
                    n.$pivotChk[0].checked = g.pivot,
                    n.showHideColPane();
                for (var w = 0, x = p.length; x > w; w++)
                    t = p[w],
                    e = t.dataIndx,
                    t.tpHide || c[e] || (t.summary && t.summary.type ? l.push(d(e, t)) : i.push(s(e, t)));
                v.forEach(function(t) {
                    ...
                    n.$colsAll.html(i.join("")),
                    n.$rows.html(a.join("") || n.ph(u.strTP_rowPH)),
                    n.$cols.html(o.join("") || n.ph(u.strTP_colPH)),
                    n.$aggs.html(l.join("") || n.ph(u.strTP_aggPH))
            },
            ...
            showHideColPane: function() {
                var t = this;
                t.$colsPane.css("display", t.isHideColPane() ? "none" : ""),
                    t.setAttrPanes()
            },
...
function(t) {
    function e(t) {
        ...
        e.that = t,
            e.rtl = t.options.rtl,
            t.on("headerCellClick", e.onHeadCellClick.bind(e)).on("headerClick", e.onHeadClick.bind(e)).on("destroy", e.onDestroy.bind(e))
    }
    t.paramquery;
    t(document).on("pqGrid:bootup", function(t, n) {
            var r = n.instance;
            r.iHeaderMenu = new e(r),
                r.HeaderMenu = function() {
        ...
        e.prototype = {
            ...
            openFilterTab: function() {
                ...
                return this.$tabs.tabs("option", "active", t),
                    this.filterMenu
            },
            FilterMenu: function() {
            ...
            open: function(e, n, r) {
                ...
                n = n || s.getCellHeader({
                    ...
                    null != e ? (a = s.columns[e],
                        i = l.menuH = l.getMenuH(s.options, a),
                        o = i.tabs) : o = ["hideCols"];
                ...
                return o.indexOf("filter") > -1 && l.appendFilter(d.find("#tabs-filter"), a),
                    pq.makePopup(l.$popup[0]),
                    c.tabs({
                        active: localStorage["pq-menu-tab"] || 1,
                        activate: function(e, n) {
                            localStorage["pq-menu-tab"] = t(this).tabs("option", "active"),
                                t(n.newPanel).find(".pq-grid").pqGrid("refresh")
                        }
                    }),
                    d.resizable({
                        handles: "e,w",
            ...
            onMenuClick: function(t, e, n) {
                return this.open(e.dataIndx, t, n),
                    !1
            },
    ...
    e.select = function(t, e) {
        ...
        e.select.prototype = {
            ...
            create: function(e, n, r) {
                ...
                return l("selectGridObj"),
                    a.rtl = o.options.rtl,
                    s.grid = i.grid = pq.grid(e, a),
                    l("selectGridCreated"),
                    i.grid
            },
            ...
            getData: function(e, n) {
                ...
                return t.isArray(d) ? s && (d = d.slice(0, s)) : d = 1 == s ? [d] : [],
        ...
        e.prototype = {
            addEvents: function() {
                var t = this;
                t.$sel0.on("change", t.onSel1Change.bind(t)),
                    t.$sel1.on("change", t.onSel2Change.bind(t)),
                    t.$filter_mode.on("change", t.onModeChange.bind(t)),
                    t.$clear.button().on("click", t.clear.bind(t)),
                    t.$ok.button().on("click", t.ok.bind(t))
            },
            addEventsInput: function() {
                var t = this;
                t.$inp && (t.$inp.filter("[type='checkbox']").off("click").on("click", t.onInput.bind(t)),
                    t.$inp.filter("[type='text']").off("keyup").on("keyup", t.onInput.bind(t)))
            },
            clear: function() {
                var t = this.that,
                    e = this.column,
            ...
            getVal: function(t) {
                ...
                if (o.is("[type='checkbox']")) {
                    ...
                    o.is(":visible") && (e = pq.deFormat(r, o.val(), i)),
                    l.is(":visible") && (n = pq.deFormat(r, l.val(), i));
                return [e, n]
            },
            init: function(t) {
            ...
            initControls: function() {
                ...
                r.$editor = t([this.$inp0[0], this.$inp1[0]]),
                    r.condition = this.cond0,
                    r.type = e.type,
                    r.filterUI = e,
                    e.init.find(function(t) {
                        return t.call(n, r)
                    }),
                    e = this.filterUI[1],
                    r.$editor = t([this.$inp2[0], this.$inp3[0]]),
                    r.condition = this.cond1,
                    r.type = e.type,
                    r.filterUI = e,
                    e.init.find(function(t) {
                        return t.call(n, r)
            ...
            ok: function() {
                var t = this.cond0;
                "select" != this.getType(t) || this.filterRow ? t && this.filterByCond(!0) : this.iRange.change(!0),
                    this.close(),
                    this.refreshRowFilter()
            },
            ...
            onInput: function(e) {
                ...
                n.is(":checkbox") && n.pqval({
                    ...
                    this.filterByCond(r),
                    r && this.refreshRowFilter()
            },
            onSel1Change: function() {
                var t = !this.btnOk;
                this.cond0 = this.getSel(0).val(),
                    this.readFilterUI(),
                    this.filterRow || (this.$inp0.replaceWith(this.getHtmlInput(0)),
            ...
            ready: function(e) {
                ...
                var n, r, i, o = t(e),
                    ...
                    g = a.readFilterUI();
                a.iRange = new pq.cFilterMenu.select(l, s),
                    n = a.getType(f),
                    r = a.getType(p),
                    i = a.$select = o.find("select"),
                    a.$sel0 = t(i[0]).val(f),
                    a.$sel1 = t(i[1]).val(p),
                    a.$filter_mode = o.find('[name="pq_filter_mode"]'),
                    a.$clear = o.find("[data-rel='clear']"),
                    a.$ok = o.find("[data-rel='ok']"),
                    a.btnOk = a.$ok.length,
                    a.filterRow || (a.refreshInputVarsAndEvents(),
                        a.$gridR = o.find("[data-rel='grid']"),
                        a.$filter_mode.filter("[value=" + d.mode + "]").attr("checked", "checked"),
                        a.$filter_mode_div = o.find(".filter_mode_div"),
                        a.showHide(f, p),
                        "select" == n ? a.iRange.create(a.$gridR, g[0], a.btnOk) : a.readyInput(0, n, u),
                        a.readyInput(1, r, h),
                        a.initControls())
            },
            readyInput: function(t, e, n) {
                ...
                o.is(":checkbox") && o.pqval({
                    ...
                    o.val(pq.formatEx(r, n.value, i)),
                    "textbox2" == e && a.val(pq.formatEx(r, n.value2, i))
            },
            readFilterUI: function() {
                ...
                return t[0] = pq.filter.getFilterUI(n, e),
                    n.condition = this.cond1,
                    n.indx = 1,
                    t[1] = pq.filter.getFilterUI(n, e),
                    t
            },
            ...
            showHide: function(t, e) {
                if (!this.filterRow) {
                    var n, r = this,
                        ...
                        a = r.getType(t),
                        l = r.$inp;
                    "select" === a ? (r.$gridR.show(),
                        r.$gridR.hasClass("pq-grid") && r.$gridR.pqGrid("destroy"),
                        l.hide(),
                        i.hide(),
                        o.hide()) : (r.$gridR.hide(),
                        t ? (r.$inp0[r.isInputHidden(a) ? "hide" : "show"](),
                            r.$inp1["textbox2" === a ? "show" : "hide"](),
                            i.show(),
                            o.show(),
                            e ? (n = r.getType(e),
                                r.$inp2[r.isInputHidden(n) ? "hide" : "show"](),
                                r.$inp3["textbox2" === n ? "show" : "hide"]()) : (r.$inp2.hide(),
                                r.$inp3.hide())) : (l.hide(),
                            i.hide(),
                            o.hide()))
                }
            ...
            updateConditions: function() {
                ...
                t.crules = t.crules || [{}],
                    t.crules[0].condition = this.cond0,
                    this.cond1 && (t.crules[1] = t.crules[1] || {},
                        t.crules[1].condition = this.cond1)
            }
        }
}(jQuery),
function(t) {
    ...
    t(document).on("pqGrid:bootup", function(t, n) {
        ...
        e.cEditor = function(t) {
            var e = this;
            e.that = t,
                t.on("editorBeginDone", function(t, n) {
                    n.$td[0].edited = !0,
                        e.fixWidth(n),
                        setTimeout(function() {
    ...
    t(document).on("pqGrid:bootup", function(t, e) {
        ...
        pq.grid = function(t, e) {
            ...
            return o.reactive && (r.on("filter", function() {
                        e.dataModel && (e.dataModel.data = o.dataModel.data),
                            i.prxData()
                    }),
        ...
        r.prototype = {
            init: function() {
                ...
                t.prxData(),
                    t.prxCM(),
                    e.on("refresh", t.clear.bind(t)).on("dataReady", t.clearV.bind(t)).on("dataAvailable", t.clearDV.bind(t))
            },
            onOption: function(t, e) {
                ...
                if (o[t] = e,
                    ...
                    t == a ? (e.data && r.prxData(e.data),
                        r.refreshDataView()) : "pageModel" == t && (e.rPP || null != e.type) && r.refreshDataView();
                    for (n in e)
                        i.option(t + "." + n, e[n])
                } else
                    "colModel" == t ? r.prxCM(e) : "mergeCells" == t && r.refreshView(),
                    i.option(t, e)
            },
            onCMChange: function() {
                var t = this,
            ...
            prxCM: function(t) {
                ...
                r && (e.prxArray(r, e.onCMChange.bind(e)),
                    r.forEach(function(t) {
            ...
            prxArray: function(t, e) {
                ...
                i.forEach(function(i) {
                        t[i] = function() {
                            ...
                            return ("push" == i || a || "unshift" == i) && n.prxArrayObjs(a ? r.slice.call(o, 2) : o),
                                e.call(n),
                                l
                        }
                    }),
            ...
            prxArrayObjs: function(t) {
                for (var e = this, n = 0, r = t.length; r > n; n++)
                    e.prxObj(t[n])
            },
            prxObj: function(t, e, n, r) {
                if (pq.isObject(t)) {
                    ...
                    t[l] || Object.defineProperty(t, l, {
                        ...
                        i.__self = a;
                    for (o in t)
                        "pq_" != o.substr(0, 3) && (n && !r && pq.isObject(t[o]) && a.prxObj(t[o], e, n, o),
                            i.hasOwnProperty(o) || (Object.defineProperty(i, o, Object.getOwnPropertyDescriptor(t, o)),
                                a.defineProp(t, i, o, e, n, r)))
                }
            },
            defineProp: function(t, e, n, r, i, o) {
                Object.defineProperty(t, n, {
                    ...
                    set: function(t) {
                        var a, l = e.__self;
                        i && !o && pq.isObject(t) && l.prxObj(t, r, i, n),
                            e[n] = t,
                            r ? (a = t,
                                o && (a = {},
                                    a[n] = t),
                                r.call(l, o || n, a)) : l.refresh()
                    },
                    enumerable: !0
                })
            },
...
function(t) {
    ...
    e.setSBDim = function() {
            var e = t("<div style='max-width:100px;height:100px;position:fixed;left:0;top:0;overflow:auto;visibility:hidden;'><div style='width:200px;height:100px;'></div></div>").appendTo(document.body),
                n = e[0];
            this.SBDIM = n.offsetHeight - n.clientHeight,
                e.remove()
        },
        e.prototype = {
            assignTblDims: function(t) {
                var e, n = this,
                    ...
                    a = n.maxHt;
                o > a ? (n[t ? "ratioH" : "ratioV"] = o / a,
                    n[t ? "virtualWd" : "virtualHt"] = o,
                    o = a) : (o = o || (n.isHead() ? 0 : 1),
                    n[t ? "ratioH" : "ratioV"] = 1);
                var l = n.$tbl_right[0],
                ...
                l.style[c] = o + "px",
                    d.style[c] = o + "px",
                    e = r ? "Tbl" : n.isHead() ? "TblHead" : "TblSum",
                    !r && t && n.$spacer.css(n.rtl, o),
                    n.dims[t ? "wd" + e : "ht" + e] = o,
                    r && n.triggerTblDims(100)
            },
            calInitFinal: function(t, e, n) {
                ...
                if (n && (d -= this.numColWd),
                    t += d,
                    e += d,
                    a > l && s[l] < t) {
                    for (var c, u = 30, h = a; u--;)
                        if (c = Math.floor((l + h) / 2),
                            s[c] >= t)
                            h = c;
                        else {
                            if (l == c) {
                ...
                return null == r && null == i && a && t > s[a - 1] ? [null, null] : (null == r && (r = 0),
                    null == i && (i = a - 1),
                    [r, i])
            },
            ...
            calcTopBottom: function(t) {
                ...
                var f, p, g, v = e.maxHt,
                    ...
                    C = c - w;
                if (s + w >= v ? (r = m - u + C,
                        n = r - c + u) : (0 == s ? n = 0 : (f = null == d || Math.abs(s - d) > c ? h : 1,
                            n = s * f + (1 == f && y ? y : 0)),
                        r = n + c - u),
                    p = n - s,
                    p != y && (g = !0,
                        i[x] = p,
                        o && i.triggerTblDims(3e3)),
                    i[t ? "sleft" : "stop"] = s,
                    !(s >= 0))
                    throw "stop NaN";
                if (!(r >= 0 && n >= 0))
            ...
            getHeightCell: function(t, e) {
                ...
                var n, r, i = this.topArr,
                    o = this.rowHtDetail;
                if (n = o ? this.getHtDetail(this.data[t + e - 1], o) : 0,
                    r = i[t + e] - i[t] - n,
                    r >= 0)
                    return r;
                throw r
            ...
            refreshRowHtArr: function(t, e) {
                var n = this.data[t],
                    r = this.rowHtDetail,
                    i = this.rowHt;
                this.rowhtArr[t] = n.pq_hidden ? 0 : i + this.getHtDetail(n, r),
                    e && (this.setTopArr(t),
                        this.assignTblDims())
            },
        ...
        pq.cRender.prototype = t.extend({}, {
            ...
            autoHeight: function(t) {
                var e = this,
                    ...
                    l = e.initV,
                    s = e.finalV;
                e.rows && (r && n._trigger("beforeAutoRowHeight"),
                    a = e.setRowHtArr(l, s, i),
                    a = e.setRowHtArr(0, o - 1, i) || a,
                    a ? (e.setTopArr(o ? 0 : l),
                        e.assignTblDims(),
                        e.setPanes(),
                        e.setCellDims(!0),
                        r && (t.source = "autoRow",
                            e.refresh(t),
                            n._trigger("autoRowHeight"))) : e.setCellDims(!0))
            },
            autoWidth: function(t) {
                var e = this,
                    ...
                    r = e.initH,
                    i = e.finalH;
                null == t ? (e.setColWdArr(r, i),
                    e.setColWdArr(0, n - 1)) : e.setColWdArr(t, t)
            },
            _each: function(t, e, n, r, i, o) {
                for (var a, l = this, s = l.jump, d = 0; n >= d; d++)
                    d = s(e, o, d),
                    a = r[d],
                    a[i] || t.call(l, a, d)
            },
            ...
            generateCell: function(t, e, n, r, i, o) {
                ...
                if (p._m() && (f = g.ismergedCell(w, e))) {
                    if (!f.o_rc)
                        return t == p._initV || e == p._initH ? (c = p.getCellRegion(t, e),
                            d = g.getRootCell(w, e),
                            l = d.v_ri - m,
                            s = d.v_ci,
                            0 > l ? "" : (u = p.getCellRegion(l, s),
                                p.mcLaid[l + "," + s + (u == c ? "" : "," + c)] = !0,
                                "")) : "";
                    d = g.getClsStyle(w, e),
                        d.style && v.push(d.style),
                        d.cls && x.push(d.cls),
                        w = f.o_ri,
                        t = w - m,
                        n = p.data[t],
                        e = f.o_ci,
                        r = p.colModel[e],
                        o = p.getHeightCellM(t, f.o_rc),
                        a = p.getWidthCellM(e, f.o_cc),
                        x.push("pq-merge-cell")
                } else if (n.pq_hidden || r.hidden)
                    return "";
                if (h = p.getCellId(t, e, i),
                    p.getById(h))
                    return "";
                var y = o || p.getHeightCell(t),
                    C = a || p.colwdArr[e],
                    b = p.getLeft(e);
                return v.push(p.rtl + ":" + b + "px;width:" + C + "px;height:" + y + "px;"),
                    p.renderCell({
                        style: v,
                        cls: x,
            ...
            getCell: function(t, e, n) {
                var r, i, o = this.riOffset,
                    a = t + o;
                return n || (r = this.iMerge,
                        r.ismergedCell(a, e) && (i = r.getRootCell(a, e),
                            this.isHead() && (t = i.o_ri,
                                e = i.o_ci),
                            n = this.getCellRegion(i.v_ri - o, i.v_ci))),
                    this.getById(this.getCellId(t, e, n))
            },
            ...
            getCellId: function(t, e, n) {
                return t >= this.data.length ? "" : (n = n || this.getCellRegion(t, e),
                    this.cellPrefix + t + "-" + e + "-" + n)
            },
            ...
            getCellCoords: function(t, e) {
                var n, r = this,
                    ...
                    l = t,
                    s = e;
                r.isBody() && (n = r.that.iMerge.inflateRange(a, e, a, e),
                    l = n[2] - o,
                    s = n[3]);
                var d = r.getTop(t),
                    c = r.getTop(l + 1),
            ...
            getRowClsStyleAttr: function(t) {
                ...
                if (i) {
                    ...
                    u && (u.cls && n.push(u.cls),
                        s += u.attr ? " " + u.attr : "",
                        d += u.style ? u.style : "")
                }
                if (r.stripeRows && this.stripeArr[t] && n.push("pq-striped"),
                    o.pq_rowselect && n.push(e.iRows.hclass),
                    a && n.push(a),
                    l) {
            ...
            preInit: function(t) {
                ...
                t.empty(),
                    t[0].innerHTML = ['<div class="pq-grid-cont">', n ? '<div class="pq-grid-norows">' + i.strNoRows + "</div>" : "", '<div class="', a[0] + a[1], '"><div class="pq-table-right ' + o + '"></div>', n ? "" : '<div class="pq-r-spacer" style="position:absolute;top:0;height:10px;"></div>', "</div>", '<div class="' + a[0] + a[2] + '"><div class="pq-table-left ' + o + '"></div></div>', '<div class="' + a[0] + a[4] + '"><div class="pq-table-tr ' + o + '"></div></div>', '<div class="' + a[0] + a[3] + '"><div class="pq-table-lt ' + o + '"></div></div>', "</div>"].join(""),
                    e.$cright = t.find("." + a[1]).on("scroll", e.onNativeScroll(e)),
                    n || (e.$spacer = t.find(".pq-r-spacer")),
                    e.$cleft = t.find("." + a[2]).on("scroll", e.onScrollL),
                    ...
                    n && e.$cleft.add(e.$ctr).on("mousewheel DOMMouseScroll", e.onMouseWheel(e))
            },
            isBody: function() {},
            isHead: function() {},
            isSum: function() {},
            ...
            initStripeArr: function() {
                for (var t, e = this.rows, n = 0, r = this.stripeArr = [], i = this.data; e > n; n++)
                    i[n].pq_hidden || (t = r[n] = !t)
            },
            ...
            refresh: function(t) {
                ...
                r && n.blurEditor({
                    ...
                    e._initH = h,
                    e._finalH = p,
                    r && n._trigger("beforeTableView", null, {
                        initV: u,
                        finalV: f,
                        pageData: e.data
                    }),
                    g || (null != m && f >= v && m >= u && (u > v ? (e.removeView(v, u - 1, w, x),
                                s && e.removeView(v, u - 1, l ? -1 : 0, a - 1)) : v > u && (e.renderView(u, v - 1, h, p),
                                s && e.renderView(u, v - 1, 0, a - 1)),
                            m > f ? (e.removeView(f + 1, m, w, x),
                                s && e.removeView(f + 1, m, l ? -1 : 0, a - 1)) : f > m && (e.renderView(m + 1, f, h, p),
                                s && e.renderView(m + 1, f, 0, a - 1)),
                            v = u,
                            m = f),
                        null != x && p > w && x > h && (h > w ? (e.removeView(v, m, w, h - 1),
                                d && e.removeView(0, d - 1, w, h - 1)) : w > h && (e.renderView(v, m, h, w - 1),
                                d && e.renderView(0, d - 1, h, w - 1)),
                            x > p ? (e.removeView(v, m, p + 1, x),
                                d && e.removeView(0, d - 1, p + 1, x)) : p > x && (e.renderView(v, m, x + 1, p),
                                d && e.renderView(0, d - 1, x + 1, p)),
                            w = h,
                            x = p)),
                    g || f !== m || u !== v || h !== w || p !== x ? (r && n._trigger("beforeViewEmpty", null, {
                            region: "right"
                        }),
                        e.$tbl_right.empty(),
                        e.renderView(u, f, h, p),
                        !s || f === m && u === v || (e.$tbl_left.empty(),
                            e.renderView(u, f, 0, a - 1)),
                        d && (h === w && p === x || (n._trigger("beforeViewEmpty", null, {
                                    region: "tr"
                                }),
                                e.$tbl_tr.empty(),
                                e.renderView(0, d - 1, h, p)),
                            s && null == m && (e.$tbl_lt.empty(),
                ...
                var _ = h != e.initH || p != e.finalH,
                    q = _ && null != e.initH;
                (f != e.finalV || u != e.initV || _) && (e.initV = u,
                    e.finalV = f,
                    e.initH = h,
                    e.finalH = p,
                    r ? n._trigger("refresh", null, {
                        source: t.source,
                        hChanged: q
            ...
            refreshCell: function(e, n, r, i) {
                var o, a = this,
                    ...
                    c = function(l, s) {
                        l && (o = !0,
                            l.id = "",
                            t(l).replaceWith(a.generateCell(e, n, r, i, s)))
                    };
                return l ? (e = l.rowIndxPage,
                        n = l.colIndx,
                        r = l.rowData,
                        i = l.column,
            ...
            removeMergeCells: function() {
                for (var e, n, r, i, o, a, l, s, d, c, u = this, h = u.iMerge, f = u.riOffset, p = (u.freezeCols,
                        u.freezeRows,
                        u.getMergeCells()), g = u._initH, v = u._finalH, m = u._initV, w = u._finalV, x = 0, y = p.length; y > x; x++)
                    s = p[x],
                    n = u.getCellIndx(s),
                    n && (r = n[0],
                        i = n[1],
                        d = n[2],
                        e = h.getRootCell(r + f, i),
                        o = r + e.o_rc - 1,
                        a = i + e.o_cc - 1,
                        l = !1,
                        r > w || i > v ? l = !0 : "right" == d ? (m > o || g > a) && (l = !0) : "left" == d ? m > o && (l = !0) : "tr" == d && g > a && (l = !0),
                        c = s.parentNode,
                        l && t(s).remove(),
                        c.children.length || c.parentNode.removeChild(c))
            },
            ...
            renderRow: function(e, n, r, i, o, a) {
                var l, s, d, c, u = this.getRow(r, a),
                    ...
                    g = this.colModel;
                for (!u && e.push(this.generateRow(r, a)),
                    0 != i || !h || "left" != a && "lt" != a || (c = this.renderNumCell(r, h, a),
                        f.push(c)),
                    d = i; o >= d; d++)
                    s = g[d],
                    s.hidden || (c = this.generateCell(r, d, n, s, a, p),
                        f.push(c));
                l = f.join(""),
            ...
            renderView: function(t, e, n, r, i) {
                if (null != n && null != r) {
                    ...
                    for (var o, a = [], l = this.data, s = this["$tbl_" + i], d = t; e >= d; d++)
                        o = l[d],
                        o && !o.pq_hidden && this.renderRow(a, o, d, n, r, i);
                    s.append(a.join(""))
                }
            },
            ...
            setCellDims: function(t) {
                ...
                r.eachV(function(g, v) {
                    var m, w = r.get$Row(v),
                        ...
                        C = r.getHeightCell(v);
                    c(w, x, y);
                    for (var b = s ? -1 : 0; f >= b; b++)
                        b = d(h, p, b),
                        (0 > b || !l[b].hidden) && (a && (e = o.ismergedCell(v + u, b)) || (m = r.getCell(v, b),
                            m && (n = m.style,
                                n.height = (-1 == b ? x : C) + "px",
                                t || (n.width = r.getWidthCell(b) + "px",
                                    n[i] = r.getLeft(b) + "px"))))
                });
                for (var g = r.getMergeCells(), v = 0, m = g.length; m > v; v++) {
                    ...
                    if (x) {
                        ...
                        c(I, _, D),
                            n = w.style,
                            n.height = q + "px",
                            t || (n.width = r.getWidthCellM(C, e.o_cc) + "px",
                                n[i] = r.getLeft(C) + "px")
                    }
                }
            },
            ...
            setColWdArr: function(e, n) {
                ...
                if (D >= 0)
                    for (; f >= e; f--)
                        if (i = m[f],
                            !i.hidden && -1 == (i.width + "").indexOf("%") && (s = q ? i.width : i._minWidth)) {
                            for (r = 0; D >= r; r++)
                                if (r = v(b, x, r),
                                    a = w[r],
                                    a && !a.pq_hidden) {
                                    if (d = !0,
                                        c = C.ismergedCell(r + g, f)) {
                                        if (1 == c)
                                            continue;
                                        if (c = C.getRootCell(r + g, f),
                                            c.v_rc > 1 || c.v_cc > 1) {
                                            if (c.v_cc > 1)
                                                continue;
                                            d = !1
                                        ...
                                        o = p.getCell(r, f);
                                    o.parentNode.style.width = y,
                                        d && (o.style.width = "auto",
                                            u = t(o).find(".pq-menu-icon,.pq-menu-filter-icon"),
                                            u.length && (u.css({
                                                    position: "static",
                                                    "float": "left",
                                                    width: 20
                                                }),
                                                h = t(o).find(".pq-td-div"),
                                                h.css("width", "auto"))),
                                        l = o.offsetWidth + 1,
                                        d && u.length && (u.css({
                                                position: "",
                        ...
                        for (f = D ? g.getHtDetail(l, D) : 0,
                            ...
                            if (i = r,
                                ...
                                if (u = C && q.ismergedCell(p + m, r)) {
                                    if (1 == u || b)
                                        continue;
                                    u = q.getRootCell(p + m, r),
                                        s = g.getCell(u.o_ri - m, u.o_ci)
                                } else
                                    s = g.getCell(p, r);
                                s.style.height = "auto",
                                    d = s.offsetHeight,
                                    u && (h = u.o_rc - (u.v_ri - u.o_ri) - 1,
                                        d -= u.v_rc > 1 ? g.getHeightCellDirty(u.v_ri - m + 1, h) : 0),
                                    c = Math.max(d, c)
                            }
                        a = c + f,
                            w[p] != a && (w[p] = l.pq_ht = a,
...
function(t) {
    pq.cRenderBody = function(t, e) {
            ...
            n.that = t,
                n.rtl = i.rtl ? "right" : "left",
                n.setTimer = n.setTimer(r),
                n.cellPrefix = "pq-body-cell-u" + r + "-",
                n.rowPrefix = "pq-body-row-u" + r + "-",
                n.cellCls = "pq-grid-cell",
                n.iMerge = t.iMerge,
                n.rowHt = i.rowHt || 27,
                n.rowHtDetail = i.detailModel.height,
                n.iRenderHead = t.iRenderHead = new pq.cRenderHead(t, l),
                n.iRenderSum = t.iRenderSum = new pq.cRenderSum(t, a),
                t.on("headHtChanged", n.onHeadHtChanged(n)),
                null != s && t.on("refresh refreshRow refreshCell refreshColumn", function() {
        ...
        pq.cRenderBody.prototype = t.extend({}, new t.paramquery.cGenerateView, new pq.cRender, {
            ...
            flex: function(t) {
                ...
                0 != n._trigger("beforeFlex", null, {
                    colIndx: t
                }) && (e.iRenderHead.autoWidth(t),
                    e.iRenderSum.autoWidth(t),
                    e.autoWidth(t),
                    n.refreshCM(null, {
                        flex: !0
                    }),
            ...
            init: function(t) {
                ...
                var e, n = this,
                    ...
                    d = r.options,
                    c = d.scrollModel,
                    u = (n.freezeCols = d.freezeCols || 0,
                        n.freezeRows = d.freezeRows,
                        n.numberCell = d.numberCell),
                ...
                o && (n.dims = r.dims,
                        ...
                        n.pauseTO = c.timeout,
                        e = r.pdata || [],
                        f.find(".pq-grid-norows").css("display", e.length ? "none" : ""),
                        n.data = e,
                        n.maxHt = pq.cVirtual.maxHt,
                        n.riOffset = r.riOffset,
                        n.cols = h.length,
                        n.rows = e.length,
                        r._mergeCells && (n._m = function() {
                            return !0
                        }),
                        n.autoRow = d.autoRow,
                        n.initRowHtArrSuper(),
                        d.stripeRows && n.initStripeArr()),
                    n.refreshColumnWidths(),
                    n.numColWd = l.numColWd = s.numColWd = u.show ? u.outerWidth : 0,
                    n.initColWdArrSuper(),
                    s.init(t),
                    t.header ? l.init(t) : n.setPanes(),
                    s.initPost(t),
                    t.header && l.initPost(t),
                    n.$cright[0].scrollTop > n.getTop(n.rows) || (o ? n.refreshAllCells({
                        source: a
                    }) : i && (n.setCellDims(),
                        n.refresh({
                            source: a
            ...
            initColWdArr: function() {
                for (var t, e = this.colModel, n = e.length, r = (this.leftArr = this.iRenderHead.leftArr = this.iRenderSum.leftArr = [],
                        0), i = this.colwdArr = this.iRenderHead.colwdArr = this.iRenderSum.colwdArr = []; n > r; r++)
                    t = e[r],
                    i[r] = t.hidden ? 0 : t.outerWidth
            },
            ...
            onNativeScroll: function(t) {
                return function() {
                    var e = t.$cright[0],
                        ...
                        r = e.scrollLeft,
                        i = e.scrollTop;
                    t.iRenderSum.setScrollLeft(r),
                        t.iRenderHead.setScrollLeft(r),
                        t.$cleft[0].scrollTop = i,
                        t.$ctr[0].scrollLeft = r,
                        t.refresh(),
                        n._trigger("scroll"),
                        t.setTimer(function() {
            ...
            postRenderAll: function() {
                ...
                r.eachH(function(l, s) {
                        (n = l.postRender) && r.eachV(function(l, d) {
                            e = a.getRootCellO(d + o, s, !0),
                                t = r.getCell(e.rowIndxPage, e.colIndx),
                                t && !t._postRender && (e.cell = t,
                                    i.callFn(n, e),
                                    t._postRender = !0)
                        })
                    }),
            ...
            _scrollRow: function(t, e) {
                ...
                return null != h ? (h + f + 1 > c + o ? n = h + f + 1 - o : c + u > h && (n = h - u,
                        n = 0 > n ? 0 : n),
                    n >= 0 ? n : c) : void 0
            },
            ...
            scrollY: function(t, e) {
                var n = this.$cright[0];
                return null == t ? n.scrollTop : (t = t >= 0 ? t : 0,
                    void this.scrollXY(pq.scrollLeft(n), t, e))
            },
            scrollXY: function(t, e, n) {
                var r, i, o = this.$cright[0],
                    ...
                    l = o.scrollLeft,
                    s = o.scrollTop;
                return t >= 0 ? (pq.scrollLeft(o, t),
                    o.scrollTop = e,
                    r = o.scrollLeft,
                    i = o.scrollTop,
                    n && (r == l && i == s ? n() : a.one("scroll", function() {
            ...
            setPanes: function() {
                ...
                m.css("display", h ? "" : "none"),
                    ...
                    f.css("overflow-y", ""),
                    "flex" == r.height ? (s > 0 && C > s ? C = Math.min(C, s) : f.css("overflow-y", "hidden"),
                        r.setHtCont(C)) : r.setHtCont(s),
                    a && r.getSBWd() && f.css("overflow-y", "scroll"),
                    f.css("overflow-x", a ? "hidden" : ""),
                    "flex" == r.width ? (y = parseInt(c[0].style.height) >= l.htTbl - 1 ? y : y + x,
                        o.maxWidth && y > d ? y = Math.min(y, d) : f.css("overflow-x", "hidden"),
                        r._flexWidth = y,
                        c.width(r._flexWidth)) : c.css("width", ""),
                    r.htCont = l.htCont = f.height(),
                    r.wdCont = l.wdCont = f.width(),
                    l.htContClient = n = p.clientHeight,
                    l.wdContClient = t = p.clientWidth,
                    w > t && (f.css("overflow-x", "hidden"),
                        w = t),
                    g.css("width", w),
                    v.css("width", w),
                    m.width(t),
                    g.height(n),
                    e = p.offsetWidth,
                    r.iRenderHead.setWidth(e, t),
                    r.iRenderSum.setWidth(e, t),
                    b > n && (f.css("overflow-y", "hidden"),
                        b = n),
                    v.css("height", b),
                    m.css("height", b),
                    r.wdContLeft = l.wdContLeft = g.width(),
                    r.htContTop = l.htContTop = m.height()
            }
        }, new pq.cVirtual)
}(jQuery),
function(t) {
    ...
    t.paramquery.cMergeHead = e,
        e.prototype = {
            getRootCell: function(t, e) {
                for (var n = this.that, r = n.headerCells, i = r[t][e], o = i.rowSpan, a = i.leftPos; t && r[t - 1][a] == i;)
                    t--;
                return {
                    v_ri: t,
                    o_ri: t,
            ...
            ismergedCell: function(t, e) {
                ...
                if (d)
                    if (n = d.leftPos,
                        0 != t && l[t - 1][e] === d || (o = a.getNextVisibleCI(n)) != e) {
                        if (d.colSpan)
                            return !0
                    } else if (r = d.rowSpan,
                    i = d.colSpan,
    ...
    pq.cRenderHS = t.extend({}, new pq.cRender, {
        init: function(t) {
            ...
            var e, n = this,
                r = n.that,
                i = r.options,
                o = (n.freezeCols = i.freezeCols || 0,
                    n.numberCell = i.numberCell,
                    n.colModel = r.colModel),
                a = n.isHead(),
                l = n.isSum(),
            ...
            n.freezeRows = 0;
            n.dims = r.dims,
                a ? e = n.data = i.showHeader ? i.filterModel.header ? d.concat([
                    []
                ]) : d : [] : l && (e = n.data = i.summaryData || []),
                n.maxHt = pq.cVirtual.maxHt,
                n.riOffset = 0,
                n.cols = o.length,
                n.rows = e.length,
                a ? d.length > 1 && (n._m = function() {
                    return !0
                }) : i.stripeRows && n.initStripeArr(),
                n.autoRow = null == s ? i.autoRow : s,
                n.initRowHtArrSuper(),
                n.assignTblDims(!0),
                n.setPanes()
        },
        initPost: function(t) {
            ...
            var e = this;
            e.autoRow;
            e.data.length && (t.soft ? (e.setCellDims(),
                e.refresh()) : e.refreshAllCells())
        },
        onNativeScroll: function(t) {
            return function() {
                t.refresh(),
        ...
        setPanes: function() {
            ...
            l.css("display", s ? "" : "none"),
                r.height(u),
                d ? (n.htHead = u,
                    e._trigger("headHtChanged")) : c && (n.htSum = u,
                    e._trigger("headHtChanged")),
                t.htCont = o.height(),
                t.wdCont = o.width(),
                l.css("width", s),
    ...
    var e = t.paramquery,
        n = pq.cRenderHead = function(t, n) {
            ...
            i.iMerge = new e.cMergeHead(t),
                ...
                i.height = "flex",
                i.scrollTop = 0,
                i.rtl = r.rtl ? "right" : "left",
                i.rowHt = r.rowHtHead || 28,
    ...
    n.prototype = t.extend({}, pq.cRenderHS, new e.cHeader, new e.cHeaderSearch, {
        getRowClsStyleAttr: function(t) {
            var e = this.that.headerCells.length,
                n = "";
            return e == t ? n = "pq-grid-header-search-row" : t == e - 1 && (n = "pq-grid-title-row"),
                [n, "", ""]
        },
        getTblCls: function(t) {
        ...
        onRefreshTimer: function(t, e) {
            return function() {
                ...
                t.autoRow && t.autoHeight({
                    ...
                    t.that._trigger("refreshHeadAsync")
            }
        },
        ...
        refreshResizeColumn: function() {
            ...
            for (this.$ele.find("." + l).remove(); s >= f; f++) {
                ...
                t = f >= 0 ? a[f] : d,
                    t.hidden || t.resizable === !1 || this._resizeDiv(f) || (n = this.getLeft(f + 1),
                        r = n - 5,
                        i = this._resizeId(f),
                        e.push("<div id='", i, "' pq-col-indx='", f, "' style='", this.rtl, ":", r, "px;'", " class='pq-grid-col-resize-handle " + l + "'>&nbsp;</div>"))
            }
        ...
        renderCell: function(t) {
            var e, n = t.rowData,
                ...
                l = t.style,
                s = n[i];
            return s ? (s.colSpan > 1 && l.push("z-index:3;"),
                this.createHeaderCell(r, i, s, o, a, l)) : (e = this.renderFilterCell(t.column, i, a),
                "<div " + o + " class='" + a.join(" ") + "' style='" + l.join("") + "'>" + e + "</div>")
        }
    })
}(jQuery),
function(t) {
    var e = t.paramquery,
        n = pq.cRenderSum = function(t, e) {
            ...
            r.that = t,
                ...
                r.height = "flex",
                r.scrollTop = 0,
                r.rowHt = n.rowHtSum || 27,
                r.cellCls = "pq-grid-cell",
                r.setTimer = r.setTimer(i),
                r.cellPrefix = "pq-sum-cell-u" + i + "-",
                r.rowPrefix = "pq-sum-row-u" + i + "-",
                r.preInit(e),
                t.on("refreshSum softRefresh", r.onRefresh.bind(r))
        };
