...
class BreakdownseverityController extends Controller
{
  ...
  public function severitygrids(Breakdownseverity $Breakdownseverity)
    ...
    $result = \DB::select("SELECT COUNT(breakdownseverity_id) AS count FROM  breakdown_severity as breakdown_severity where 1=1 $wh");
    ...
    $SQL = "SELECT * FROM breakdown_severity WHERE 1 = 1 $wh ORDER BY $sidx $sord LIMIT $start,$limit";
    $download = "SELECT * FROM breakdown_severity WHERE 1 = 1 $wh ORDER BY $sidx $sord";
