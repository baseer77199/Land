...
//Upload
    ...
    $status['status']='success';
        ...
        { 
            ...
            foreach($result_pr as $key=>$value)
            {
                ...
                {
                    $checkvalue =$this->checkvalue('ma_department_t',trim($value->department_id),"department_name");
               ...
               if(!empty($value->locationid))
                {
                    $checkvalue =$this->checkvalue('m_location_t',trim($value->locationid),"location_name");
   ...
   if(!empty($value->group_id))
                {
                    $checkvalue =$this->checkvalue('machine_group_t',trim($value->group_id),"group_name");
                ...
                {
                    $checkvalue =$this->checkvalue('m_amc_tb',trim($value->vendor_id),"vendor_name");
                ...
                {
                    $checkvalue =$this->checkvalue('m_amc_tb',trim($value->amc_vendor_id),"vendor_name");
                ...
                {
                    $checkvalue =$this->checkvalue('frequency_tbl',trim($value->frequency),"frequency_name");
