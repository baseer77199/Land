...
concat(cbb.employee_number,'-',cbb.first_name) as closed_by
    ...
    where 1=1 $wh1 and date(b_maintenance_t.issue_date) BETWEEN '$start_date' and '$end_date') as v1 where 1=1 $wh ";
         //  dd("df");   
...
left join tb_users as cb ON cb.id=b_maintenance_t.issue_created_by
left join tb_users as cbb ON cbb.id=b_maintenance_t.closed_engineer_by
where 1=1 $wh1 and date(b_maintenance_t.issue_date) BETWEEN '$start_date' and '$end_date') as v1 where 1=1 $wh  ORDER BY $sidx LIMIT $start , $limit";
