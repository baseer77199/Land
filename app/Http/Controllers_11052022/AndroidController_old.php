...
class AndroidController extends Controller {
	...
	public function assignengineerticketlist(Request $request){
		...
		$data = DB::table('b_maintenance_t')->leftjoin('ma_department_t','ma_department_t.department_id','=','b_maintenance_t.department_id')->leftjoin('machine_hdr_t','machine_hdr_t.machine_id','=','b_maintenance_t.machine_id')->leftjoin('m_breakdowntype_t','m_breakdowntype_t.breakdowntype_id','=','b_maintenance_t.break_type_id')->leftjoin('breakdown_severity','breakdown_severity.breakdownseverity_id','=','b_maintenance_t.breakdown_sevearity')->leftjoin('tb_users','tb_users.id','=','b_maintenance_t.issue_created_by')->leftjoin('maintanance_type','maintanance_type.mt_id','=','b_maintenance_t.maintenance_type')->select('b_maintenance_t.id','maintanance_type.maintanance_name as maintenance_type','b_maintenance_t.causes','b_maintenance_t.issue_date','b_maintenance_t.technician','b_maintenance_t.request_status','b_maintenance_t.ticket_number','ma_department_t.department_name','machine_hdr_t.machine_name','machine_hdr_t.asset_code','machine_hdr_t.files as image','m_breakdowntype_t.breakdown_name','breakdown_severity.severity_name','tb_users.employee_number')->where('b_maintenance_t.request_status','INITIATED')->where('b_maintenance_t.engineer','=',0)->where('b_maintenance_t.location_id','=',$locid)->orWhere('b_maintenance_t.request_status','OPEN')->where('b_maintenance_t.location_id','=',$locid)->where('b_maintenance_t.engineer','=',0)->orWhere('b_maintenance_t.request_status','REJECTED')->where('b_maintenance_t.location_id','=',$locid)->where($array)->orWhere($array1)->orWhere($array2)->orWhere($array3)->orderBy('b_maintenance_t.id', 'desc')
		->get();
	...
	public function assigntechticketlist(Request $request){
		...
		$data = DB::table('b_maintenance_t')->leftjoin('ma_department_t','ma_department_t.department_id','=','b_maintenance_t.department_id')->leftjoin('machine_hdr_t','machine_hdr_t.machine_id','=','b_maintenance_t.machine_id')->leftjoin('m_breakdowntype_t','m_breakdowntype_t.breakdowntype_id','=','b_maintenance_t.break_type_id')->leftjoin('breakdown_severity','breakdown_severity.breakdownseverity_id','=','b_maintenance_t.breakdown_sevearity')->leftjoin('tb_users as eng','eng.id','=','b_maintenance_t.engineer')->leftjoin('tb_users','tb_users.id','=','b_maintenance_t.issue_created_by')->leftjoin('maintanance_type','maintanance_type.mt_id','=','b_maintenance_t.maintenance_type')->select('b_maintenance_t.id','maintanance_type.maintanance_name as maintenance_type','b_maintenance_t.technician','b_maintenance_t.causes','b_maintenance_t.issue_date','b_maintenance_t.request_status','b_maintenance_t.ticket_number','ma_department_t.department_name','machine_hdr_t.machine_name','machine_hdr_t.asset_code','machine_hdr_t.files as image','m_breakdowntype_t.breakdown_name','breakdown_severity.severity_name','tb_users.employee_number','eng.employee_number as engineer_name')->where('b_maintenance_t.request_status','INITIATED')->where('b_maintenance_t.location_id','=',$locid)->orWhere('b_maintenance_t.request_status','OPEN')->where('b_maintenance_t.technician','=','[]')->where('b_maintenance_t.location_id','=',$locid)->where($array)->orWhere($array1)->orWhere($array2)->orWhere($array3)->orderBy('b_maintenance_t.id', 'desc')
		->get();
	...
	public function approvalrequestlist(Request $request){
		...
		$data = DB::table('b_maintenance_t')->leftjoin('ma_department_t','ma_department_t.department_id','=','b_maintenance_t.department_id')->leftjoin('machine_hdr_t','machine_hdr_t.machine_id','=','b_maintenance_t.machine_id')->leftjoin('m_breakdowntype_t','m_breakdowntype_t.breakdowntype_id','=','b_maintenance_t.break_type_id')->leftjoin('breakdown_severity','breakdown_severity.breakdownseverity_id','=','b_maintenance_t.breakdown_sevearity')->leftjoin('tb_users','tb_users.id','=','b_maintenance_t.issue_created_by')->leftjoin('tb_users as eng','eng.id','=','b_maintenance_t.engineer')->leftjoin('maintanance_type','maintanance_type.mt_id','=','b_maintenance_t.maintenance_type')->select('eng.employee_number as engineer_name','b_maintenance_t.id','maintanance_type.maintanance_name as maintenance_type','b_maintenance_t.technician','b_maintenance_t.causes','b_maintenance_t.issue_date','b_maintenance_t.request_status','b_maintenance_t.ticket_number','ma_department_t.department_name','machine_hdr_t.machine_name','machine_hdr_t.asset_code','machine_hdr_t.files as image','m_breakdowntype_t.breakdown_name','breakdown_severity.severity_name','tb_users.employee_number')->where('b_maintenance_t.request_status','INITIATED')->where('b_maintenance_t.location_id','=',$locid)->orWhere('b_maintenance_t.request_status','REJECTED')->where('b_maintenance_t.location_id','=',$locid)->where($array)->orWhere($array1)->orWhere($array2)->orWhere($array3)->orderBy('b_maintenance_t.id', 'desc')
		->get();
	...
	public function getalldata(Request $request)
	{
		...
		$data7 = DB::table('maintanance_type')->select('mt_id','maintanance_name')->orderBy('maintanance_name', 'asc')->get();
	...
	public function requestticket(Request $request)
	{
		...
		$ids = $user_details->id;
        $token = md5(rand());
        \DB::update("update tb_users set m_token='$token' where id='$ids'");
		$id=$posted_data['id'];
		$data=array();
	...
	public function getcloselist(Request $request){
		...
		$data = DB::table('b_maintenance_t')->leftjoin('ma_department_t','ma_department_t.department_id','=','b_maintenance_t.department_id')->leftjoin('machine_hdr_t','machine_hdr_t.machine_id','=','b_maintenance_t.machine_id')->leftjoin('m_breakdowntype_t','m_breakdowntype_t.breakdowntype_id','=','b_maintenance_t.break_type_id')->leftjoin('breakdown_severity','breakdown_severity.breakdownseverity_id','=','b_maintenance_t.breakdown_sevearity')->leftjoin('tb_users','tb_users.id','=','b_maintenance_t.issue_created_by')->leftjoin('tb_users as eng','eng.id','=','b_maintenance_t.engineer')->leftjoin('maintanance_type','maintanance_type.mt_id','=','b_maintenance_t.maintenance_type')->select('eng.employee_number as engineer_name','b_maintenance_t.technician','b_maintenance_t.start_date','b_maintenance_t.end_date','b_maintenance_t.request_remark','b_maintenance_t.approve_remarks','b_maintenance_t.id','maintanance_type.maintanance_name as maintenance_type','b_maintenance_t.causes','b_maintenance_t.issue_date','b_maintenance_t.request_status','b_maintenance_t.start_date','b_maintenance_t.end_date','b_maintenance_t.ticket_number','ma_department_t.department_name','machine_hdr_t.machine_name','m_breakdowntype_t.breakdown_name','machine_hdr_t.asset_code','machine_hdr_t.files as image','breakdown_severity.severity_name','tb_users.employee_number')->where('b_maintenance_t.request_status','=','APPROVED')->where('b_maintenance_t.location_id','=',$locid)->where($array)->orWhere($array1)->orWhere($array2)->orWhere($array3)->orderBy('b_maintenance_t.id', 'desc')
		->get();
		if (count($data)>0) {
		    foreach($data as $k=>$v){
		        $firstname="";
