        ...
        $Spare=new Spare();
          ...
          //  dd($edit_id);
            ...
            if($request->hasfile('upload_image'))
            {
                ...
                ->update(['department_id' => $_POST['department_id'], 'category' => $_POST['category'], 'spare_quantity' => $_POST['spare_quantity'], 'spares_name' => $_POST['spares_name'], 'created_by' => $_POST['created_by'], 'description' => $_POST['description'], 'upload_image' => $upload_image,'spares_no'=>$_POST['spares_no']]);
            }
            else
            {
				$upload_image="";
