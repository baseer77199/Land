  ...
  $result1 = \DB::select( $download_SQL );
    ...
    $validatedData=   $this->validate($request, [
        ...
        $Spare=new Spare();
            ...
            $Spare->spares_no=$_POST['spares_no'];
            ...
            $Spare->organization_id=\Session::get('organization');
          ...
          //  dd($edit_id);
            ...
            if($request->hasfile('upload_image'))
            {
                ...
                ->update(['department_id' => $_POST['department_id'], 'category' => $_POST['category'], 'spare_quantity' => $_POST['spare_quantity'], 'spares_name' => $_POST['spares_name'], 'description' => $_POST['description'], 'upload_image' => $upload_image,'spares_no'=>$_POST['spares_no'],'updated_at'=>date('Y-m-d H:i:s'),
