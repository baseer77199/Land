           ...
           // dd("dsf");
            ...
            if($edit_id=="")
            {
             ...
             return response()->json(array('status' => 'success', 'message' => 'Saved Successfully','id' => $id));
                ...
                $amc1['last_updated_by'] =  \Session::get('id');
                $amc1['company_id'] =  \Session::get('companyid');
                $amc1['location_id'] =  \Session::get('location');
                $amc1['organization_id'] =  \Session::get('organization');
                // $_POST['created_at'] =  date('Y-m-d H:i:s');
                $amc1['updated_at'] =  date('Y-m-d H:i:s');
                   // dd($amc1);
