...
class ConfigController extends Controller
{
    ...
    {
        $sql_c = \DB::table('c_config_hdr_t')
            ->leftjoin('c_config_lines_t', 'c_config_lines_t.config_hdr_id', '=', 'c_config_hdr_t.config_hdr_id')
            ->where('c_config_hdr_t.config_hdr_id', $module)
            ->where('c_config_lines_t.type', 'Yes')
