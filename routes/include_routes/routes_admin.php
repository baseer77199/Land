...
Route::get('initiatepmupload', array('as' => '', 'check' => '', 'menu' => 'initiatepmupload', 'label' => '', 'uses' => 'ConfigController@uploadindex'))->name('initiatepmupload');
Route::post('ticketgenerateupload', array('as' => '', 'check' => '', 'menu' => 'createissue', 'label' => 'Upload', 'uses' => 'ConfigController@uploadindex'))->name('ticketgenerateupload');


Route::get('attendanceupload', array('as' => '', 'check' => '', 'menu' => 'Attendence Upload', 'label' => '', 'uses' => 'attendenceuploadController@index'));
...
Route::post('userprofileedit', array('as' => '', 'check' => 'edit', 'menu' => 'userprofile', 'label' => 'edit', 'uses' => 'CreateuserController@create'));
Route::post('userviews', array('as' => '', 'check' => 'View', 'menu' => 'user', 'label' => 'view', 'uses' => 'CreateuserController@show'))->name('userview');
Route::post('userdelete', array('as' => '', 'check' => 'delete', 'menu' => 'user', 'label' => 'view', 'uses' => 'CreateuserController@delete'))->name('userview');
Route::get('userdelete/{id}', array('as' => '', 'check' => 'delete', 'menu' => 'user', 'label' => 'view', 'uses' => 'CreateuserController@delete'))->name('userview');
Route::post('blockunblockuser', array('as' => '', 'check' => 'userblock', 'menu' => 'user', 'label' => 'view', 'uses' => 'CreateuserController@blockunblockuser'))->name('user');
...
Route::post('departmentdelete', 'DepartmentController@destroy');
...
Route::get('machinegroup', array('as' => '', 'check' => '', 'menu' => 'Machine Group', 'label' => '', 'uses' => 'MachinegroupController@index'))->name('machinegroup');
...
Route::get('filemachine', array('as' => '', 'check' => '', 'menu' => 'filemachine', 'label' => '', 'uses' => 'MachinefilesController@index'))->name('filemachine');
...
//Breakdownseverity
Route::get('breakdownseverity', array('as' => '', 'check' => '', 'menu' => 'Breakdown Severity', 'label' => '', 'uses' => 'BreakdownseverityController@index'))->name('breakdownseverity');
...
Route::get('drawingfiles', array('as' => '', 'check' => '', 'menu' => 'Drawing Files', 'label' => '', 'uses' => 'DrawingController@index'))->name('drawingfiles');
...
Route::get('frequency', array('as' => '', 'check' => '', 'menu' => 'Maintenance Frequency', 'label' => '', 'uses' => 'FrequencyController@index'))->name('frequency');
...
Route::get('checklist', array('as' => '', 'check' => '', 'menu' => 'Pm Checklist', 'label' => '', 'uses' => 'CheckController@index'))->name('checklist');
...
Route::get('assettransfer', array('as' => '', 'check' => '', 'menu' => 'Asset transfer', 'label' => '', 'uses' => 'AddmachineController@assetindex'))->name('assettransfer');
...
/*Break Down Type*/
Route::get('breakdowntype', array('as' => '', 'check' => '', 'menu' => 'Breakdown Type', 'label' => 'breakdown type', 'uses' => 'BreakdowntypeController@index'))->name('breakdowntype');
...
/** pm checklist upload **/
Route::get('checklistimport', array('as' => '', 'check' => '', 'menu' => 'Pm Checklist Upload', 'label' => '', 'uses' => 'MachinechecklistController@checklistimport'))->name('checklistimport');
...
Route::post('download_templetechecklist', array('as' => '', 'check' => '', 'menu' => 'download_templetechecklist', 'label' => '', 'uses' => 'MachinechecklistController@downloadtemplate'))->name('downloadtemplate');
//import downloadtemplate 
Route::post('download_templetemachinechecklist', array('as' => '', 'check' => '', 'menu' => 'download_templetemachinechecklist', 'label' => '', 'uses' => 'MachinechecklistController@downloadmachinechecklisttemplate'))->name('downloadtemplate');
//import PM Machine Upload downloadt emplate 
Route::post('download_templetepmupload', array('as' => '', 'check' => '', 'menu' => 'download_templetepmupload', 'label' => '', 'uses' => 'MachinechecklistController@downloadtempletepmupload'))->name('downloadtemplate');
//import downloadtemplate 
Route::post('download_templetemachine', array('as' => '', 'check' => '', 'menu' => 'download_templetemachine', 'label' => '', 'uses' => 'MachinechecklistController@downloadmachinetemplate'))->name('downloadtemplate');
...
Route::post('checklistuploaddelete', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'MachinechecklistController@checklistuploaddelete'))->name('checklistuploaddelete');
Route::post('checklistuploadedit', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'MachinechecklistController@checklistuploadedit'))->name('checklistuploadedit');


/** PM upload **/
Route::get('pmimport', array('as' => '', 'check' => '', 'menu' => 'PM Upload', 'label' => '', 'uses' => 'PMController@pmimport'))->name('pmimport');
Route::get('getpmuploaddata', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@getpmuploaddata'))->name('getpmuploaddata');
Route::post('pmuploadsave', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@pmuploadsave'))->name('pmuploadsave');
Route::get('getpmvalidate', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@getpmvalidate'))->name('getpmvalidate');
Route::post('getpmload', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@getpmvalidate'))->name('getpmvalidate');
Route::post('pmuploadnewsave', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@pmuploadnewsave'))->name('pmuploadnewsave');
Route::post('pmuploaddelete', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@pmuploaddelete'))->name('pmuploaddelete');
Route::post('pmuploadedit', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'PMController@pmuploadedit'))->name('pmuploadedit');
...
//Vignesh : VAPTapr25
Route::post('machineuploaddelete', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'AddmachineController@checklistuploaddelete'))->name('checklistuploaddelete');
Route::post('machineuploadedit', array('as' => '', 'check' => '', 'menu' => '', 'label' => 'edit', 'uses' => 'AddmachineController@checklistuploadedit'))->name('checklistuploadedit');
...
Route::post('issuecancel', array('as' => '', 'check' => '', 'menu' => 'createissue', 'label' => '', 'uses' => 'BreakdownmaintenanceController@issuecancel'))->name('createcancel');
Route::post('issueedit', array('as' => '', 'check' => '', 'menu' => 'createissue', 'label' => '', 'uses' => 'BreakdownmaintenanceController@create'))->name('editissue');
...
Route::get('issuemachinecheck/{id}/{machine}', array('as' => '', 'check' => '', 'menu' => 'createissue', 'label' => '', 'uses' => 'BreakdownmaintenanceController@issuemachinecheck'))->name('issueData');
...
Route::get('sopview/{id}', array('as' => '', 'check' => '', 'menu' => 'createissue', 'label' => 'view', 'uses' => 'BreakdownmaintenanceController@show'))->name('sopview');
...
Route::post('engineerallocate', array('as' => '', 'check' => '', 'menu' => 'reallocatetechnician', 'label' => 'create', 'uses' => 'BreakdownmaintenanceController@create'))->name('allocateengineer');

/*Allocate Technician*/
// Route::get('allocatetechnician', array('as' => '', 'check' => '', 'menu' => 'reallocatetechnician', 'label' => '', 'uses' => 'BreakdownmaintenanceController@index'))->name('allocatetechnician');
Route::get('reallocatetechnician', array('as' => '', 'check' => '', 'menu' => 'reallocatetechnician', 'label' => '', 'uses' => 'BreakdownmaintenanceController@index'))->name('reallocatetechnician');
...
/*Close Request*/
Route::get('closedrequest', array('as' => '', 'check' => '', 'menu' => 'closedrequest', 'label' => '', 'uses' => 'BreakdownmaintenanceController@index'))->name('closedrequest');
...
/*** Shift Timings ***/
Route::get('shifttiming', array('as' => '', 'check' => '', 'menu' => 'Shift Timing', 'label' => '', 'uses' => 'ShiftdetailController@index'))->name('shifttiming');
...
Route::get('mailsetting', array('as' => '', 'check' => '', 'menu' => 'mailsetting', 'label' => '', 'uses' => 'MailSettingController@index'))->name('pmchecksheet');
Route::get('getmailsettingdata', array('as' => '', 'check' => '', 'menu' => 'mailsetting', 'label' => '', 'uses' => 'MailSettingController@getGridData'))->name('getchecklistdata');
Route::post('mailsettingcreate', array('as' => 'create', 'check' => '', 'menu' => 'mailsetting', 'label' => 'create', 'uses' => 'MailSettingController@create'))->name('machinechklistcreate');
//Route::get('machinechecklistedit/{id}',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'Edit','uses' =>'MachinechecklistController@create'))->name('machinechecklistedit');
Route::post('mailsettingview', array('as' => '', 'check' => '', 'menu' => 'mailsetting', 'label' => 'View', 'uses' => 'MailSettingController@show'))->name('machinechecklistview');
Route::post('mailsettingsave', array('as' => '', 'check' => '', 'menu' => '', 'label' => '', 'uses' => 'MailSettingController@save'));

/*Create Escalation Matrix*/
Route::get('escalation', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => '', 'uses' => 'EscalationController@index'))->name('pmchecksheet');
Route::get('getescalationdata', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => '', 'uses' => 'EscalationController@getGridData'))->name('getchecklistdata');
Route::post('escalationcreate', array('as' => 'create', 'check' => '', 'menu' => 'escalation', 'label' => 'create', 'uses' => 'EscalationController@create'))->name('machinechklistcreate');
//Route::get('machinechecklistedit/{id}',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'Edit','uses' =>'MachinechecklistController@create'))->name('machinechecklistedit');
Route::post('escalationview', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => 'View', 'uses' => 'EscalationController@show'))->name('machinechecklistview');
Route::post('escalationsave', array('as' => '', 'check' => '', 'menu' => '', 'label' => '', 'uses' => 'EscalationController@save'));

Route::get('escalationmail', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => '', 'uses' => 'Controller@escalationmail'))->name('pmchecksheet');
Route::get('getTicketHistory/{id}/{module}', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => '', 'uses' => 'Controller@getTicketHistory'))->name('pmchecksheet');

Route::get('sendticketmail', array('as' => '', 'check' => '', 'menu' => 'escalation', 'label' => '', 'uses' => 'Controller@sendticketmail'))->name('sendticketmail');
Route::post('noticlose', array('as' => '', 'check' => '', 'menu' => 'noticlose', 'label' => '', 'uses' => 'Controller@noticlose'))->name('noticlose');
Route::post('notimessage-update', array('as' => '', 'check' => '', 'menu' => 'notimessage-update', 'label' => '', 'uses' => 'Controller@notimessageUpdate'))->name('notimessage-update');


Route::post('notification/mark-read', 'NotificationController@markAsRead')->name('notification.mark-read');
Route::post('notification/mark-all-read', 'NotificationController@markAllAsRead')->name('notification.mark-all-read');
