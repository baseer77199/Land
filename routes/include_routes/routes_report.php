...
/*Pm Monthly Report*/
Route::get('pmmonthlyreport', array('as' => '', 'check' => '', 'menu' => 'PM Monthly schedule', 'label' => '', 'uses' => 'PmreportController@pmmonthlyindex'))->name('pmmonthlyreport');
Route::get('getpmmonthlydata', 'PmreportController@getpmmonthlydata')->name('getpmmonthlydata');



Route::get('pmmachinereport', array('as' => '', 'check' => '', 'menu' => 'Pm Machine List', 'label' => '', 'uses' => 'PmreportController@pmmachineindex'))->name('pmmachinereport');
Route::get('pmmachinedata', 'PmreportController@getpmmachinedata')->name('pmmonthlydata');

Route::get('pmhistoryreport', array('as' => '', 'check' => '', 'menu' => 'Pm History Report', 'label' => '', 'uses' => 'PmreportController@pmhistoryindex'))->name('pmhistoryreport');
...
/*Pm Yearly Report*/
Route::get('pmsixschedule', array('as' => '', 'check' => '', 'menu' => 'PM Six Month Plan', 'label' => '', 'uses' => 'PmreportController@pmyearlyindex'))->name('pmyearlyschedule');
Route::get('getpmyearlydata', 'PmreportController@getpmyearlydata')->name('getpmyearlydata');

/*Pm Daily Report*/
Route::get('dailycheckreport', array('as' => '', 'check' => '', 'menu' => 'Daily Checklist Details', 'label' => '', 'uses' => 'PmreportController@pmdailyindex'))->name('dailycheckreport');
...
// Route::get('qohreport', array('as' => '','check'=>'','menu'=>'qohreport', 'label'=>'','uses' => 'SparereportController@qohreport'))->name('qohreport');
// Route::get('getqohreportData', 'SparereportController@getqohreportData')->name('getqohreportData');

//Datewise Report
Route::get('qohreport', array('as' => '', 'check' => '', 'menu' => 'QOH Report', 'label' => '', 'uses' => 'SparereportController@qohreport'))->name('qohreport');
Route::get('getqohreportData', 'SparereportController@getqohreportData')->name('getqohreportData');
...
//HistDatewise Report
Route::get('histdatewiserpt', array('as' => '', 'check' => '', 'menu' => 'Breakdown Report', 'label' => '', 'uses' => 'DatewiserptController@histindex'))->name('datewiserpt');
Route::get('gethistdatewiserpt', 'DatewiserptController@gethistdatewiserpt')->name('gethistdatewiserpt');
...
Route::get('monthlybreakdownreport', array('as' => '', 'check' => '', 'menu' => 'BD Analysis Time Vs Percentage - Machine Wise', 'label' => '', 'uses' => 'ReportController@monthlybreakdownreportindex'))->name('monthlybreakdownreport');
...
Route::get('monthlybreakdownreportgroup', array('as' => '', 'check' => '', 'menu' => 'BD Analysis Time Vs Percentage - Group Wise', 'label' => '', 'uses' => 'ReportController@monthlybreakdownreportgroupindex'))->name('monthlybreakdownreport');
...
//breakdown register 
Route::get('breakdownregister', array('as' => '', 'check' => '', 'menu' => 'Breakdown Report Register', 'label' => '', 'uses' => 'ReportController@breakdownregisterindex'))->name('breakdownregister');
Route::get('breakdownregistersearch/{sd}/{ed}', 'ReportController@breakdownregistersearch')->name('breakdownregistersearch');

//breakdown summary 
Route::get('breakdownsummary', array('as' => '', 'check' => '', 'menu' => 'Breakdown Report Summary', 'label' => '', 'uses' => 'ReportController@breakdownsummaryindex'))->name('breakdownsummary');
Route::get('breakdownsummarysearch/{sd}/{ed}', 'ReportController@breakdownsummarysearch')->name('breakdownsummarysearch');

//category Wise report 
Route::get('categorywisereport', array('as' => '', 'check' => '', 'menu' => 'Categorywise Breakdown Report', 'label' => '', 'uses' => 'ReportController@categorywisereportindex'))->name('breakdownsummary');
Route::get('categorywisereportsearch/{sd}/{ed}/{id}', 'ReportController@categorywisereportsearch')->name('breakdownsummarysearch');

//GROUP Wise report 
Route::get('groupwisereport', array('as' => '', 'check' => '', 'menu' => 'Group Wise Report', 'label' => '', 'uses' => 'ReportController@groupwisereportindex'))->name('groupwisereport');
Route::get('groupwisereportsearch/{sd}/{ed}/{id}', 'ReportController@groupwisereportsearch')->name('groupwisereportsearch');

//GROUP Wise report 
Route::get('rptbdown', array('as' => '', 'check' => '', 'menu' => 'rptbdown', 'label' => '', 'uses' => 'ReportController@rptbdown'))->name('rptbdown');
Route::get('rptbdatareport', 'ReportController@rptbdatareport')->name('rptbdatareport');


//history card
Route::get('historycard', array('as' => '', 'check' => '', 'menu' => 'History Card', 'label' => '', 'uses' => 'ReportController@historycardindex'))->name('historycard');
Route::get('historycardsearch/{sd}/{ed}/{id}', 'ReportController@historycardsearch')->name('historycardsearch');

//top category Wise report 
Route::get('topcategorywisereport', array('as' => '', 'check' => '', 'menu' => 'Top5 BDs Category Wise', 'label' => '', 'uses' => 'ReportController@topcategorywisereportindex'))->name('groupwisereport');
...
Route::get('topmachinewisereport', array('as' => '', 'check' => '', 'menu' => 'Top5 BDs Machine Wise', 'label' => '', 'uses' => 'ReportController@topmachinewisereportindex'))->name('groupwisereport');
...
Route::get('toptypewisereport', array('as' => '', 'check' => '', 'menu' => 'Top5 BDs Type Wise', 'label' => '', 'uses' => 'ReportController@toptypewisereportindex'))->name('groupwisereport');
...
//history card
Route::get('maintenance', array('as' => '', 'check' => '', 'menu' => 'maintenance', 'label' => '', 'uses' => 'MaintenanceReportController@index'))->name('groupwisereport');
...
Route::get('monthwisemachinereport', array('as' => '', 'check' => '', 'menu' => 'MonthWise Machine Report', 'label' => '', 'uses' => 'DatewiserptController@monthwisemachinereportindex'))->name('monthwisemachinereport');
