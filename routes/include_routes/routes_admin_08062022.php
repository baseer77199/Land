...
Route::get('attendanceupload',array('as' => '','check'=>'','menu'=>'attendanceupload','label'=>'','uses' =>'attendenceuploadController@index'));
...
Route::get('assettransfer',array('as' => '','check'=>'','menu'=>'assettransfer','label'=>'','uses' =>'AddmachineController@assetindex'))->name('assettransfer');
...
/** pm checklist upload **/
 Route::get('checklistimport',array('as' => '','check'=>'','menu'=>'checklistimport','label'=>'','uses' =>'MachinechecklistController@checklistimport'))->name('checklistimport');
...
//import downloadtemplate checklist
 Route::post('download_templetechecklist',array('as' => '','check'=>'','menu'=>'download_templetechecklist','label'=>'','uses' =>'MachinechecklistController@downloadtemplate'))->name('dwonloadtemplate');
 //import downloadtemplate 
 Route::post('download_templetemachinechecklist',array('as' => '','check'=>'','menu'=>'download_templetemachinechecklist','label'=>'','uses' =>'MachinechecklistController@downloadmachinechecklisttemplate'))->name('dwonloadtemplate');
 //import downloadtemplate 
 Route::post('download_templetemachine',array('as' => '','check'=>'','menu'=>'download_templetemachine','label'=>'','uses' =>'MachinechecklistController@downloadmachinetemplate'))->name('dwonloadtemplate');
