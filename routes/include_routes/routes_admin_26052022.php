...
Route::get('mailsetting',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'MailSettingController@index'))->name('pmchecksheet');
Route::get('getmailsettingdata', array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'MailSettingController@getGridData'))->name('getchecklistdata');
Route::post('mailsettingcreate',array('as' => 'create','check'=>'','menu'=>'pmchecksheet','label'=>'create','uses' =>'MailSettingController@create'))->name('machinechklistcreate');
//Route::get('machinechecklistedit/{id}',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'Edit','uses' =>'MachinechecklistController@create'))->name('machinechecklistedit');
Route::post('mailsettingview',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'View','uses' =>'MailSettingController@show'))->name('machinechecklistview');
Route::post('mailsettingsave',array('as' => '','check'=>'','menu'=>'','label'=>'','uses' =>'MailSettingController@save'));

 /*Create Escalation Matrix*/
 Route::get('escalation',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'EscalationController@index'))->name('pmchecksheet');
 Route::get('getescalationdata', array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'EscalationController@getGridData'))->name('getchecklistdata');
 Route::post('escalationcreate',array('as' => 'create','check'=>'','menu'=>'pmchecksheet','label'=>'create','uses' =>'EscalationController@create'))->name('machinechklistcreate');
 //Route::get('machinechecklistedit/{id}',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'Edit','uses' =>'MachinechecklistController@create'))->name('machinechecklistedit');
 Route::post('escalationview',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'View','uses' =>'EscalationController@show'))->name('machinechecklistview');
 Route::post('escalationsave',array('as' => '','check'=>'','menu'=>'','label'=>'','uses' =>'EscalationController@save'));
 
 Route::get('escalationmail',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'Controller@escalationmail'))->name('pmchecksheet');
 Route::get('getTicketHistory/{id}/{module}',array('as' => '','check'=>'','menu'=>'pmchecksheet','label'=>'','uses' =>'Controller@getTicketHistory'))->name('pmchecksheet');
?>