...
<h2 class="heads">Top5 BDs Type Wise</h2>
<div class="card">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
		   ...
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('gettopbdtypewisebddata')}}/?start_date="+start_date+"&end_date="+end_date;
                      //  alert(url);
            var url = url;
    ...
    var url="";
			var colModel=[
        { dataIndx: "bd_type",align: "center",title: "Breakdown Type" , width:"35%",filter: { crules: [{condition: "begin" }] }},
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "Top5 BDs Type Wise.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'Top5 BDs Type Wise', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "Top5 BDs Type Wise.xlsx"
