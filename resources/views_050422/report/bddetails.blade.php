...
<h2 class="heads">BREAKDOWN REPORT REGISTER</h2>
<div class="card">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
		   ...
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('getbddetailsdata')}}/?start_date="+start_date+"&end_date="+end_date;
                      //  alert(url);
            var url = url;
    ...
    var url="";
			var colModel=[
        { dataIndx: "slip_no",align: "Left",title: "Ticket No - Date - Shift" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "machine",align: "Left",title: "Machine Name" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "br_type",align: "Left",title: "BD Type" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "bd_detail",align: "Left",title: "Breakdown Details" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "bd_raised",align: "Left",title: "BD Raised On - Department - Raised By" , width:"20%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "action_by",align: "Left",title: "Attended By - Time Taken" , width:"20%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "complete",align: "Left",title: "BD Completion Acknowledged On -Action By" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "com_status",align: "Left",title: "Completion Status" , width:"5%",filter: { crules: [{condition: "begin" }] }},
...
var dataModel = {
       ...
       editable: false,
           ...
           menuUI: {
            ...
            title: "BREAKDOWN REPORT REGISTER",
            resizable: true,
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "BREAKDOWN REPORT REGISTER.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'BREAKDOWN REPORT REGISTER', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "BREAKDOWN REPORT REGISTER.xlsx"
