...
.select2-selection--multiple{
 ...
 <div class="ajaxLoading"></div>
         <h2 class="heads">PM Clearance <span class="ui_close_btn"><a href="{{ URL::to('pmagencyallocation') }}" class="collapse-close pull-right btn-danger" ></a></span></h2>
		...
		<div class="form-group row">
			...
			<input type="text" id="pm_no" name="pm_no" class="form-control pm_no" value="{{$pm_no}}"  readonly>
                ...
                <div class="col-md-6">
                <input type='text' name="shift_timing" id="shift_timing" rows='5' tabindex="3" class='form-control shift_timing datepicker' data-link-format="yyyy-mm-dd" value="{{$shift_timing}}">
                </div>
                <div class="col-md-2">
                </div>
            </div>
	...
	<div class="form-group row">
        ...
        <div class="form-group row">
        <label for="inputIsValid" class="form-control-label col-md-4"><span style="color:red;">*</span>Allocation Type</label>
        <div class="col-md-6" >
            <select name="allocation_type" class="form-control allocation_type select2" style="width: 100%;" tabindex="4" required>
     ...
     <div class="form-group row">
        ...
        <div class="col-md-6" >
            <select name="agency_allocation" class="form-control agency_allocation select2" style="width: 100%;"  required>
                <option>--Please Select--</option> 
            </select>
        </div>
    </div>
		...
		<div class="col-lg-12 col-md-12">
			<div class="form-group text-center">
				...
				<!--<button type="button" class="btn save saveform" value="SAVE">SUBMIT</button>-->
				  ...
				  <a href="{{ URL::to('pmagencyallocation') }}" class='btn cancel'>Cancel</a>
			</div>
		</div>
		</div>
		</div>
...
<script>
 $(document).ready(function()
 {
      ...
      var type=$(this).val();
      if(type=="engineer"){
        $(".agency_allocation").jCombo("{{ URL::to('jcomboform1?table=tb_users:id:first_name') }}",
        {selected_value:''});
      }else{
           $(".agency_allocation").jCombo("{{ URL::to('jcomboform1?table=ma_agency_t:agency_id:agency_name') }}",
        {selected_value:''});
      }
  })  
