	...
	$( document ).ready(function() {
		...
		$(document).on('click','.search',function()
		{
			...
			if(start_date!=''&&machine_id!=''){
				var url="{{URL::to('getmachineyearlydata')}}/?start_date="+start_date+"&machine_id="+machine_id;
				var url = url;
		...
		{ dataIndx: "asset_code", align: "center",title: "Asset Code" , width:"15%",filter: { crules: [{condition: "begin" }] }},
		{ dataIndx: "breakdown_name",align: "center",width:"15%",title: "Breakdown Type Name", filter: { crules: [{condition: "begin" }] }},
		{ dataIndx: "ticket_number",width:"10%", title: "Ticket Number", filter: { crules: [{condition: "begin" }] }},
		{ dataIndx: "issue_date", align: "center",width:"12%",title: "Issue Date", filter: { crules: [{condition: "begin" }] }},
		{ dataIndx: "start_date",align: "center",width:"12%",title: "Repair Start Date", filter: { crules: [{condition: "begin" }] }},
		{ dataIndx: "end_date",align: "center",width:"12%",title: "Repair End Date", filter: { crules: [{condition: "begin" }] }},
		  { dataIndx: "diftime",align: "center",width:"12%",title: "Repair Time", filter: { crules: [{condition: "begin" }] }},
		];
		var dataModel = {
			location: "remote",            
			dataType: "JSON",
		...
		var obj = {
			...
			toolbar: {
				...
				},
				{
					...
					label: 'Print',
					listener: function () {
						var exportHtml = this.exportData({ title: 'Machine Report', format: 'htm', render: true }),
