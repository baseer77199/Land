...
<div class="form-group row" {{$style}}>
 ...
 <div class="form-group row requestraise" {{$style}}>
  ...
  <div class="col-md-8">
  <div class="input-group date form_date col-md-12 datehide">
      <input class="form-control timepicker start_date" id="start_date" name="start_date" size="16" type="text" value="{{ $row->start_date }}" required>
...
<div class="form-group row approverequest" >
  ...
  <div class="col-md-8">
  <div class="input-group date form_date col-md-12 datehide">
      <input class="form-control timepicker end_date" id="end_date" name="end_date" size="16" type="text" value="{{ $row->end_date }}" required>
...
$(document).ready(function()
{
  ...
  var condition2=' and location_id='+location;
