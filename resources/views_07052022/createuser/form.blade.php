  ...
  <div class="row">
    ...
    <div class="col-md-4">
            ...
            <input class="form-control user_id" id="user_id" name="user_id" size="16" type="hidden" value="{{$row->user_id}}" >
                <input type="text"  id="username" name="username"  class="form-control username" value="{{$row->username}}"   autocomplete="off" required>
            </div>
   ...
   <div class="form-group row pagemethod">
        ...
        <div class="form-group row company pagemethod">
         ...
         <div class="form-group row">
            <label for="inputIsValid" class="form-control-label col-md-4">Avatar  @php if($row->user_id!= "") {   $image = $row->avatar == "" ? "profile_none.jpg" : $row->avatar @endphp
