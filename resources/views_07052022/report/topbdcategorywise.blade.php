...
<h2 class="heads">Top5 BDs Category Wise</h2>
<div class="card">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
		   ...
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('gettopbdcategorywisebddata')}}/?start_date="+start_date+"&end_date="+end_date;
                      //  alert(url);
            var url = url;
    ...
    var url="";
			var colModel=[
        { dataIndx: "category",align: "center",title: "Category" , width:"35%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "bids",align: "center",title: "No.Of BIDS" , width:"35%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "time_diff",align: "center",title: "Downtime(Hrs)" , width:"35%",filter: { crules: [{condition: "begin" }] }},
        ];
var dataModel = {
            location: "remote",            
            dataType: "JSON",
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "Top5 BDs Category Wise.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'Top5 BDs Category Wise', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "Top5 BDs Category Wise.xlsx"
