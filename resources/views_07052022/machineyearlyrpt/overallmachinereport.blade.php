...
<div class="card">
    ...
    <div class="row">
     <button type="button" class="btn btn-default search_data btn_active" data-value="calculation">Calculation</button>
    ...
    $(document).ready(function(){
        $(".search").click(function(){
         ...
         if(start_date!=''&&machine_id!=''){
            var url="{{URL::to('getoverallmachinereport')}}/?start_date="+start_date+"&machine_id="+machine_id;
            $.get(url,function(data){
             ...
             $.each(data.data,function(index,val){
                ...
                html+="<tr><td>"+val.issue_month+"</td><td>"+val.no_of_bd+"</td><td>"+val.bd_time+"</td><td>"+val.total_hrs+"</td><td>"+val.repair_time+"</td><td>00:00:00</td><td>"+val.mttr+"</td><td>00:00:00</td><td>"+val.mtbf+"</td><td></td></tr>";
             ...
             $.each(months,function(index,val){
                ...
                $.each(data.data,function(index1,val1){
                  ...
                  if(val1.month==val)
                  {
                    mttr_chart.push(parseFloat(val1.mttr.slice(0,-3).replace(':','.')));
                    mtbf_chart.push(parseFloat(val1.mtbf.slice(0,-3).replace(':','.')));
             ...
             var mtbf=mtbf1+"</tr>"+mtbf2+"</tr>"+mtbf3+"</tr>"+mtbf4+"</tr>";
