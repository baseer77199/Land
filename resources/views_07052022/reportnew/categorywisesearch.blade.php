 ...
 <div class="sbox-title">
    <div class="row position">
           ...
           <div class="col-md-8 notPrint">
              <h4>CATEGORYWISE BREAKDOWN REPORT
              <br>
...
<thead>
   <tr class="display">
                     ...
                     <th colspan="4"><center>Monthly Report on Breakdowns(Machine Wise)
              <br>
                For the Period From {{$start_date}} To {{$end_date}}</center></th>
                     <th colspan="1">Date : 07/10/2019<br>
                      ...
                      <tr>
                          ...
                          <th >Ticket Number</th>
                          <th >Date</th>
                          <th >Machine Name/Department</th>
                          <th >Break Down Raised On</th>
                          <th >Break Down Closed On</th>
