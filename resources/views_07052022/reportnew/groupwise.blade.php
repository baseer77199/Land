...
{{ csrf_field() }}
    <div class="col-md-4">
     ...
     <div class="col-md-4">
        <div class="form-group row">
            <label for="inputIsValid" class="form-control-label col-md-4">Group</label>
            <div class="col-md-6">
                        
                                     <select id="group_id" name='group_id' rows='5'  class='form-control group_id select2' tabindex="1" data-show-subtext="true" data-live-search="true" required>
                    {!! $group_id !!}
            </select>                
...
$( document ).ready(function() {
		        $(document).on('click','.search',function()
		{
			 ...
			 var start_date = ($('.start_date').val() != '') ? $('.start_date').val() : '0';
			   ...
			   var group_id   =  ($('.group_id').val() != '') ? $('.group_id').val()  : '0'; 
		  if(start_date!=0 && end_date!=0 && group_id!=0){
			var url="{{URL::to('groupwisereportsearch')}}/"+start_date+"/"+end_date+"/"+group_id;
