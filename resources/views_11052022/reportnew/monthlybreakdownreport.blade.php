...
@media print{
  .col-md-offset-2,.heads,.btn.search,.footer,{
...
/*}*/
    #job_card_reprot,.footershow,.heads{
        ...
        #reportshow:after {
    visibility: visible;
    content: "FORMAT NO:04.2211.71.03-8 REV:00/16";
}
    }   
...
<h2 class="heads">Monthly Report on Breakdowns(Machine Wise)</h2>
<div class="card">
...
$( document ).ready(function() {
		        $(document).on('click','.search',function()
		{
		  ...
		  if(start_date!=0 && end_date!=0){
			var url="{{URL::to('monthlybreakdownreportsearch')}}/"+start_date+"/"+end_date;
