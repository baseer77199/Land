	...
	$("#grid1").jqGrid(
            {
                ...
                colModel: [
                    ...
                    { name: "department_no", label: "Department No", width: 250,editable:true},
                    { name: "is_technician", label: "Is Technician?", width: 250,editable:true},
 ...
 // alert("dfhgfd");
  ...
  if(gr ){
    swal({
      ...
      if(e == true)
      {
        var url ="{{ url('departmentdelete') }}/" +id;
