...
{ name: "mobile_no", label: "Mobile No",editable:true, editrules:{date:true}},
{ name: "group_name", label: "Group Name",editable:true, editrules:{date:true}},
{ name: "department_name", label: "Department Name",editable:true, editrules:{date:true}},
{ name: "designation_name", label: "Designation Name",editable:true, editrules:{date:true}},
