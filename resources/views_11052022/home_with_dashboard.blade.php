...
<div class="col-md-12 content_box">
                        ...
                        <div class="col-md-3 dash_box wow fadeInUp">
                            <div class="dash_wrap">
                                ...
                                <!--<figure class="dash_ic wow zoomIn"><img src="images/total_order_ic.png" alt=" " /></figure>-->
                                <figure class="dash_ic wow zoomIn"><img src="images/machine-learning.png" alt=" " /></figure>
                            </div>
                        </div>
  ...
  <div class="row">
    <div class="col-md-6">
        <h4 class="card-title"style="padding-top: 15px;height: 48px;"><img src="{{asset('images/settings.png')}}" style="width: 33px;height: 33px;">Preventive Maintenance</h4>
  </div>
  <div class="col-md-6">
