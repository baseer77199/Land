...
$pdf->Cell(0,0, "Preventive Maintenance Schedule For Plant - ".$department_id." ".$year ,0,1,'L');
...
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, "Month : ".$year ,0,'L');

$pdf->SetXY(925,120);
$pdf->SetFont('','B','10');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, "Overall Point" ,0,'L');
...
{
//dd($breakdown_details);
$pdf->SetXY($x+10,$yy-20);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->MultiCell(0,0, $total[$machine_id]['total_brkdwn'] ,0,'L');
$pdf->SetXY($x+10,$yy+10);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, $total[$machine_id]['total_brkdwn_hours'] ,0,'L');
$pdf->SetXY($x+10,$yy+40);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
//$pdf->Cell(0,0, $total[$machine_id]['avail_hours'] ,0,'L');
$pdf->SetXY($x+10,$yy+70);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, $total[$machine_id]['total_repair_hours'] ,0,'L');
$pdf->SetXY($x+10,$yy+100);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, $breakdown_details[$machine_id][$key1]['mttr'] ,0,'L');
$pdf->SetXY($x+10,$yy+130);
$pdf->SetFont('','','9');
$pdf->SetTextColor('0','0','0');
$pdf->Cell(0,0, $breakdown_details[$machine_id][$key1]['mtbf'] ,0,'L');
$x=$x+65;
}
