      ...
      <div class="m-logo-box">
        <h1>
          ...
          <a href="{{URL::to('home')}}" class="m-logo">
            <img class="img-fluid m-logo-mobile" src="{{ asset('images/logo.jpg') }}" >
            <img class=" img-fluid m-logo-desktop img-responsive" src="{{ asset('images/logo.jpg') }}" >
          </a>
        </h1>
      </div>
      <!--logo end -->
                ...
                <div class="notification_home">
                  <?php if(count($count_no) > 0 ){ foreach ($count_no as $key => $value) { ?>
                      ...
                      <div  <?php if($value->noty=="read") { ?> class="alert alert-success" <?php } else {?> class="alert alert-info" <?php  } ?>>
                        <a class="a_noty" href="{{URL::to($value->reference_url.'/'.$value->reference_source_id.'?btnval='.$value->btn_val.'&ref_id='.$value->notification_id)}}"  <?php if($value->noty=="read") { ?> style="color: green;" <?php } else {?> style="color: blue;" <?php  } ?> ><?php echo $value->description; ?> </a>
