...
$( document ).ready(function() {
       ...
       var department_id   =  ($('.department_id').val() != '') ? $('.department_id').val()  : ''; 
		   ...
		   if(start_date!=''&&department_id!=''){
			var url="{{URL::to('getpmdailydata')}}/?start_date="+start_date+"&department_id="+department_id;
                      //  alert(url);
            var url = url;
    ...
    var url="";
			var colModel=[
  { dataIndx: "department_id", align: "center",title: "Id" ,hidden:true},
        { dataIndx: "department_name",align: "Left",title: "Department Name" , width:"15%",filter: { crules: [{condition: "begin" }] }},
       { dataIndx: "machine_name",align: "Left",title: "Machine Name" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "actual_pm_date",align: "Left",title: "Months" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "frequency_id",align: "Left",title: "Plan" , width:"20%",filter: { crules: [{condition: "begin" }] }},
     //  { dataIndx: "debit_amounts", align: "Right",title: "Actual Done On" ,width:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "done_on_date", align: "Right",title: "AMC Done On" ,width:"15%", filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "statuss", align: "Right",title: "Status" ,width:"15%", filter: { crules: [{condition: "begin" }] }},
           ...
           menuUI: {
            ...
            toolbar: {
                ...
                },
                {
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'PM Daily Report', format: 'htm', render: true }),
