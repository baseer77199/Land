...
<div class="card">
    ...
    <div class="row">
     <span class="float-right" style="margin-left: 1000px;"><button onclick="myFunction()">Print this page</button></span>
 </div>
    ...
    $(document).ready(function(){
        $(".search").click(function(){
         ...
         if(start_date!=''&&department_id!=''){
            var url="{{URL::to('getmonthwisemachinereport')}}/?start_date="+start_date+"&department_id="+department_id;
            $.get(url,function(data){
             ...
             $.each(data.data,function(index,val){
                 ...
                 html+="<tr><td>"+val.machine_name+"</td><td>"+val.no_of_bd+"</td><td>"+val.bd_time+"</td><td>"+val.total_hrs+"</td><td>"+val.repair_time+"</td><td>00:00:00</td><td>"+val.mttr+"</td><td>00:00:00</td><td>"+val.mtbf+"</td><td></td></tr>";
            }); 
