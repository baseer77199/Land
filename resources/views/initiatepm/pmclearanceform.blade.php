...
<script>
 $(document).ready(function()
 {
    ...
    if(($(".change_date").select2("val"))=="1") {
        $(".save_btn").prop("disabled", true).hide();  
        $(".postpone_btn").prop("disabled", false).show(); 
        $(".clearance_date").show();
        $(".shift_timings").hide();
        $(".postponed_date").val("");
       ...
       $(".postpone_btn").prop("disabled",true).hide();
       $(".shift_timing").val("");
       $(".shift_timing").attr('required', 'required');
       $(".postponed_date").removeAttr('required', false);
    }
});	
$(".postpone_btn,.save_btn").prop("disabled",true).hide();
