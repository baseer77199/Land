    ...
    <div class="report-header">
        <div class="report-header-content">
            ...
            <div class="report-title">
                <h3>Category Wise Breakdown Report</h3>
        ...
        <table border="1" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th style="width: 150px;">Machine Name/<br>Department</th>
                    <th style="width: 120px;">Breakdown<br>Raised On</th>
                    <th style="width: 120px;">Breakdown<br>Closed On</th>
...
if (isset($data) && count($data) > 0) {
    foreach ($data as $key => $value) {
        ...
        $timeStr = isset($value->time_diff) ? $value->time_diff : '0:00';
            ?>
                <tr>
                    <td class="sno-cell">{{$i}}</td>
                    <td class="ticket-cell">{{$value->ticket_number}}</td>
                    <td class="date-cell">{{$value->issue_date}}</td>
                    <td class="machine-cell">{{$value->machine_dept}}</td>
                    <td class="bd-raised-cell">{{$value->start_date}}</td>
                    <td class="bd-closed-cell">{{$value->end_date}}</td>
    ...
    echo "<tr><td colspan='8' style='text-align: center; padding: 40px; color: #999;'>No breakdown incidents recorded for the selected period</td></tr>";
}
        ?>
            </tbody>
        </table>
        ...
        <div class="footer-note">
            ...
            <div class="summary-stats">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-badge" style="background: #17a2b8;">Category Wise</span>
                </div>
                <div class="stat-item">
                    <span style="color: #024d87;">⏱️ Time Format:</span>
                    <span class="stat-badge" style="background: #6c757d;">HH:MM</span>
                </div>
            </div>
            <p style="margin-top: 10px; font-size: 10px; color: #999;">
                Report generated on <span id="footerDate"></span> | A3 Landscape format recommended | All times in
                24-hour
                format
            </p>
        </div>
