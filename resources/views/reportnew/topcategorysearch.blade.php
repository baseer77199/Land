...
table tbody tr:nth-child(1) .category-cell,
table tbody tr:nth-child(2) .category-cell,
table tbody tr:nth-child(3) .category-cell {
    text-align: center;
    padding-left: 12px;
}
...
<div class="report-container">
    <div class="report-header">
        ...
        <div class="report-subtitle">
            🏆 Top 5 Categories by Breakdown Count & Downtime
        </div>
    </div>
...
if (isset($data) && count($data) > 0) {
            ...
            ?>
                <tr>
                    <td class="category-cell">
                        <span class="rank-badge">{{$rankEmoji}}</span>{{$v->category}}
                    </td>
    ...
    echo "<tr><td colspan='3' style='text-align: center; padding: 40px; color: #999;'>No breakdown data available for the selected period</td></tr>";
}
        ?>
            </tbody>
        </table>
        ...
        <div class="footer-note">
            ...
            <div class="legend">
                ...
                <div class="legend-item">
                    ...
                    <span>Rank 2 - Second</span>
                </div>
                <div class="legend-item">
                    <div class="legend-color bronze"></div>
                    <span>Rank 3 - Third</span>
                </div>
                <div class="legend-item">
