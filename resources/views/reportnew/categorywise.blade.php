            ...
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="breakdowntype_id" name='breakdowntype_id' rows='5'
                            class='form-control breakdowntype_id select2' tabindex="1" data-show-subtext="true"
        ...
        $(document).on('click', '.search', function() {
            ...
            if (start_date != 0 && end_date != 0 && breakdowntype_id != 0) {
                if (start_date <= end_date) {
                    var url = "{{URL::to('categorywisereportsearch')}}/" + start_date + "/" + end_date +
                        "/" + breakdowntype_id;
