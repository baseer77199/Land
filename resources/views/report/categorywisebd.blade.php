...
{{ csrf_field() }}
  ...
  <div class=" col-md-4">
        <div class="form-group row">
            <label for="inputIsValid" class="form-control-label col-md-4">Breakdown Type</label>
            <div class="col-md-6">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
             ...
             var breakdowntype_id   =  ($('.breakdowntype_id').val() != '') ? $('.breakdowntype_id').val()  : ''; 
 		    
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('getcategorywisebddata')}}/?start_date="+start_date+"&end_date="+end_date+"&breakdowntype_id="+breakdowntype_id;
                      //  alert(url);
            var url = url;
    ...
    var url="";
			var colModel=[
        { dataIndx: "ticket_number",align: "Left",title: "Ticket Number" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "issue_date",align: "Left",title: "Issue Date" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "machine_dept",align: "Left",title: "Machine Name/Department" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "start_date",align: "Left",title: "Start Date" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "end_date",align: "Left",title: "End Date" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "time_diff",align: "Left",title: "Time Taken" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        { dataIndx: "preventive_action",align: "Left",title: "Action Taken" , width:"15%",filter: { crules: [{condition: "begin" }] }},
                ];
var dataModel = {
            location: "remote",            
            dataType: "JSON",
       ...
       editable: false,
           ...
           menuUI: {
            ...
            title: "CATEGORYWISE BREAKDOWN REPORT",
            resizable: true,
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "CATEGORYWISE BREAKDOWN REPORT.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'CATEGORYWISE BREAKDOWN REPORT', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "CATEGORYWISE BREAKDOWN REPORT.xlsx"
