...
<h2 class="heads">BD Analysis Time Vs Percentage - Group Wise</h2>
<div class="card">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
		   ...
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('getgroupwisebdanalysisdata')}}/?start_date="+start_date+"&end_date="+end_date;
                      //  alert(url);
            var url = url;
...
var dataModel = {
       ...
       editable: false,
           ...
           menuUI: {
            ...
            title: "BD Analysis Time Vs Percentage - Group Wise",
            resizable: true,
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "BD Analysis Time Vs Percentage - Group Wise.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'BD Analysis Time Vs Percentage - Group Wise', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "BD Analysis Time Vs Percentage - Group Wise.xlsx"
