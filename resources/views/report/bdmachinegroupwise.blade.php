...
<h2 class="heads">MACHINE GROUPWISE BREAKDOWN REPORT</h2>
<div class="card">
...
$( document ).ready(function() {
	    ...
	    $(document).on('click','.search',function()
		{
		   ...
		   if(start_date!=''&&end_date!=''){
			var url="{{URL::to('getmachinegroupwisebddata')}}/?start_date="+start_date+"&end_date="+end_date;
                      //  alert(url);
            var url = url;
    ...
    var url="";
        ...
        { dataIndx: "issue_date",align: "Left",title: "Issue Date" , width:"15%",filter: { crules: [{condition: "begin" }] }},
         ...
         { dataIndx: "bd_type",align: "Left",title: "Category" , width:"15%",filter: { crules: [{condition: "begin" }] }},
         { dataIndx: "causes",align: "Left",title: "Breakdown Details(User)" , width:"15%",filter: { crules: [{condition: "begin" }] }},
         { dataIndx: "preventive_action",align: "Left",title: "Action Taken(PMD)" , width:"15%",filter: { crules: [{condition: "begin" }] }},
         { dataIndx: "time_diff",align: "Left",title: "Time Taken" , width:"15%",filter: { crules: [{condition: "begin" }] }},
         { dataIndx: "remarks",align: "Left",title: "Remarks" , width:"15%",filter: { crules: [{condition: "begin" }] }},
        ];
var dataModel = {
            location: "remote",            
            dataType: "JSON",
       ...
       editable: false,
           ...
           menuUI: {
            ...
            title: "MACHINE GROUPWISE BREAKDOWN REPORT",
            resizable: true,
            ...
            toolbar: {
                items: [{
                    ...
                    listener: function () {
                        ...
                        saveAs(blob, "MACHINE GROUPWISE BREAKDOWN REPORT.xlsx" );
                    }
                },
                {
                    type: 'button',
                    ...
                    label: 'Print',
                    listener: function () {
                        var exportHtml = this.exportData({ title: 'MACHINE GROUPWISE BREAKDOWN REPORT', format: 'htm', render: true }),
...
$("#pmyearlygrid" ).pqGrid({ scrollModel:{autoFit: true }});
    $(document).on('click',".exportexcel",function() {
        $("#pmyearlygrid").jqGrid("exportToExcel",{
                                                ...
                                                includeFooter: true,
                                                fileName : "MACHINE GROUPWISE BREAKDOWN REPORT.xlsx"
