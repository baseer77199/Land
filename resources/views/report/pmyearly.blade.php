...
<h2 class="heads">PM Yearly report</h2>
<div class="card">
        ...
        <form method="post" action="" id="job_card_reprot" class="org_form" data-parsley-validate
            ...
            <div class="col-lg-12 col-md-12">
                <div class="form-group text-center">
                    ...
                    <button type="button" class="btn print" value="SAVE" onclick="window.print()">Print</button>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.search', function() {
        ...
        if (start_date != '' && department_id != '') {
            var url = "{{URL::to('getpmyearlydata')}}/?start_date=" + start_date + "&department_id=" +
                department_id;
            $.get(url, function(data) {
                $('#pmyearlygrid').html(data);
            });
