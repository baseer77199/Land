...
<div class="card">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="machine_name" name="machine_name" class="form-control machine_name" value="{{ $row->machine_name}}"  tabindex="1" required="true">
        </div>
        <div class="col-md-2">
        </div>
    </div>
...
<!-- <div class="form-group row">
       ...
       <div class="col-md-6">
			...
			<input class="form-control relocated_date datepicker1" id="relocated_date" name="relocated_date" size="16" type="text" value="{{ $row->relocated_date }}" tabindex="5" >
...
<div class=" form-group row">
       ...
       <div class="col-md-6">
			<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			<input class="form-control purchased_date datepicker1" id="purchased_date" name="purchased_date" size="16" type="text" value="{{ $row->purchased_date }}" tabindex="5" >
			 <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span> 
			</div>
			</div>
            ...
            <div class="form-group row panel-body remarks_cfg">
                ...
                <div class="form-group row panel-body remarks_cfg">
                    ...
                    <div class="form-group row panel-body remarks_cfg">
                        ...
                        <div class="col-md-6">
			<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			<input class="form-control renewal_date datepicker1" id="renewal_date" name="renewal_date" size="16" type="text" value="{{ $row->renewal_date }}" tabindex="5" >
			 <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span> 
			</div>
			</div>
                    </div>
                    ...
                    <div class="form-group row panel-body remarks_cfg">
                       ...
                       <div class="col-md-6">
			<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			<input class="form-control from_date datepicker1" id="from_date" name="from_date" size="16" type="text" value="{{ $row->from_date }}" tabindex="5" >
			 <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span> 
			</div>
                ...
                <div class="col-md-4">
                    <div class="form-group row panel-body">
                        ...
                        <div class="col-md-6">
			<div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
			<input class="form-control to_date datepicker1" id="to_date" name="to_date" size="16" type="text" value="{{ $row->to_date }}" tabindex="5" >
			 <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span> 
			</div>
                    ...
                    <?php  if (count($linedata) >= 1) {    ?>
                        ...
                        <tr class="rcopy clone">
                            <td>
                             ...
                             <td>
                                    <select name="bulk_frequency_id[]" class="select2  bulk_frequency_id " >{!! $value->frequency_id !!}</select>
                                </td>
                            <td class="">
                <input type="text" name="bulk_frequency_date[]" class="form-control datepicker1 input-sm bulk_frequency_date"   value="{{ $value->frequency_date }}">
            </td>
            <td>
                ...
                <input type="hidden" name="counter[]">
                        ...
                        <?php } if (count($linedata) < 1) { ?>
                            <tr class="rcopy clone">
                                ...
                                <td>
                                    <select name="bulk_frequency_id[]" class="select2  bulk_frequency_id " >{!! $frequency_id!!}</select>
                                </td>
                                <td class="">
                <input type="text" name="bulk_frequency_date[]" class="form-control datepicker1 input-sm bulk_frequency_date"   value="{{ $value->frequency_date }}">
            </td>
