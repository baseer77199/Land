...
<div class="card">
 ...
 <div class="col-md-6">
          <div class=" form-group row">
            <label for="fob_point_name" class="form-control-label col-md-4"><span style="color:red;">*</span>Spare Number</label>
            <div class="col-md-8">
              <input type="text" id="spares_no" name="spares_no" class="form-control spares_no" tabindex="1" value="" style="width:100%;" tabindex="3" required>
            </div>
          </div>
        </div>
...
$(document).ready(function(){
 ...
 $("#sparegrid").jqGrid(
 {
    ...
    { name: "spares_no", label: "Spare Number", width: 250,editable: true},
 ...
 $("#editdata").click(function()
 {
     ...
     var spares_no = $("#sparegrid").jqGrid ('getCell', index, 'spares_no');
