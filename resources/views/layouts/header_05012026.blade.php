                ...
                <div class="notification-item alert alert-info"
                  ...
                  <div class="notification-actions">
                    <form id="noti-form-<?php    echo $value->notification_id; ?>"
                      action="{{ route('notification.mark-read') }}" method="POST" style="display: none;">
                      {{ csrf_field() }}
                      <input type="hidden" name="notification_id" value="<?php    echo $value->notification_id; ?>">
                      <input type="hidden" name="reference_source_id"
                        value="<?php    echo $value->reference_source_id; ?>">
                      <input type="hidden" name="btn_val" value="<?php    echo $value->btn_val; ?>">
                      <input type="hidden" name="reference_url" value="<?php    echo $value->reference_url; ?>">
                    </form>
