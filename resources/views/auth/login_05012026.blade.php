...
<div class="row boxshadow">
    ...
    <div class="col-md-offset-7 col-md-5 login-sec">
        <div class="panel panel-default">
            <div class="panel-heading"> <img src="{{asset('images/l&tlogo.png')}}" style="height:70px"
                ...
                <form class="form-horizontal" id="login_form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group{{ $errors->has('employee_number') ? ' has-error' : '' }}">
                        ...
                        <div>
                            <input id="employee_number" type="text" autocomplete='off' class="form-control"
                                ...
                                style="color:#fff;font-weight:bolder;background: url(images/doctor.png);">
                    ...
                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <div>
                            <input id="password" type="password" autocomplete='off'
                                ...
                                required style="color:#fff;font-weight:bolder;background: url(images/key.png);">
                    ...
                    <div class="form-group">
                        ...
                        <div class="c-checkbox">
                            ...
                            <span class="check_mark"></span> <label class="loginlink"> Remember Me</label>
                        </div>
            ...
            <div class="panel-footer text-center"
                style="color:#fff;font-weight: bolder;font-size: 13px;text-shadow: 0px 1px 1px rgba(0,0,0,1)">Powered By
                i <img src="{{ asset('images/logo.png') }}"
                    style="width: 45px;height: 35px !important;vertical-align: baseline;"> Technology Pvt Ltd</div>
