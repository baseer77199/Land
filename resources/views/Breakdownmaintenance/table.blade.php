...
<form id="ticket-upload" action="{{URL::to('ticketgenerateupload')}}" method="POST" style="display: none;">
    {{ csrf_field() }}
...
$(document).ready(function() {
    ...
    $("#grid1").jqGrid({
        ...
        colModel: [{
            ...
            {
                name: "severity_name",
                label: "Breakdown Sevearity"
            },
            {
                name: "causes",
                label: "Causes of Breakdown",
                editable: true,
                editrules: {
                    date: true
                }
    ...
    $('.ticket_upload').on('click', function() {
        ...
        document.getElementById('ticket-upload').submit();
        ...
        if (index) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 1) {
                        notyMsgs("info", "Ticket Cancelled");
                        window.location.reload();
                    } else {
                        notyMsgs("info", "Please Try again");
                    }
                }
            });
        } else {
