...
<?php if($pageMethod=="closeredquest"){$datetimepicker="datpicker2";}else{$datetimepicker="datetimpicker1";} ?>
...
<h2 class="heads">  <?php if($pageMethod=="allocateengineer") {?>
                                     ...
                                     <?php } else if($pageMethod=="approverequest"){ ?>
                                      ...
                                      <?php } else if($pageMethod=="closerequest"){?>
                                        Close Request
                                      <?php } else if($pageMethod=="closeredquest"){?>
                                        Update Issue
...
<?php if($pageMethod=="closeredquest"){?>
