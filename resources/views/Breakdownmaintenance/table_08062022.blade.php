...
{ name: "asset_code", label: "Asset Code",editable:true, editrules:{date:true}},
{ name: "machine_name", label: "Machine",editable:true, editrules:{date:true}},
...
{ name: "ticket_status", label: "Status",editable:true, editrules:{date:true}},
{ name: "error_code", label: "Error Code",editable:true, editrules:{date:true}},
{ name: "allocated_to_name", label: "Engineer",editable:true, editrules:{date:true}},
{ name: "created_by_name", label: "Created By",editable:true, editrules:{date:true}},
