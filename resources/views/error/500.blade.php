...
body{
    background: url(../images/error_images/b2.jpg);
...
<img src="{{asset('images/error_images/warning.png')}}" width="100" height="100" style="margin-top: -1%;">	
<h1>5<span>0</span>0</h1>
</div>

<h2  style="color:red;text-shadow: 0 2px 2px rgba(0,0,0,0.6);">INTERNAL SERVER ERROR</h2>
 <!-- <span class="blink">_</span></h2> -->
<p style="cursor: pointer;"><a href="#">Reload </a></p>
</div>
</div>
</div>
