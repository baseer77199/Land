...
$( document ).ready(function() {
   var colModel=[
        ...
        { dataIndx: "department_name",align: "center",title: "Department" , filter: { crules: [{condition: "begin" }] },width:"14%"},
        { dataIndx: "machine_name", align: "center",title: "Machine Name", filter: { crules: [{condition: "begin" }] } ,width:"25.28%"},
        { dataIndx: "spares_name",align: "center",title: "Spare Name", filter: { crules: [{condition: "begin" }] },width:"20.28%"},
        { dataIndx: "qty", title: "Used Qty", filter: { crules: [{condition: "begin" }] },width:"14.28%"},
        { dataIndx: "spare_quantity", title: "Balance Qty", filter: { crules: [{condition: "begin" }] },width:"14.28%" },
